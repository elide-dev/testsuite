...
Last updated: 2026-08-02T09:13:20.337Z

![Latest compatibility pass rates](reports/pass-rate.svg)

| Suite | Version | Digest | Pass rate | Regressions |
|---|---|---|---:|---:|
| cpython-core | `1.4.2+20260802.a0d5a22` | `unknown` | 94.3% | 0 |
| javac-jtreg | `1.4.2+20260802.a0d5a22` | `unknown` | 99.9% | 2 |
| node-api | `1.4.2+8bf2c6fb1` | `dce38dd7dc4c` | 29.5% | 0 |
| test262 | `1.4.2+20260802.a0d5a22` | `unknown` | 100.0% | 0 |
| wpt-wintertc | `1.4.2+20260802.a0d5a22` | `unknown` | 86.9% | 0 |
