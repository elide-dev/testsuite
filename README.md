...
Last updated: 2026-08-31T23:46:11.051Z

![Latest compatibility pass rates](reports/pass-rate.svg)

| Suite | Version | Digest | Pass rate | Regressions |
|---|---|---|---:|---:|
| cpython-core | `1.4.99+8b374d579` | `4094eb2fb1ff` | 97.0% | 0 |
| javac-jtreg | `1.4.99+8b374d579` | `4094eb2fb1ff` | 100.0% | 0 |
| node-api | `1.4.99+8b374d579` | `4094eb2fb1ff` | 70.1% | 0 |
| test262 | `1.4.99+8b374d579` | `4094eb2fb1ff` | 99.9% | 0 |
| wpt-wintertc | `1.4.99+8b374d579` | `4094eb2fb1ff` | 89.9% | 0 |
