...
Last updated: 2026-07-01T21:59:43.089Z

![Latest compatibility pass rates](reports/pass-rate.svg)

| Suite | Version | Digest | Pass rate | Regressions |
|---|---|---|---:|---:|
| cpython-core | `1.4.0+ff263a815` | `f35eaed61d09` | 94.2% | 0 |
| javac-jtreg | `1.4.0+ff263a815` | `f35eaed61d09` | 98.8% | 0 |
| test262 | `1.4.0+ff263a815` | `f35eaed61d09` | 92.2% | 0 |
