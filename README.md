...
Last updated: 2026-07-01T11:39:23.192Z

![Latest compatibility pass rates](reports/pass-rate.svg)

| Suite | Version | Digest | Pass rate | Regressions |
|---|---|---|---:|---:|
| cpython-core | `1.3.6+20260701.7e20640` | `unknown` | 90.6% | 447 |
| javac-jtreg | `1.3.6+20260701.7e20640` | `unknown` | 98.6% | 4 |
| test262 | `1.3.6+20260701.7e20640` | `unknown` | 91.9% | 0 |
