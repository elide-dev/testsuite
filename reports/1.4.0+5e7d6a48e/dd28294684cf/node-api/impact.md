...
### 51 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Missing expected exception │ │ │ │ In file <loc> │ │─ Stack Tra`
...
### 35 × `Node API test timed out`

distinct messages:
- `Node API test timed out`
example test: `test/parallel/test-fs-promises-watch.js`

### 32 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: The worker script or module filename must be an absolute path or a│ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: The worker script or module filename must be an absolute path or a│
│relative path starting with './' or '../'. Received "unknown".               │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: The worker script or module filename must be an absolute path or a│
│relative path starting with './' or '../'. Received "unknown".               │
...
### 19 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc> │ │─ Stack Trace ────────────`
...
### 15 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc> │ │─ S`
...
### 4 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: undefined │ │ │ │ In file <loc> │ │─ St`
...
│AssertionError: Got unwanted exception: undefined                            │
│                                                                             │
│ In file test/parallel/test-worker-invalid-workerdata.js:10`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: undefined                            │
│                                                                             │
...
### 3 × `AssertionError: <n> === <n> at Function.strictEqual (native) at <loc> at _return (<loc>)`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [] deepStrictEqual [<str>] │ │ │ │ In file <loc> │ │─ Stack Tra`
...
│                                                                             │
│ In file test/parallel/test-worker-messageport-hasref.js:33`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: The worker script or module filename │ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: The worker script or module filename │
...
│values provided for JSToNumberNodeGen@444b128a: [[B@63e5c270], [byte[]]      │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected    │
│values provided for JSToObjectNodeGen.Uncached@57769162: [[B@7c172c50],      │
│[byte[]]                                                   `
example test: `test/parallel/test-fs-promises-writefile-typedarray.js`

### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │DOMException │ │ │ │ In file <loc> │ │─ Stack Trace ───────────────────────────`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│DOMException                                                                 │
│                                                                             │
│ In file test/parallel/test-worker-message-channel.js:17:3 `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│DOMException                                                                 │
│                                                                             │
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: The URL must be of scheme file │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: The URL must be of scheme file                                    │
│                                                                             │
│ In file test/parallel/test-worker-data-url.js:7:1         `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: The URL must be of scheme file                                    │
│                                                                             │
│ In file test/parallel/test-worker-process-exit-async-modul`
example test: `test/parallel/test-worker-data-url.js`

### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: The worker script extension must be <str>, <str>, or <str>. │ │Recei`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: The worker script extension must be ".js", ".mjs", or ".cjs".     │
│Received "../node-api-overlay/unknown"                                       │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: The worker script extension must be ".js", ".mjs", or ".cjs".     │
│Received "./unknown"                                                         │
...
distinct messages:
- `(node:10053) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10053) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9403) Warning: A Warning
(node:9403) CustomWarning: A Warning
(node:9403) Warning: A Warning
(node:9403) CustomWarning: A Warning
(node:9403) [CODE001] CustomWarning: A Warning
(node:9403) CustomWarning: A Warning
(node:9403) [CODE001] CustomWarning: A Warning
(node:9403) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10304) Warning: test
(node:10304) DeprecationWarning: test
(node:10304) Warning: test
(node:10304) DeprecationWarning: test
(node:10304) Error: test
(node:10304) Warning: test
...
distinct messages:
- `7/7/2026, 1:36:48 AM start test
7/7/2026, 1:36:48 AM waiting for callbacks
7/7/2026, 1:36:48 AM fs open() callback
7/7/2026, 1:36:48 AM WriteStream constructor
7/7/2026, 1:36:48 AM closed 1
...
### 1 × `>> READ >> READ >> READ data emitted aaa pushing readable emitted >> READ <n> <n> <n> <n> <n> <n> <n> <n> <n> <n> pushing data emitted <n> data emitted <n> data`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@18d771d4 === [B@4ffbf66f │ │ │ │ In file <loc> │ │─ Stack Tr`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@18d771d4 === [B@4ffbf66f                                  │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: node:worker_threads: │ │moveMessagePort`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: node:worker_threads:                 │
│moveMessagePortToContext is not implemented yet in Elide                     │
│                                                           `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: The <str> argument must be of │ │type s`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: The "filename" argument must be of   │
│type string or an instance of URL. Received boolean                          │
│                                                           `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@4234fef1 │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@4234fef1                                    │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │DOMException │ │ │ │ In file test/parallel/test-worker-message-port-multiple-sh`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │RangeError: Maximum call stack size exceeded │ │ │ │ In file <loc> │ │─ Stack T`
...
### 1 × `Mismatched <anonymous> function calls. Expected at least <n>, actual <n>. at Proxy.mustCallAtLeast (<loc>) at <loc> at _return (<loc>)`
...
- `Mismatched <anonymous> function calls. Expected at least 1, actual 0.
    ...
    at test-fs-read-stream-pos.js:37:28
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:57`
...
### 1 × `TypeError: Cannot read property <str> of null at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (native) TypeError: Canno`
...
- `TypeError: Cannot read property 'read' of null
    ...
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)
TypeError: Cannot read property 'r`
...
### 1 × `TypeError: TypeError: Cannot load module: <str> TypeError: TypeError: Cannot load module: <str> TypeError: TypeError: Cannot load module: <str>`
...
### 1 × `Uncaught JSException in event listener: AssertionError: function should not have been called at <loc> called with arguments: { hello: <str> }`
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6204-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6204-64K.txt of length 65536
