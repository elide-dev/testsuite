...
- Image digest: `fcb69aa9881236fbea3bdb0da092de93c93ea9ee67e89b22e05d6f30c468459c`
- Suite version: `unknown`
- Ran: 2026-09-21T19:55:59.537Z → 2026-09-22T00:39:51.823Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 5308/12755 (77.90%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 5308 | 1480 | 26 | 5941 | 0 | 0 |

## Observed cases (6814)

- `build/AbsPathsInImage.java` — pass
...
- `build/translations/VerifyTranslations.java` — fail — Not run. (filtered by keywords, @requires, or @ignore)
...
- `com/sun/crypto/provider/Cipher/PBE/PBEKeyCleanupTest.java` — error — Error. Program `/Users/sam/workspace/bali/target/dist/bin/java' timed out (timeout set to 240000ms, elapsed time including timeout handling was 240004ms).
...
- `com/sun/crypto/provider/KeyFactory/TestProviderLeak.java` — fail — Failed. Execution failed\: `main' threw exception\: java.lang.OutOfMemoryError\: Garbage-collected heap size exceeded. Consider increasing the maximum Java heap size, for example with '-Xmx'.
...
- `com/sun/jndi/dns/EnvTests/AddOps.java` — error — Failed. Execution failed\: `main' threw exception\: javax.naming.CommunicationException\: DNS error [Root exception is java.net.SocketTimeoutException]; remaining name 'dns\://localhost\:54145/host1.domain1.com.'
...
- `com/sun/jndi/dns/EnvTests/RemoveOps.java` — error — Failed. Execution failed\: `main' threw exception\: javax.naming.CommunicationException\: DNS error [Root exception is java.net.SocketTimeoutException]; remaining name 'dns\://localhost\:55506/host1.domain1.com.'
