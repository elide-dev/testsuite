...
distinct messages:
- `FileNotFoundError: [Errno 2] No such file or directory: '@test_27_tmpæ.out'`
...
AssertionError: <function FinalizeTestCase.test_all_freed.<locals>.callback at 0x4b92f6> is not None`
...
AssertionError: b'File "/tmp/tmpgxkk9e7k/script.py", line 2, in __main__.Test' not found in b'***************`
...
AssertionError: b'/tmp/tmp740n37lj/script.py' not found in b'> /work/.harness/work/cpython-core/`
...
AssertionError: 'Z' unexpectedly found in {<weakref at 872635568; to 'UserString' at 26852263>, <weakref at 1124600574; to '`
...
AssertionError: 5.212897305027582 not less than 4`
...
AssertionError: <test.test_exceptions.ExceptionTests.testExceptionCleanupState.<locals>.MyObj object at 0x39a66465> is not None`
