...
│values provided for JSToNumberNodeGen@73700c4: [[B@7f3e91a5], [byte[]]       │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected    │
│values provided for JSToObjectNodeGen.Uncached@5cd2cdf4: [[B@d6ba63c],       │
│[byte[]]                                                   `
...
- `AssertionError: function should not have been called at test-timers-dispose.js:7
    at Function.fail (native)
    at mustNotCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:631:12)
AssertionError: function should not have been called at test-timers-dispose.js:5
    at Functi`
...
distinct messages:
- `(node:10056) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10056) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9406) Warning: A Warning
(node:9406) CustomWarning: A Warning
(node:9406) Warning: A Warning
(node:9406) CustomWarning: A Warning
(node:9406) [CODE001] CustomWarning: A Warning
(node:9406) CustomWarning: A Warning
(node:9406) [CODE001] CustomWarning: A Warning
(node:9406) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10314) Warning: test
(node:10314) DeprecationWarning: test
(node:10314) Warning: test
(node:10314) DeprecationWarning: test
(node:10314) Error: test
(node:10314) Warning: test
...
distinct messages:
- `7/6/2026, 10:26:57 PM start test
7/6/2026, 10:26:57 PM waiting for callbacks
7/6/2026, 10:26:57 PM fs open() callback
7/6/2026, 10:26:57 PM WriteStream constructor
7/6/2026, 10:26:57 PM closed 1
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@4ed6dffb === [B@fb7b4f1 │ │ │ │ In file <loc> │ │─ Stack Tra`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@4ed6dffb === [B@fb7b4f1                                   │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@2b08901b │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@2b08901b                                    │
│                                                                             │
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6213-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6213-64K.txt of length 65536
