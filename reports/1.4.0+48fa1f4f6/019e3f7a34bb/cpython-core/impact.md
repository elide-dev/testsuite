...
AssertionError: <function FinalizeTestCase.test_all_freed.<locals>.callback at 0x1de896c1> is not None`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_builtins self.assertEqual(lines, [<str>]) AssertionError: Lists differ: [<str>, <str>] != [<str`
...
AssertionError: Lists differ: ['usage: frozen [-h] [-d] object', 'frozen[50 chars]ect'] != ["Can't `
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_cli_file_input self.assertEqual(expected.splitlines(), res.out.decode(<str>).splitlines()) Asse`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_ast/test_ast.py", line 2797, in test_cli_file_input
    self.assertEqual(expected.splitlines(), res.out.decode("utf8").splitlines())
AssertionError: Lists differ: ['Module(', '   body=[', '      Expr(', '         [246 char`
...
AssertionError: b'File "/tmp/tmp2l63vl0e/script.py", line 2, in __main__.Test' not found in b'***************`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_output_year self.assertEqual(stdout, conv(result_2004_text)) AssertionError: b<str> != b<str>`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_calendar.py", line 885, in test_output_year
    self.assertEqual(stdout, conv(result_2004_text))
AssertionError: b'   [28 chars]   2026\n\n      January                   Feb[2094 chars]30\n' != b'   [28 chars]   2004\n\n `
...
AssertionError: b'/tmp/tmp1igwn97f/script.py' not found in b'> /work/.harness/work/cpython-core/`
...
AssertionError: 'Z' unexpectedly found in {<weakref at 1285427932; to 'UserString' at 1908420749>, <weakref at 802171888; to`
...
AssertionError: 4.8601565069984645 not less than 4`
...
AssertionError: <test.test_exceptions.ExceptionTests.testExceptionCleanupState.<locals>.MyObj object at 0x10f224fa> is not None`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in wrapper return function(*args, **kwargs) ^^^^^^^^^^^^^^^^^^^^^^^^^ File <str>, line <n>, in test_com`
...
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_gzip.py", line 997, in wrapper
    return function(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/work/suites/cpython/Lib/test/test_gzip.py", line 1064, in test_compress_infile_outfile_default
    self.asse`
