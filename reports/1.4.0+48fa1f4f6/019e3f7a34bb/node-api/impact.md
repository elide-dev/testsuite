...
### 37 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc> │ │─ S`
...
### 18 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === <str> │ │ │ │ In file <loc> │ │─ Stack Trace ────────`
...
### 17 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc> │ │─ Stack Trace ────────────`
...
distinct messages:
- `(node:10134) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10134) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9481) Warning: A Warning
(node:9481) CustomWarning: A Warning
(node:9481) Warning: A Warning
(node:9481) CustomWarning: A Warning
(node:9481) [CODE001] CustomWarning: A Warning
(node:9481) CustomWarning: A Warning
(node:9481) [CODE001] CustomWarning: A Warning
(node:9481) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10381) Warning: test
(node:10381) DeprecationWarning: test
(node:10381) Warning: test
(node:10381) DeprecationWarning: test
(node:10381) Error: test
(node:10381) Warning: test
...
### 1 × `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@1f1dc975: [[B@46b92fff], [byte[]] com.oracle.truffle.api.dsl.Unsup`

distinct messages:
- `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@1f1dc975: [[B@46b92fff], [byte[]]
com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSCollectionsNormalizeNodeGen@1f1dc975: [[B@46b92fff], [byte[]]
	at com.oracle`
...
distinct messages:
- `7/3/2026, 1:22:41 AM start test
╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'prototype' of undefined                     │
│                                                                             │
│ In file test/parallel/test`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@2e72875f === [B@5ce3577a │ │ │ │ In file <loc> │ │─ Stack Tr`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@2e72875f === [B@5ce3577a                                  │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@6fb90c74 │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@6fb90c74                                    │
│                                                                             │
...
│values provided for JSToNumberNodeGen@6abb202c: [[B@361d5a3d], [byte[]]      │
│                                                           `
...
### 1 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at runTest (<loc>) at <loc> at <loc> Mismatched <anonymous> f`

distinct messages:
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at runTest (test-stream2-readable-wrap.js:81:25)
    at test-stream2-readable-wrap.js:97:1
    at test-stream2-readable-wrap.js:1`
example test: `test/parallel/test-stream2-readable-wrap.js`
...
### 1 × `TypeError: Cannot read property <str> of undefined at <loc> at _return (<loc>) TypeError: Cannot read property <str> of undefined at <loc> at _return (<loc>)`
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6328-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6328-64K.txt of length 65536
