...
### 82 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ co`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'internal/async_hooks'                        │
│                                                                             │
│ In file test/parallel/test-async-hooks-enabledhooksexits.j`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'internal/async_hooks'                        │
│                                                                             │
│ In file test/parallel/test-async-hooks-http-agent-destroy.`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'internal/async_hooks'                        │
│                                                                             │
...
example test: `test/parallel/test-async-hooks-enabledhooksexits.js`

### 77 × `╭─────────────────────────────────────────────────────────────────────────────╮ │Error: node:worker_threads: new Worker() is not implemented yet in Elide │ │ │ `
...
example test: `test/parallel/test-async-hooks-worker-asyncfn-terminate-4.js`

### 47 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Missing expected exception │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n`
...
### 33 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc>: │ │ ╭`
...
│ReferenceError: setTimeout is not defined                                    │
│                                                                             │
│ In file test/parallel/test-fs-watch-recursive-add-folder.j`
example test: `test/parallel/test-eventtarget-memoryleakwarning.js`

### 15 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: path must be a string, Buffer, or │ │fi`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: path must be a string, Buffer, or    │
│file: URL                                                                    │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: path must be a string, Buffer, or    │
...
### 15 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ │ `
...
│                                                                             │
│ In file test/parallel/test-fs-open-flags.js:42:27:        `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'internal/fs/utils'                           │
│                                                                             │
│ In file test/parallel/test-fs-rm.js:11:35:                `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'module'                                      │
│                                                                             │
│ In file test/parallel/test-module-create-require-multibyte`
example test: `test/parallel/test-assert-myers-diff.js`

### 15 × `Node API test timed out`

distinct messages:
- `Node API test timed out`
example test: `test/parallel/test-fs-read-stream-fd-leak.js`

### 9 × `Mismatched %s function calls. Expected %s, actual %d. noop exactly <n> <n> at Proxy.mustCall (<loc>) at <loc>`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
...
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 2
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-event-emitter-once.js:48:20`
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-fs-rmdir-throws-not-found.js:32:17`
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-fs-watch-abort-signal.js:29:32`
example test: `test/parallel/test-async-hooks-enable-disable.js`

### 9 × `Mismatched %s function calls. Expected %s, actual %d. noop exactly <n> <n> at Proxy.mustCall (<loc>) at <loc> Mismatched %s function calls. Expected %s, actual `

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-async-hooks-enable-recursive.js:8:16
Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 2 0
    `
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 2 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-fs-write-stream-double-close.js:14:18
Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
   `
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 2
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-once-readable-pipe.js:24:29
Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.`
example test: `test/parallel/test-async-hooks-enable-recursive.js`

### 8 × `╭─────────────────────────────────────────────────────────────────────────────╮ │Error: node:child_process: spawn() is not implemented yet in Elide │ │ │ │ In f`
...
│Error: node:child_process: spawn() is not implemented yet in Elide           │
│                                                                             │
│ In file test/parallel/test-process-kill-null.js:27:13:    `
example test: `test/parallel/test-diagnostics-channel-child-process.js`

### 8 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at Proxy.mustCall (<loc>) at <loc> Mismatched %s function calls. Expected %s, `

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-readable-emit-readable-short-stream.js:20:19
Mismatched %s function calls. Expected %s, actual %d. <anony`
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 6 1
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-readable-hwm-0-async.js:15:16
Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    `
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 12 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-readable-infinite-read.js:11:16
Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactl`
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1`
example test: `test/parallel/test-stream-readable-emit-readable-short-stream.js`
...
### 7 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: callback must be a function │ │ │ │ In `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: callback must be a function          │
│                                                                             │
│ In file test/parallel/test-fs-make-callback.js:21:5:      `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: callback must be a function          │
│                                                                             │
│ In file test/parallel/test-fs-close-errors.js:17:3:       `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: callback must be a function          │
│                                                                             │
│ In file test/parallel/test-fs-exists.js:28:1:             `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: callback must be a function          │
│                                                                             │
│ In file test/parallel/test-fs-fsync.js:54:3:              `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: callback must be a function          │
│                                                                             │
│ In file test/parallel/test-fs-makeStatsCallback.js:19:5:  `
example test: `test/parallel/test-fs-make-callback.js`

### 7 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at Proxy.mustCall (<loc>) at <loc>`
...
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-readable-end-destroyed.js:14:24`
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-transform-flush-data.js:26:21`
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-unshift-empty-chunk.js:77:20`
example test: `test/parallel/test-stream-err-multiple-callback-construction.js`
...
### 6 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ de`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'zlib/iter'                                   │
│                                                                             │
...
│TypeError: Cannot load module: 'zlib/iter'                                   │
│                                                                             │
│ In file test/parallel/test-stream-iter-transform-sync.js:2`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'zlib/iter'                                   │
│                                                                             │
│ In file test/parallel/test-stream-iter-transform-roundtrip`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'zlib/iter'                                   │
│                                                                             │
...
### 6 × `AssertionError: function should not have been called at <loc> at Function.fail (native) at mustNotCall (<loc>)`
...
### 6 × `Uncaught (in promise) TypeError: path must be a string, Buffer, or file: URL`
...
### 5 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file test/paralle`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'bindStore' of undefined                     │
│                                                                             │
...
### 4 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ │ │→ <n> │ `
...
│                                                                             │
│ In file test/parallel/test-process-umask.js:46:1:         `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
...
### 4 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │java.lang.UnsupportedOperationException: process.chdir() is not yet │ │implemen`
...
### 4 × `Uncaught (in promise) TypeError: fromSync is not a function`

distinct messages:
- `Uncaught (in promise) TypeError: fromSync is not a function`
...
│deepStrictEqual ['a', 'b', Symbol(1), Symbol(2)]                             │
│                                                           `
example test: `test/parallel/test-vm-ownpropertysymbols.js`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: Creating Buffer instances is not │ │all`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ vm.ru`
...
│AssertionError: undefined === 42                                             │
│                                                                             │
│ In file test/parallel/test-vm-strict-assign.js:12:1:      `
example test: `test/parallel/test-vm-context-property-forwarding.js`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │RangeError: Maximum call stack size exceeded │ │ │ │ In file <loc>: │ │ ╭─ │ │ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│RangeError: Maximum call stack size exceeded                                 │
│                                                                             │
│ In file test/parallel/test-console-no-swallow-stack-overfl`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│RangeError: Maximum call stack size exceeded                                 │
│                                                                             │
...
example test: `test/parallel/test-console-no-swallow-stack-overflow.js`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Buffer.from: unsupported input type │ │ │ │ In file <loc>: │ │ ╭─ │ `
...
example test: `test/parallel/test-buffer-tojson.js`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Readable.toWeb is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <`
...
### 3 × `╭─────────────────────────────────────────────────────────────────────────────╮ │Error: node:child_process: exec() is not implemented yet in Elide │ │ │ │ In fi`
...
│Error: node:child_process: exec() is not implemented yet in Elide            │
│                                                                             │
│ In file test/parallel/test-stream-pipeline-process.js:16:3`
- `╭─────────────────────────────────────────────────────────────────────────────╮
│Error: node:child_process: exec() is not implemented yet in Elide            │
│                                                                             │
│ In file test/parallel/test-worker-init-failure.js:50:14:  `
...
example test: `test/parallel/test-module-wrapper.js`

### 3 × `╭─────────────────────────────────────────────────────────────────────────────╮ │Error: node:child_process: fork() is not implemented yet in Elide │ │ │ │ In fi`
...
example test: `test/parallel/test-process-external-stdio-close.js`
...
### 3 × `AssertionError: undefined deepStrictEqual {foo: <str>} at Function.deepStrictEqual (native) at checkAsync (<loc>) at checkAsync (<loc>) at <loc>`
...
### 3 × `Uncaught (in promise) TypeError: hrtime is not a function`
...
│                                                                             │
│ In file test/parallel/test-process-getactiveresources-trac`
example test: `test/parallel/test-process-getactiveresources-track-multiple-timers.js`

### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ assert.`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ functio`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ vm.runI`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: 'undefined' === 'function'                                   │
│                                                                             │
│ In file test/parallel/test-vm-harmony-symbols.js:30:1:    `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: 'undefined' === 'function'                                   │
│                                                                             │
│ In file test/parallel/test-vm-proxies.js:11:1:            `
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: data must be a string, Buffer, │ │Typed`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: data must be a string, Buffer,       │
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: fd must be a number │ │ │ │ In file <lo`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: fd must be a number                  │
│                                                                             │
│ In file test/parallel/test-fs-fchown.js:8:3:              `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: fd must be a number                  │
│                                                                             │
│ In file test/parallel/test-fs-fchmod.js:17:3:             `
...
│non-object                                                                   │
│                                                           `
example test: `test/parallel/test-vm-create-context-arg.js`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: writeSync: data must be a Buffer or │ │`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: writeSync: data must be a Buffer or  │
│string                                                                       │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: writeSync: data must be a Buffer or  │
...
example test: `test/parallel/test-stream3-cork-uncork.js`

### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ │ │`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === 'Hello 42 '                                    │
│                                                                             │
...
example test: `test/parallel/test-console-tty-colors-per-stream.js`

### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ con`
...
│                                                                             │
│ In file test/parallel/test-vm-source-map-url.js:9:3:      `
...
│                                                                             │
│ In file test/parallel/test-diagnostics-channel-tracing-cha`
example test: `test/parallel/test-diagnostics-channel-tracing-channel-sync-run-stores.js`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │ReferenceError: WebAssembly is not defined │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>│ │ ╭─ │ │ <n> │ cons`
...
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'domain'                                      │
│                                                                             │
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc>:│ │ ╭─`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fromSync is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ /`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: fromSync is not a function                                        │
│                                                                             │
│ In file test/parallel/test-stream-iter-pull-sync.js:10:35:`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: fromSync is not a function                                        │
│                                                                             │
│ In file test/parallel/test-stream-iter-from-sync.js:10:20:`
...
### 2 × `Error: foobar Error: foobar Error: foobar`
...
### 2 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at mustCall (<loc>) at _expectWarning (<loc>) at Proxy.expectWarning (<loc>) a`
...
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    ...
    at Proxy.expectWarning (/wor`
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at _expectWarning (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:750:10)
    at Proxy.expectWarning (/wor`
example test: `test/parallel/test-module-parent-setter-deprecation.js`

### 2 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at mustCall (<loc>) at Proxy.expectsError (<loc>) at <loc> Mismatched %s funct`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at Proxy.expectsError (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:796:10)
    at test-stream-readable-`
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at Proxy.expectsError (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:796:10)
    at test-stream-writable-`
...
### 2 × `Uncaught (in promise) TypeError: broadcast is not a function`
...
### 2 × `Uncaught (in promise) TypeError: from is not a function`
...
distinct messages:
- `(node:10330) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10330) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9675) Warning: A Warning
(node:9675) CustomWarning: A Warning
(node:9675) Warning: A Warning
(node:9675) CustomWarning: A Warning
(node:9675) [CODE001] CustomWarning: A Warning
(node:9675) CustomWarning: A Warning
(node:9675) [CODE001] CustomWarning: A Warning
(node:9675) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10590) Warning: test
(node:10590) DeprecationWarning: test
(node:10590) Warning: test
(node:10590) DeprecationWarning: test
(node:10590) Error: test
(node:10590) Warning: test
...
### 1 × `[EventLoop] external task threw: AssertionError: ENOENT: no such file or directory, open <str> === DESTROYED <loc>.runtime.JSException: AssertionError: ENOENT: `

distinct messages:
- `[EventLoop] external task threw: AssertionError: ENOENT: no such file or directory, open 'unknown' === DESTROYED
com.oracle.truffle.js.runtime.JSException: AssertionError: ENOENT: no such file or directory, open 'unknown' === DESTROYED
[EventLoop] external task threw: AssertionError: ENOENT: no such`
example test: `test/parallel/test-fs-stream-destroy-emit-error.js`

### 1 × `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@4e4bee50: [[B@5bc28c9d], [byte[]] com.oracle.truffle.api.dsl.Unsup`

distinct messages:
- `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@4e4bee50: [[B@5bc28c9d], [byte[]]
com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSCollectionsNormalizeNodeGen@4e4bee50: [[B@5bc28c9d], [byte[]]
	at com.oracle`
...
distinct messages:
- `7/2/2026, 11:35:08 PM start test
╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'prototype' of undefined                     │
│                                                                             │
...
### 1 × `>> READ >> READ data emitted aaa pushing data emitted <n> data emitted <n> data emitted <n> data emitted <n> data emitted <n> data emitted <n> data emitted <n> `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: -<n> === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ b[<n>] = -`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [] deepStrictEqual [<str>] │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@791a68c3 === [B@3b57c6d1 │ │ │ │ In file <loc>: │ │ ╭─ │ │ <`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@791a68c3 === [B@3b57c6d1                                  │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: {resultHasOwn: {onSelf: false, onSelfGetter: true, │ │onSelfInd`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: {resultHasOwn: {onSelf: false, onSelfGetter: true,           │
│onSelfIndexed: false, onOuterProto: false, onOuterProtoGetter: true, …},     │
│resultDesc: {onSelf: undefined, onSelfGetter: {value: {}, w`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ // message.`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: 10 === 0                                                     │
│                                                                             │
│ In file test/parallel/test-worker-message-port-transfer-ta`
example test: `test/parallel/test-worker-message-port-transfer-target.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ ʼ, ctx); │ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: 1 === 3                                                      │
│                                                                             │
│ In file test/parallel/test-vm-property-definer-interceptio`
example test: `test/parallel/test-vm-property-definer-interception.js`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ process.uma`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: 18 === 436                                                   │
│                                                                             │
│ In file test/parallel/test-process-umask-mask.js:27:3:    `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ script.runI`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: 2 === 5                                                      │
│                                                                             │
│ In file test/parallel/test-vm-new-script-new-context.js:55`
example test: `test/parallel/test-vm-new-script-new-context.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ vm.runInNew`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: 2 === 5                                                      │
│                                                                             │
│ In file test/parallel/test-vm-run-in-new-context.js:43:1: `
example test: `test/parallel/test-vm-run-in-new-context.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc>│ │ ╭─ │ │ <n> │ a.runInAsyncS`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ const e`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: '/work/.harness/work/node-api/node-api-overlay' === '.'      │
│                                                                             │
│ In file test/parallel/test-path-resolve.js:91:3:          `
example test: `test/parallel/test-path-resolve.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ const r`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: 'undefined' === 'function'                                   │
│                                                                             │
│ In file test/parallel/test-vm-function-declaration.js:42:1`
example test: `test/parallel/test-vm-function-declaration.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ write: `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === undefined │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ } c`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: '' === undefined                                             │
│                                                                             │
│ In file test/parallel/test-console-methods.js:52:5:       `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Case <n> failed: Object.keys │ │ │ │ In file <loc>: │ │ ╭─ │ │ `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: false == true │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ let cache`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: false == true                                                │
│                                                                             │
│ In file test/parallel/test-vm-createcacheddata.js:12:1:   `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: false == true │ │ │ │ In file <loc>│ │ ╭─ │ │ <n> │ const inspe`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: false === true │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ assert.n`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: false === true                                               │
│                                                                             │
│ In file test/parallel/test-whatwg-url-properties.js:98:3: `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: Cannot read property <str> of │ │undefi`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: Cannot read property 'prototype' of  │
│undefined                                                                    │
│                                                           `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: fs._toUnixTimestamp is not a function│ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: fs._toUnixTimestamp is not a function│
│                                                                             │
│ In file test/parallel/test-fs-timestamp-parsing-error.js:7`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: readSync: offset/length out of bounds│ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: readSync: offset/length out of bounds│
│                                                                             │
│ In file test/parallel/test-fs-read-empty-buffer.js:13:1:  `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: watchFile: listener must be a │ │functi`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: watchFile: listener must be a        │
│function                                                                     │
│                                                           `
example test: `test/parallel/test-fs-watchfile.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Missing expected exception │ │ │ │ In file <loc>:│ │ ╭─ │ │ <n>`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: null == true │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ } catch (e`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@77f310eb │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n>`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@77f310eb                                    │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === {} │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ assert`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === <n> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ │ │→ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === 20                                             │
│                                                                             │
│ In file test/parallel/test-vm-indexed-properties.js:17:1: `
example test: `test/parallel/test-vm-indexed-properties.js`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === true │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ vm.r`
...
example test: `test/parallel/test-vm-property-not-on-sandbox.js`
...
│values provided for JSToNumberNodeGen@6fe9fb74: [[B@3a7243c2], [byte[]]      │
│                                                           `
example test: `test/parallel/test-fs-promises-writefile-typedarray.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │DOMException │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ │ │→ <n> │ port1.postMessa`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │DOMException │ │ │ │ In file <loc>:│ │ ╭─ │ │ <n> │ │ │→ <n> │ basePort1.postMe`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │null │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ write() { │ │→ <n> │ throw null; /`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │ReferenceError: baz is not defined │ │ │ │ In file <loc> │ │─ Stack Trace ─────`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│ReferenceError: baz is not defined                                           │
│                                                                             │
│ In file test/parallel/test-vm-static-this.js:1:28         `
example test: `test/parallel/test-vm-static-this.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │ReferenceError: BroadcastChannel is not defined │ │ │ │ In file <loc>: │ │ ╭─ │`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │ReferenceError: WebAssembly is not defined │ │ │ │ In file <loc> │ │─ Stack Tra`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: boundedChannel.run is not a function │ │ │ │ In file <loc>:│ │ ╭─ │ `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: BroadcastChannel is not a constructor │ │ │ │ In file <loc>: │ │ ╭─ `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ js`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'stream/consumers'                            │
│                                                                             │
│ In file test/parallel/test-stream-consumers.js:14:5:      `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ No`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'internal/event_target'                       │
│                                                                             │
│ In file test/parallel/test-eventtarget-brandcheck.js:12:5:`
example test: `test/parallel/test-eventtarget-brandcheck.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ re`
...
example test: `test/parallel/test-console-formatTime.js`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file test/parallel/test-worker-`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'internal/worker/js_transferable'             │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: channel.port1.on is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Creating Buffer instances is not allowed │ │ │ │ In file <loc> │ │─ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Creating Buffer instances is not allowed                          │
│                                                                             │
│ In file test/parallel/test-buffer-constructor-outside-node`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fromSync is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ c`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fromWritable is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n>`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fs.mkdtempDisposableSync is not a function │ │ │ │ In file <loc>: │ `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: fs.mkdtempDisposableSync is not a function                        │
│                                                                             │
│ In file test/parallel/test-fs-mkdtempDisposableSync.js:14:`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: m.createCachedData is not a function │ │ │ │ In file <loc>: │ │ ╭─ │`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Object{} is not iterable │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ fun`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: port1.on is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ }`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: port1.on is not a function │ │ │ │ In file <loc>│ │ ╭─ │ │ <n> │ let`
...
example test: `test/parallel/test-worker-message-port-infinite-message-loop.js`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: port2.on is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ p`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: port2.once is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Readable.toWeb is not a function │ │ │ │ In file <loc>:│ │ ╭─ │ │ <n`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: sb.entries is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: storage.withScope is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: toReadable is not a function │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: URLPattern is not a constructor │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: vm.SyntheticModule is not a constructor │ │ │ │ In file <loc>: │ │ ╭`
...
### 1 × `╭─────────────────────────────────────────────────────────────────────────────╮ │Error: something went wrong │ │ │ │ In file <loc>│ │ ╭─ │ │ <n> │ this.push(chu`
...
### 1 × `AssertionError: {foo: <str>} deepStrictEqual undefined at Function.deepStrictEqual (native) at <loc> at _return (<loc>) at <loc>`

distinct messages:
- `AssertionError: {foo: 'bar'} deepStrictEqual undefined
    at Function.deepStrictEqual (native)
...
### 1 × `AssertionError: undefined deepStrictEqual {foo: <str>} at Function.deepStrictEqual (native) at checkEnd (<loc>) at checkEnd (<loc>) at <loc> AssertionError: fun`
...
### 1 × `first cb second cb [EventLoop] external task threw: AssertionError: undefined === BAM <loc>.runtime.JSException: AssertionError: undefined === BAM`

distinct messages:
- `first cb
second cb
[EventLoop] external task threw: AssertionError: undefined === BAM
com.oracle.truffle.js.runtime.JSException: AssertionError: undefined === BAM`
example test: `test/parallel/test-fs-write-stream-err.js`

### 1 × `foo foo bar %s %s foo bar hop {slashes: <str>} {foo: <str>, Symbol(nodejs.util.inspect.custom): () => <str>} foo foo bar %s %s foo bar hop {slashes: <str>} {foo`
...
### 1 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> at least <n> <n> at Proxy.mustCallAtLeast (<loc>) at <loc>`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> at least 20 2
...
example test: `test/parallel/test-stream-pipe-flow-after-unpipe.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> at least <n> <n> at Proxy.mustCallAtLeast (<loc>) at <loc> Mismatched %s function calls. Expec`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> at least 2 0
    at Proxy.mustCallAtLeast (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:543:10)
    at test-async-hooks-close-during-destroy.js:14:16
Mismatched %s function calls. Expected %s, actual %d. <anonymo`
example test: `test/parallel/test-async-hooks-close-during-destroy.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at mustCall (<loc>) at _expectWarning (<loc>) at <loc> at Array.forEach (nativ`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 3 0
    at mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at _expectWarning (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:750:10)
    at /work/.harness/work/node-`
example test: `test/parallel/test-module-circular-dependency-warning.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at mustCall (<loc>) at Proxy.expectsError (<loc>) at <loc>`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at Proxy.expectsError (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:796:10)
    at test-stream-transform`
example test: `test/parallel/test-stream-transform-callback-twice.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at mustCall (<loc>) at Proxy.expectsError (<loc>) at testPushArg (<loc>) at <l`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at Proxy.expectsError (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:796:10)
    at testPushArg (test-str`
example test: `test/parallel/test-stream-readable-invalid-chunk.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at mustCall (<loc>) at Proxy.mustSucceed (<loc>) at <loc> at <loc> at _return `

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at Proxy.mustSucceed (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:535:10)
    at test-fs-write-buffer.j`
example test: `test/parallel/test-fs-write-buffer.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at Proxy.mustCall (<loc>) at track (<loc>) at <loc> Mismatched %s function cal`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at track (test-diagnostics-channel-module-import-error.js:12:17)
    at test-diagnostics-channel-module-import-error.js:`
example test: `test/parallel/test-diagnostics-channel-module-import-error.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly <n> <n> at Proxy.mustCall (<loc>) at Writable.<anonymous> (<loc>) at Writable._return `

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at Writable.<anonymous> (test-stream-writable-end-multiple.js:17:23)
    at Writable._return (/work/.harness/work/node-a`
example test: `test/parallel/test-stream-writable-end-multiple.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. noop at least <n> <n> at Proxy.mustCallAtLeast (<loc>) at <loc>`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. noop at least 1 0
    at Proxy.mustCallAtLeast (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:543:10)
    at test-fs-write-stream-fs.js:28:22`
example test: `test/parallel/test-fs-write-stream-fs.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. noop exactly <n> <n> at Proxy.mustCall (<loc>) at <loc> at _return (<loc>)`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-end-paused.js:41:27
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)`
example test: `test/parallel/test-stream-end-paused.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. noop exactly <n> <n> at Proxy.mustCall (<loc>) at <loc> at _return (<loc>) Mismatched %s function calls. E`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-async-hooks-enable-during-promise.js:7:18
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/ind`
example test: `test/parallel/test-async-hooks-enable-during-promise.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. noop exactly <n> <n> at Proxy.mustCall (<loc>) at check (<loc>) at <loc>`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at check (test-stream-readable-readable-then-resume.js:27:22)
    at test-stream-readable-readable-then-resume.js:10:1`
example test: `test/parallel/test-stream-readable-readable-then-resume.js`

### 1 × `Mismatched %s function calls. Expected %s, actual %d. noop exactly <n> <n> at Proxy.mustCall (<loc>) at test (<loc>) at <loc> Mismatched %s function calls. Expe`

distinct messages:
- `Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test (test-stream-readable-no-unneeded-readable.js:30:30)
    at test-stream-readable-no-unneeded-readable.js:42:3
Mismatche`
example test: `test/parallel/test-stream-readable-no-unneeded-readable.js`
...
distinct messages:
- `node-api test exited with code 1`
example test: `test/parallel/test-stream-writable-samecb-singletick.js`
...
not ok 1 - module is not instantiated yet
  ...
  code: 'ERR_ASSERTION'
  ...
# Subtest: simple module with top-level awa`
...
### 1 × `Uncaught (in promise) AssertionError: Got unwanted exception: callback must be a function`

distinct messages:
- `Uncaught (in promise) AssertionError: Got unwanted exception: callback must be a function`
example test: `test/parallel/test-fs-write-optional-params.js`

### 1 × `Uncaught (in promise) AssertionError: Got unwanted exception: data must be a string, Buffer, TypedArray, or DataView Uncaught (in promise) AssertionError: Got u`

distinct messages:
- `Uncaught (in promise) AssertionError: Got unwanted exception: data must be a string, Buffer, TypedArray, or DataView
Uncaught (in promise) AssertionError: Got unwanted exception: data must be a string, Buffer, TypedArray, or DataView
Uncaught (in promise) AssertionError: Got unwanted exception: data`
...
### 1 × `Uncaught (in promise) Error: kaboom`
...
### 1 × `Uncaught (in promise) Error: node:worker_threads: new Worker() is not implemented yet in Elide Uncaught (in promise) TypeError: path must be a string, Buffer, o`
...
### 1 × `Uncaught (in promise) TypeError: from is not a function Uncaught (in promise) TypeError: Cannot read property <str> of undefined Uncaught (in promise) TypeError`
...
Uncaught (in promise) TypeError: Cannot read property 'from' of undefined
Uncaught (in promise) TypeError: from is not a function
Uncaught (in promise) TypeError: broadca`
...
### 1 × `Uncaught (in promise) TypeError: fromSync is not a function Uncaught (in promise) AssertionError: Got unwanted exception: fromSync is not a function Uncaught (i`

distinct messages:
- `Uncaught (in promise) TypeError: fromSync is not a function
Uncaught (in promise) AssertionError: Got unwanted exception: fromSync is not a function
Uncaught (in promise) TypeError: from is not a function
Uncaught (in promise) TypeError: from is not a function
Uncaught (in promise) TypeError: fromSy`
example test: `test/parallel/test-stream-iter-consumers-bytes.js`

### 1 × `Uncaught (in promise) TypeError: fromSync is not a function Uncaught (in promise) TypeError: from is not a function Uncaught (in promise) TypeError: from is not`
...
### 1 × `Uncaught (in promise) TypeError: fromSync is not a function Uncaught (in promise) TypeError: shareSync is not a function`
...
### 1 × `Uncaught (in promise) TypeError: fsPromises.mkdtempDisposable is not a function`

distinct messages:
- `Uncaught (in promise) TypeError: fsPromises.mkdtempDisposable is not a function`
...
### 1 × `Uncaught (in promise) TypeError: pipeTo is not a function`
...
### 1 × `Uncaught (in promise) TypeError: read: buffer must be a Buffer or TypedArray Uncaught (in promise) TypeError: Cannot read property <str> of undefined`
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6408-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6408-64K.txt of length 65536
