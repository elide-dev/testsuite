...
- Image digest: `d256b49f15ac282b9071c698db8c75b5a3d27f91c15a6d50d4bb28f3a78112be`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-07-02T23:34:48.769Z → 2026-07-02T23:36:43.174Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 227/1563 (17.96%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 227 | 1022 | 15 | 299 | 2 | 184 |
...
# todo 0
# duration_ms 3
- `test/parallel/test-async-hooks-close-during-destroy.js` — fail — Mismatched %s function calls. Expected %s, actual %d. <anonymous> at least 2 0
...
- `test/parallel/test-async-hooks-enable-recursive.js` — fail — Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
...
- `test/parallel/test-async-hooks-enable-during-promise.js` — fail — Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
Mismatched %s function calls. Expected %s, actual %d. noop at least 1 0
    ...
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
Mismatched %s function calls. Expected %s, actual %d. noop at least 2 0
    at Proxy.mustCallAtLeast (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:543:10)
...
- `test/parallel/test-async-hooks-disable-during-promise.js` — fail — Mismatched %s function calls. Expected %s, actual %d. noop exactly 2 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
- `test/parallel/test-async-hooks-enable-disable.js` — fail — Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
│→  8 │ const { freeParser, parsers, HTTPParser } = require('_http_common');  │
│   9 │                                                                       │
│  10 │ let storeGCed = false;                                                │
│  11 │                                                                       │
│   · │                                                                       │
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
│ ╭─ [js] :program                            test-async-local-storage-http-p │
│ │                                                                           │
│ · elide run test/parallel/test-async-local-                                 │
│                                                                             │
│─ Advice ────────────────────────────────────────────────────────────────────│
...
│                                                                             │
│ In file test/parallel/test-console-no-swallow-stack-overflow.js:12:22:      │
│    ╭─                                                                       │
...
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
│ ╭─ [js] write                               test-console-no-swallow-stack-o │
│ │─ [js] write                               test-console-no-swallow-stack-o │
│ │─ [js] write                               test-console-no-swallow-stack-o │
│ │─ [js] write                               test-console-no-swallow-stack-o │
│ │─ [js] write                               test-console-no-swallow-stack-o │
...
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
│ ╭─ [js] assertEqualName                        test-console-methods.js:52:5 │
│ │                                                                           │
...
- `test/parallel/test-diagnostics-channel-module-import-error.js` — fail — Mismatched %s function calls. Expected %s, actual %d. <anonymous> exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
- `test/parallel/test-diagnostics-channel-tracing-channel-promise-error.js` — fail — Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 0
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
│    ╭─                                                                       │
│  25 │                                                                       │
│→ 26 │ assert.throws(() => console.table([], false), {                       │
...
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
│ ╭─ [js] :program                                test-console-table.js:26:1- │
│ │                                                                           │
...
│→  7 │ const http = require('http');                                         │
│   8 │                                                                       │
│   9 │ const als = new AsyncLocalStorage();                                  │
│  10 │ let context;                                                          │
│   · │                                                                       │
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
...
│    ╭─                                                                       │
│  45 │                                                                       │
│→ 46 │   boundedChannel.start.bindStore(store, (context) => context.value);  │
│  47 │                                                                       │
│  48 │   boundedChannel.subscribe({                                          │
│  49 │     start() {},                                                       │
│   · │                                                                       │
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
...
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
│ ╭─ [js] :program                            test-diagnostics-channel-symbol │
│ │                                                                           │
│ · elide run test/parallel/test-diagnostics-                                 │
│                                                                             │
│─ Advice ────────────────────────────────────────────────────────────────────│
...
│    ╭─                                                                       │
│  18 │ channel.traceSync(common.mustCall(() => {                             │
│→ 19 │   assert.deepStrictEqual(store.getStore(), context);                  │
│  20 │ }));                                                                  │
│  21 │ assert.strictEqual(store.getStore(), undefined);                      │
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
...
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
│ ╭─ [js] :program                             test-diagnostics-channel-proce │
│ │                                                                           │
...
│                                                                             │
╰─────────────────────────────────────────────────────────────────────────────╯
- `test/parallel/test-diagnostics-channel-bounded-channel-scope-transform-error.js` — fail — ╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'bindStore' of undefined                     │
│                                                                             │
│ In file test/parallel/test-diagnostics-channel-bounded-channel-scope-transfo│
│    ╭─                                                                       │
│  31 │ // Bind store with a transform that throws                            │
│→ 32 │ boundedChannel.start.bindStore(store, () => {                         │
│  33 │   throw transformError;                                               │
│  34 │ });                                                                   │
│  35 │                                                                       │
│   · │                                                                       │
│─ Stack Trace ───────────────────────────────────────────────────────────────│
...
│    ╭─                                                                       │
│  21 │   const context = { id: 123 };                                        │
│→ 22 │   const result = boundedChannel.run(context, () => {                  │
│  23 │     return 'success';                                                 │
│  24 │   });                                                                 │
│  25 │                                                                       │
│   · │                                                                       │
...
│                                                                             │
╰─────────────────────────────────────────────────────────────────────────────╯
- `test/parallel/test-diagnostics-channel-bind-store.js` — fail — AssertionError: {foo: 'bar'} deepStrictEqual undefined
    at Function.deepStrictEqual (native)
...
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
│ ╭─ [js] :program                           test-diagnostics-channel-object- │
│ │                                                                           │
│ · elide run test/parallel/test-diagnostics                                  │
│                                                                             │
│─ Advice ────────────────────────────────────────────────────────────────────│
...
- `test/parallel/test-event-emitter-once.js` — fail — Mismatched %s function calls. Expected %s, actual %d. noop exactly 1 2
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
│─ Stack Trace ───────────────────────────────────────────────────────────────│
│                                                                             │
│ ╭─ [js] :program                              test-dns-multi-channel.js:6:1 │
│ │                                                                           │
...
## 🟢 New passes (184) — consider advancing the baseline
...
- `test/parallel/test-fs-watch-ignore-recursive-regexp.js`
- `test/parallel/test-fs-watch-ignore-recursive-glob.js`
- `test/parallel/test-fs-watch-ignore-mixed.js`
- `test/parallel/test-fs-watch-ignore-recursive-glob-subdirectories.js`
- `test/parallel/test-fs-watch-ignore-recursive-mixed.js`
- `test/parallel/test-fs-watch-ignore-regexp.js`
