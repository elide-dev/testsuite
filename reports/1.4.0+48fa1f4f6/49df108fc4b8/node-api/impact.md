...
│                                                                             │
│ In file test/parallel/test-async-hooks-worker-asyncfn-term`
example test: `test/parallel/test-async-hooks-worker-asyncfn-terminate-2.js`

### 49 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Missing expected exception │ │ │ │ In file <loc> │ │─ Stack Tra`
...
### 41 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc> │ │─ Stack Trace ───`
...
### 34 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc> │ │─ S`
...
### 16 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <n> === <n> │ │ │ │ In file <loc> │ │─ Stack Trace ────────────`
...
### 16 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: false == true │ │ │ │ In file <loc> │ │─ Stack Trace ──────────`
...
### 16 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │ReferenceError: setTimeout is not defined │ │ │ │ In file <loc>: │ │ ╭─ │ │─ St`
...
### 15 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: <str> === <str> │ │ │ │ In file <loc> │ │─ Stack Trace ────────`
...
### 13 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ co`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'node:zlib'                                   │
│                                                                             │
│ In file test/parallel/test-async-local-storage-weak-asyncw`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'http'                                        │
│                                                                             │
│ In file test/parallel/test-diagnostics-channel-http.js:5:1`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'dgram'                                       │
│                                                                             │
│ In file test/parallel/test-dns-channel-cancel-promise.js:5`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'dgram'                                       │
│                                                                             │
│ In file test/parallel/test-dns-resolver-max-timeout.js:6:1`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'stream/consumers'                            │
│                                                                             │
│ In file test/parallel/test-fs-promises-file-handle-stream.`
...
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    ...
    at test-fs-rmdir-throws-not-found.js:1:1`
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-fs-watch-abort-signal.js:29:32
    at test-fs-watch-abort-signal.js:1:1`
example test: `test/parallel/test-async-hooks-enable-disable.js`

### 9 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === <str> │ │ │ │ In file <loc> │ │─ Stack Trace ────`
...
### 8 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: callback must be a function │ │ │ │ In `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: callback must be a function          │
│                                                                             │
│ In file test/parallel/test-fs-fchmod.js:26:3              `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: callback must be a function          │
│                                                                             │
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    ...
    at test-stream-readable-end-destroyed.js:1:1`
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    ...
    at test-stream-unshift-empty-chunk.js:1:1`
example test: `test/parallel/test-stream-err-multiple-callback-construction.js`

### 7 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: false === true │ │ │ │ In file <loc> │ │─ Stack Trace ─────────`
...
### 7 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc> Mismatched <anonymous> function calls. Expe`
...
Mismatc`
- `Mismatched <anonymous> function calls. Expected exactly 12, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-readable-infinite-read.js:11:16
    at test-stream-readable-infinite-read.js:1:1
Mismatched <anonymous> function `
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-transform-final.js:69:17
    at test-stream-transform-final.js:1:1
...
### 6 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === <n> │ │ │ │ In file <loc> │ │─ Stack Trace ──────`
...
### 5 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │java.lang.UnsupportedOperationException: process.chdir() is not yet │ │implemen`
...
### 5 × `╭─────────────────────────────────────────────────────────────────────────────╮ │Error: Readable.wrap() is not implemented │ │ │ │ In file <loc> │ │─ Stack Trac`
...
example test: `test/parallel/test-stream2-readable-wrap-destroy.js`

### 5 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc> Mismatched noop function calls. Expected exactly <`
...
### 4 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === null │ │ │ │ In file <loc> │ │─ Stack Trace ─────`
...
### 4 × `╭─────────────────────────────────────────────────────────────────────────────╮ │Error: ENOENT: no such file or directory, open <str> │ │ │ │ In file <loc> │ │─`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │{} │ │ │ │ In file <loc> │ │─ Stack Trace ─────────────────────────────────────`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: The <str> argument must be of type │ │s`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │null │ │ │ │ In file <loc> │ │─ Stack Trace ───────────────────────────────────`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │RangeError: Maximum call stack size exceeded │ │ │ │ In file <loc> │ │─ Stack T`
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc>: │ │ ╭`
...
│                                                                             │
│ In file test/parallel/test-stream-promises.js:15:20:      `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'on' of undefined                            │
│                                                                             │
│ In file test/parallel/test-stream-compose.js:17:3:        `
...
### 3 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: The <str> argument must be of type string or an instance of │ │Buffe`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fromSync is not a function │ │ │ │ In file <loc> │ │─ Stack Trace ──`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fs.WriteStream is not a function │ │ │ │ In file <loc> │ │─ Stack Tr`
...
### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: receiver is not an EventEmitter │ │ │ │ In file <loc> │ │─ Stack Tra`
...
### 2 × `╭─────────────────────────────────────────────────────────────────────────────╮ │Error │ │ │ │ In file <loc> │ │─ Stack Trace ──────────────────────────────────`
...
### 2 × `Mismatched <anonymous> function calls. Expected at least <n>, actual <n>. at Proxy.mustCallAtLeast (<loc>) at <loc> at <loc> Mismatched <anonymous> function cal`
...
- `Mismatched <anonymous> function calls. Expected at least 1, actual 0.
    at Proxy.mustCallAtLeast (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:543:10)
    at test-stream-unshift-read-race.js:46:18
    at test-stream-unshift-read-race.js:1:1
Mismatched <anonymous> function cal`
example test: `test/parallel/test-async-hooks-close-during-destroy.js`

### 2 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc> Mismatched <anonymous> function calls. Expected ex`
...
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    ...
    at test-fs-write-stream-double-close.js:1:1
Mismatched <anonymous> function calls. Exp`
example test: `test/parallel/test-async-hooks-enable-recursive.js`

### 2 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> Mismatched noop function calls. Expected exactly <n>, actua`
...
distinct messages:
- `(node:10014) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10014) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9379) Warning: A Warning
(node:9379) CustomWarning: A Warning
(node:9379) Warning: A Warning
(node:9379) CustomWarning: A Warning
(node:9379) [CODE001] CustomWarning: A Warning
(node:9379) CustomWarning: A Warning
(node:9379) [CODE001] CustomWarning: A Warning
(node:9379) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10299) Warning: test
(node:10299) DeprecationWarning: test
(node:10299) Warning: test
(node:10299) DeprecationWarning: test
(node:10299) Error: test
(node:10299) Warning: test
...
### 1 × `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@5d8c55e6: [[B@73e8392d], [byte[]] com.oracle.truffle.api.dsl.Unsup`

distinct messages:
- `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@5d8c55e6: [[B@73e8392d], [byte[]]
com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSCollectionsNormalizeNodeGen@5d8c55e6: [[B@73e8392d], [byte[]]
	at com.oracle`
...
### 1 × `<n>/<n>/<n>, <n><loc> AM start test ╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of un`

distinct messages:
- `7/3/2026, 12:37:50 AM start test
╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'prototype' of undefined                     │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@2efeb5d0 === [B@4f9344b1 │ │ │ │ In file <loc> │ │─ Stack Tr`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@2efeb5d0 === [B@4f9344b1                                  │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: null !== null │ │ │ │ In file <loc> │ │─ Stack Trace ──────────`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: true === false │ │ │ │ In file <loc> │ │─ Stack Trace ─────────`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@2962ed7d │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@2962ed7d                                    │
│                                                                             │
...
│values provided for JSToNumberNodeGen@26e30fd3: [[B@73434a14], [byte[]]      │
│                                                           `
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │ReferenceError: process is not defined │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ `
...
│                                                           `
example test: `test/parallel/test-worker-debug.js`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: callback must be a function │ │ │ │ In file <loc> │ │─ Stack Trace ─`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: callbacks.shift(...) is not a function │ │ │ │ In file <loc> │ │─ St`
...
distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'zlib'                                        │
│                                                                             │
│ In file test/parallel/test-stream-iter-transform-coverage.`
example test: `test/parallel/test-stream-iter-transform-coverage.js`

### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>│ │ ╭─ │ │ <n> │ cons`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc>:│ │─ S`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fs._toUnixTimestamp is not a function │ │ │ │ In file <loc> │ │─ Sta`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fs.ReadStream is not a function │ │ │ │ In file <loc> │ │─ Stack Tra`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fs.readv is not a function │ │ │ │ In file <loc> │ │─ Stack Trace ──`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fs.readvSync is not a function │ │ │ │ In file <loc> │ │─ Stack Trac`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fs.writev is not a function │ │ │ │ In file <loc> │ │─ Stack Trace ─`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: fs.writevSync is not a function │ │ │ │ In file <loc> │ │─ Stack Tra`
...
example test: `test/parallel/test-fs-open.js`
...
### 1 × `AssertionError: {foo: <str>} deepStrictEqual undefined at Function.deepStrictEqual (native) at <loc> at _return (<loc>) at <loc> at <loc>`
...
### 1 × `Mismatched <anonymous> function calls. Expected at least <n>, actual <n>. at Proxy.mustCallAtLeast (<loc>) at <loc> at <loc>`
...
### 1 × `Mismatched <anonymous> function calls. Expected at least <n>, actual <n>. at Proxy.mustCallAtLeast (<loc>) at test (<loc>) at <loc> at <loc> Mismatched <anonymo`

distinct messages:
- `Mismatched <anonymous> function calls. Expected at least 1000, actual 2.
    at Proxy.mustCallAtLeast (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:543:10)
    at test (test-stream-pipe-manual-resume.js:13:18)
    at test-stream-pipe-manual-resume.js:33:1
    at test-stream-pip`
...
distinct messages:
- `Mismatched <anonymous> function calls. Expected exactly 6, actual 1.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-readable-hwm-0-async.js:15:16
    at test-stream-readable-hwm-0-async.js:1:1
Mismatched noop function calls. Expec`
example test: `test/parallel/test-stream-readable-hwm-0-async.js`

### 1 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> Mismatched noop function calls. Expected exactly <n>`
...
### 1 × `Mismatched noop function calls. Expected at least <n>, actual <n>. at Proxy.mustCallAtLeast (<loc>) at <loc> at <loc>`
...
### 1 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at check (<loc>) at <loc> at <loc>`
...
### 1 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at test (<loc>) at <loc> at <loc> Mismatched noop function calls. Ex`
...
### 1 × `Uncaught (in promise) AssertionError: Got rejection that did not match expected: TypeError: from is not a function`

distinct messages:
- `Uncaught (in promise) AssertionError: Got rejection that did not match expected: TypeError: from is not a function`
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6154-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6154-64K.txt of length 65536
