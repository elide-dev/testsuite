...
### 6 × `AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000749be0000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000070648e11d750 (heapBase - 4631349045424)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000749bf6429038 points into the stack for thread 0x0000749be0000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007e5bdc000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000070648e11d360 (heapBase - 15351520308384)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007e5bf3d1a448 points into the stack for thread 0x00007e5bdc000cc0
 `
...
### 2 × `AssertionError: function should not have been called at <loc> called with arguments: IncomingMessage [Readable] { socket: <ref *<n>> Socket [Duplex] { _handle: `
...
distinct messages:
- `(node:99982) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:136676) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:112030) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:43623) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 163704]: --- stdout ---

[process 163704]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 19:26:51 GMT\r`
...
+   'Date: Tue, 11 Aug 2026 19:27:53 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.125775.sock',
-   _connections: 1,
-   _handle: {},
-   _listeningId: 2,
-   _pauseOnC`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:44506' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: IncomingMessage [Readable] { socket: Socket [Duplex] { _handle: {}, _allowH`
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@7fde46d7: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@7fde46d7: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@65091108], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:38691`
...
Printing instructions (ip=0x0000601b4c3e209b):
  0x0000601b4c3e1f9b: 0x0`
...
### 1 × `TypeError: Cannot read property <str> of undefined at Readable.<anonymous> (<loc>) at TypeError.get stack (native)`

distinct messages:
- `TypeError: Cannot read property 'socket' of undefined
    at Readable.<anonymous> (test-http-nodelay.js:30:7)
    at TypeError.get stack (native)`
...
- `TypeError: Cannot read property 'id' of undefined
    at Readable.<anonymous> (test-http-client-timeout-agent.js:59:28)
    at TypeError.get stack (native)
TypeError: Cannot read property 'id' of undefined
    at Readable.<anonymous> (test-http-client-timeout-agent.js:59:28)
