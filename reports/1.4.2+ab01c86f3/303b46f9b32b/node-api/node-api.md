...
- Image digest: `303b46f9b32bee38bc9d360319519b74731edacadebabe42ed5d0a531e15d87a`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-12T05:07:30.580Z → 2026-08-12T05:34:24.155Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1324/3071 (62.07%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1324 | 736 | 73 | 938 | 0 | 341 |
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1251]: --- stderr ---
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1262) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-resizable.js` — fail — (node:1503) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
## 🟢 New passes (341) — consider advancing the baseline
