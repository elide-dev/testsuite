...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000759258000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007b250a31d750 (heapBase + 6131908204368)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000075926e4a9038 points into the stack for thread 0x0000759258000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x000076df60000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007b250a31d360 (heapBase + 4701549876064)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000076df779fa448 points into the stack for thread 0x000076df60000cc0
  `
...
distinct messages:
- `(node:84279) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:117951) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:95437) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:36778) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
distinct messages:
- `[process 1251]: --- stderr ---
(node:1251) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.

[process 1251]: --- stdout ---

[process 1251]: status = 0, signal = null
Erro`
...
[process 140047]: --- stdout ---

[process 140047]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 23:12:51 GMT\r`
...
+   'Date: Tue, 11 Aug 2026 23:13:54 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.108123.sock',
-   _connections: 1,
-   _handle: {},
-   _listeningId: 2,
-   _pauseOnC`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:52678' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@56b354d0: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@56b354d0: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@6ed81381], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:35853`
...
### 1 × `GC summary Collected chunk bytes: <n>.00M Collected object bytes: <n>.00M Allocated chunk bytes: <n>.48M Allocated object bytes: <n>.99M Incremental GC count: <`

distinct messages:
- `GC summary
  Collected chunk bytes: 0.00M
  Collected object bytes: 0.00M
  Allocated chunk bytes: 34.48M
  Allocated object bytes: 33.99M
