...
distinct messages:
- `(node:81857) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:115063) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:92779) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:34654) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007dd014000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000077fee5f1d750 (heapBase - 6391683754160)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007dd028469038 points into the stack for thread 0x00007dd014000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000754204000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000077fee5f1d360 (heapBase + 3014563058528)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000075421a83a448 points into the stack for thread 0x0000754204000cc0
  `
...
[process 135313]: --- stdout ---

[process 135313]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Wed, 12 Aug 2026 07:13:48 GMT\r`
...
+   'Date: Wed, 12 Aug 2026 07:14:38 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.105230.sock',
-   _connections: 1,
-   _handle: {},
-   _listeningId: 2,
-   _pauseOnC`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:54831' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@21ec9de8: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@21ec9de8: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@655cf980], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:35021`
...
distinct messages:
- `Error: connect ECONNREFUSED 0:0:0:0:0:0:0:1:32943`
...
### 1 × `GC summary Collected chunk bytes: <n>.00M Collected object bytes: <n>.00M Allocated chunk bytes: <n>.49M Allocated object bytes: <n>.19M Incremental GC count: <`

distinct messages:
- `GC summary
  Collected chunk bytes: 0.00M
  Collected object bytes: 0.00M
  Allocated chunk bytes: 34.49M
  Allocated object bytes: 34.19M
