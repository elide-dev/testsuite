...
### 68 × `Node API test timed out`

distinct messages:
- `Node API test timed out`
example test: `test/parallel/test-async-hooks-execution-async-resource-await.js`

### 17 × `AssertionError: Expected values to be strictly equal: <n> !== <n> at :anonymous (<loc>) at :program (<loc>)`
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-http-parser-multiple-execute.js:33:27
...
### 11 × `AssertionError: Missing expected exception. at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Missing expected exception.
    at :anonymous (test-fs-mkdtempDisposableSync.js:80:3)
...
### 8 × `TypeError: Cannot read property <str> of undefined at :anonymous (<loc>) at :program (<loc>)`
...
### 5 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + message: <str>, - code: <str>, - message: <str>, name: <str> } at `
...
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: '1 is not a String', -   code: 'ERR_INVALID_ARG_TYPE', -   message: 'The "flags" argument must be of type string. Received type number (1)',     name: 'TypeError'   }
    at :=> (test-v8-flag-`
example test: `test/parallel/test-http-client-reject-unexpected-agent.js`

### 5 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { code: <str>, + message: <str>, - message: <str>, name: <str> } at :a`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: 'The "target" argument must be an instance of Buffer or Uint8Array. Received type undefined (undefined)', -   message: 'The "target" argument must be an insta`
...
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-duplex-destroy.js:207:29
    at test-stream-duplex-destroy.js:1:1
Mismatched noop function calls. Expected exactly 1, act`
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
- `AssertionError: Missing expected exception (TypeError).
    at :anonymous (test-child-process-reject-null-bytes.js:285:1)
...
distinct messages:
- `AssertionError: Expected values to be strictly equal: + actual - expected  + undefined - 'overridden'
    at :anonymous (test-console-instance.js:114:3)
...
### 3 × `AssertionError: Expected values to be strictly equal: true !== false at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Expected values to be strictly equal:  true !== false
    at :anonymous (test-stream-duplex-end.js:23:3)
...
### 3 × `TypeError: This handle type cannot be sent at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (native)`
...
- `(node:1509) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.`
example test: `test/parallel/test-buffer-constructor-outside-node-modules.js`

### 2 × `(node:<n>) [DEP0169] DeprecationWarning: <str> behavior is not standardized and prone to errors that have security implications. Use the WHATWG URL API instead.`

distinct messages:
- `(node:75931) [DEP0169] DeprecationWarning: ʼurl.parse()ʼ behavior is not standardized and prone to errors that have security implications. Use the WHATWG URL API instead. CVEs are not issued for ʼurl.parse()ʼ vulnerabilities.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expe`
- `(node:95342) [DEP0169] DeprecationWarning: ʼurl.parse()ʼ behavior is not standardized and prone to errors that have security implications. Use the WHATWG URL API instead. CVEs are not issued for ʼurl.parse()ʼ vulnerabilities.`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000075c3bc000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007b474a11d750 (heapBase + 6066877618000)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000075c3d41d90d8 points into the stack for thread 0x000075c3bc000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x0000718bbc000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007b474a11d360 (heapBase + 10705442296672)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000718bd1e8a448 points into the stack for thread 0x0000718bbc000cc0
 `
...
### 2 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - true at :anonymous (<loc>) at :program (<loc>)`
...
### 2 × `AssertionError: Expected values to be strictly equal: <str> !== <str> at :anonymous (<loc>) at :program (<loc>)`
...
example test: `test/parallel/test-os.js`

### 2 × `AssertionError: Expected values to be strictly equal: <str> !== <str> at <loc> at _return (<loc>) at EventEmitter.emit (native)`
...
'child stdout' !== ''
    ...
    at test-child-process-exec-timeout-expire.js:47:10
...
'child stdout' !== ''
    ...
    at test-child-process-exec-timeout-kill.js:36:10
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)`
example test: `test/parallel/test-child-process-exec-timeout-expire.js`

### 2 × `AssertionError: Expected values to be strictly equal: false !== true at :=> (<loc>) at _return (<loc>)`
...
- `AssertionError: Missing expected exception (RangeError).
    at :anonymous (test-child-process-spawn-typeerror.js:80:1)
...
example test: `test/parallel/test-net-server-capture-rejection.js`
...
### 2 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + name: <str> - name: <str> } AssertionError: `
...
### 2 × `Uncaught (in promise) AssertionError: Expected values to be strictly equal: <n> !== <n> Uncaught (in promise) AssertionError: Expected values to be strictly equ`
...
distinct messages:
- `(node:64535) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:94482) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:73545) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:29310) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 111582]: --- stdout ---

[process 111582]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Wed, 12 Aug 2026 18:05:23 GMT\r`
...
### 1 × `AssertionError: (req, res) => { res.end(); } at <loc> called with arguments: <ref *<n>> IncomingMessage [Readable] { socket: <ref *<n>> Socket [Duplex] { _handl`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { - code: <str>, name: <str> } at :=> (<loc>) at :anonymous (<loc>) at`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str>, + message: <str> - code: <str>, - message: <str> } at`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + message: <str>, + name: <str> - code: <str>, - message: <str>, - n`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: "Cannot set property 'test' of undefined", +   name: 'TypeError' -   code: 'ERR_HTTP_HEADERS_SENT', -   message: 'Cannot set headers after they are sent to the client', -   name: 'Error'   }
 `
...
distinct messages:
- `AssertionError: Expected values to be strictly equal: + actual - expected  + "[ 'foo' ]" - "[\n  'foo'\n]"
...
+   'Date: Wed, 12 Aug 2026 18:06:08 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
+ null
- <ref *1> IncomingMessage [Readable] {
-   _consuming: false,
-   _dumped: true,
-   _keepAlive: true,
-   aborted: false,
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - <str>`
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - Server [EventEmitter] { - _allowHalfOpen: true, - _closing: false, - _co`
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.85201.sock',
-   _connections: 1,
-   _handle: {},
-   _listeningId: 2,
-   _pauseOnCo`
...
distinct messages:
- `AssertionError: Expected values to be strictly equal:  16394 !== -1
    at :anonymous (test-buffer-indexof.js:352:7)
...
### 1 × `AssertionError: Expected values to be strictly equal: <n> !== null at <loc> at _return (<loc>)`
...
called with arguments: [Error: bind EADDRINUSE 0.0.0.0:33705] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind',
  address: '0.0.0.0',
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: { result: undefined }, <str> at mustNotCall (<loc>) AssertionError: functio`
...
called with arguments: <ref *1> IncomingMessage [Readable] {
  socket: <ref *2> Socket [Duplex] {
    ...
    _connected: true,
   `
example test: `test/parallel/test-http-highwatermark.js`

### 1 × `AssertionError: function should not have been called at <loc> called with arguments: <ref *<n>> IncomingMessage [Readable] { socket: Socket [Duplex] { _handle: `
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: <ref *<n>> Socket [Duplex] { _handle: {}, _allowHalfOpen: true, allowHalfOp`
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: Socket [Duplex] { _handle: {}, _allowHalfOpen: false, allowHalfOpen: false,`
...
### 1 × `AssertionError: ifError got unwanted exception: write failed on fd <n> (wrote <n> of <n> bytes) TypeError: This handle type cannot be sent at EventEmitter.<anon`

distinct messages:
- `AssertionError: ifError got unwanted exception: write failed on fd 6 (wrote 0 of 10 bytes)

TypeError: This handle type cannot be sent
    at EventEmitter.<anonymous> (test-child-process-send-returns-boolean.js:36:19)
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/co`
...
### 1 × `AssertionError: Missing expected exception. at Duplex.<anonymous> (<loc>) at Duplex._return (<loc>) at Duplex.push (native) Error: read ECONNRESET`
...
### 1 × `AssertionError: Missing expected exception. at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (native)`

distinct messages:
- `AssertionError: Missing expected exception.
    at EventEmitter.<anonymous> (test-dgram-multicast-set-interface.js:90:12)
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)`
...
### 1 × `AssertionError: The expression evaluated to a falsy value: assert.ok(!Buffer.isBuffer(actualUint8Array)) at assertContentEqual (<loc>) at :anonymous (<loc>) at `

distinct messages:
- `AssertionError: The expression evaluated to a falsy value:    assert.ok(!Buffer.isBuffer(actualUint8Array))
    at assertContentEqual (test-buffer-generic-methods.js:186:3)
    at :anonymous (test-buffer-generic-methods.js:570:3)
...
### 1 × `AssertionError: The expression evaluated to a falsy value: assert(!socket.destroyed) at <loc>`
...
- `AssertionError: The expression evaluated to a falsy value:
  ...
  assert(!socket.destroyed)
    ...
    at test-net-allow-half-open.js:18:9`
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@7d24f19c: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@7d24f19c: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@32a2464b], [BorrowedEmitterState]
    at :anonymous (native)
...
### 1 × `Error: boom! at :anonymous (<loc>) at test2 (<loc>) at :anonymous (<loc>) at :program (<loc>) AssertionError: test test2 should have sent message: uncaughtExcep`

distinct messages:
- `Error: boom!
    at :anonymous (test-domain-uncaught-exception.js:38:11)
    at test2 (test-domain-uncaught-exception.js:37:3)
    at :anonymous (test-domain-uncaught-exception.js:153:3)
    at :program (test-domain-uncaught-exception.js:1:1)
AssertionError: test test2 should have sent message: unca`
example test: `test/parallel/test-domain-uncaught-exception.js`

### 1 × `Error: connect ECONNREFUSED ::<n>:<n>`

distinct messages:
- `Error: connect ECONNREFUSED ::1:38275`
...
distinct messages:
- `Error: connect ECONNREFUSED 0:0:0:0:0:0:0:1:34625`
...
### 1 × `Error: ENOENT: no such file or directory, open <str>`
...
### 1 × `first write first cb second write second cb error handler AssertionError: Expected values to be strictly equal: <n> !== null at Writable.<anonymous> (<loc>) at `
...
### 1 × `foo foo bar foo bar hop { slashes: <str> } inspect foo foo bar foo bar hop { slashes: <str> } inspect Trace: This is a %j %d [object Object] <n> foo at <loc> Ty`
...
TypeError: Cannot read property 'get' of undefined
    ...
    at :program (test-console`
example test: `test/parallel/test-console.js`

### 1 × `GC summary Collected chunk bytes: <n>.00M Collected object bytes: <n>.00M Allocated chunk bytes: <n>.99M Allocated object bytes: <n>.60M Incremental GC count: <`

distinct messages:
- `GC summary
  Collected chunk bytes: 0.00M
  Collected object bytes: 0.00M
  Allocated chunk bytes: 35.99M
  Allocated object bytes: 35.60M
  ...
  GC load: 0%
GC s`
example test: `test/parallel/test-vm-sigint-existing-handler.js`
...
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at EventEmitter.<anonymous> (test-http-server-connection-list-when-close.js:19:37)
    at EventEmitter._return (/work/.harness/work/node`
example test: `test/parallel/test-http-server-connection-list-when-close.js`

### 1 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at Writable.<anonymous> (<loc>) at Writable._return (<loc>) at Writa`

distinct messages:
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at Writable.<anonymous> (test-http-sync-write-error-during-continue.js:48:28)
    at Writable._return (/work/.harness/work/node-api/node`
...
### 1 × `string { key: /value/ } [ <n>, <n>, <n> ] string { key: /value/ } [ <n>, <n>, <n> ] AssertionError: The expression evaluated to a falsy value: assert.ok(interce`
...
### 1 × `SyntaxError: Unexpected end of JSON input at JSON.parse (native) at Readable.<anonymous> (<loc>) at Readable._return (<loc>) at SyntaxError.get stack (native) S`
...
### 1 × `TypeError: Cannot read property <str> of null at EventEmitter.<anonymous> (<loc>) at EventEmitter.emit (native) at Duplex.push (native) (node:<n>) [DEP0169] Dep`
...
- `TypeError: Cannot read property 'lang' of null
    ...
    at EventEmitter.emit (native)
    at Duplex.push (native)
(node:66881) [DEP0169] DeprecationWarning: ʼurl.parse()ʼ behavior is not standardized and prone to errors that have sec`
...
### 1 × `TypeError: Cannot read property <str> of undefined at child (<loc>) at _return (<loc>) at EventEmitter.emit (native) at TypeError.get stack (native)`
...
### 1 × `TypeError: The <str> argument must be of type string. Received undefined at :anonymous (<loc>) at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `TypeError: The "servers[1]" argument must be of type string. Received undefined
    at :anonymous (dns-error.js:21:11)
    at :anonymous (test-dns.js:40:3)
...
### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected Buffer(<n>) [Uint8Array] [ + <n>, + <n>, + <n>, + <n>, + <n`
...
### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly equal: <n> !== <n> Uncaught (in promise) AssertionError: Expected values to be strictly dee`
...
distinct messages:
- `Uncaught (in promise) Error: escaped timeout at 2002 milliseconds!
...
Uncaught (in promise) TypeError: The "options" argument must be of type object. Received number
Uncaught (in promi`
...
| 90 | node:http |
| 78 | node:streams |
| 68 | node:worker-threads |
| 60 | node:fs |
| 60 | node:vm |
| 51 | node:process |
| 45 | node:child-process |
| 35 | node:net |
| 33 | node:module-loading |
| 26 | node:async-hooks |
| 21 | node:zlib |
| 18 | node:dns |
| 16 | node:domain |
