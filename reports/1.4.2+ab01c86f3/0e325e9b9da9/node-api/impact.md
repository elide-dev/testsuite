...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000742870000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000074e0e931d750 (heapBase + 796602521424)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000742886bd9038 points into the stack for thread 0x0000742870000cc0
  R`
- `[ [ SegfaultHandler caught a segfault in thread 0x00007210f8000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000074e0e931d360 (heapBase + 3096423289696)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000072110c60a448 points into the stack for thread 0x00007210f8000cc0
  `
...
distinct messages:
- `(node:84357) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:117945) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:95426) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:37019) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 140820]: --- stdout ---

[process 140820]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 22:22:30 GMT\r`
...
+   'Date: Tue, 11 Aug 2026 22:23:33 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.108084.sock',
-   _connections: 1,
-   _handle: {},
-   _listeningId: 2,
-   _pauseOnC`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:38723' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3fa126b6: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3fa126b6: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@5bf6ab7c], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:34285`
