# node-api — `1.4.2+ab01c86f3`

- Image digest: `664309ac7237bfe135203f294593d2725f869658a4120070ebb77902abe432a4`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-11T21:22:01.727Z → 2026-08-11T21:49:18.984Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1318/3071 (61.79%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1318 | 741 | 74 | 938 | 2 | 337 |
...
- `test/parallel/test-async-local-storage-http-agent.js` — fail — (node:931) TimeoutOverflowWarning: Infinity does not fit into a 32-bit signed integer.
...
- `test/parallel/test-async-local-storage-http-multiclients.js` — pass
- `test/parallel/test-async-local-storage-isolation.js` — fail — AssertionError: Expected values to be strictly equal: + actual - expected  + undefined - 'store3'
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1252]: --- stderr ---
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1263) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-indexof.js` — fail — AssertionError: Expected values to be strictly equal:  16394 !== -1
...
- `test/parallel/test-buffer-resizable.js` — fail — (node:1511) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-write.js` — fail — AssertionError: The validation function is expected to return "true". Received false  Caught error:  TypeError: buf.asciiWrite is not a function
...
- `test/parallel/test-async-local-storage-isolation.js` — AssertionError: Expected values to be strictly equal: + actual - expected  + undefined - 'store3'
    at :anonymous (test-async-local-storage-isolation.js:33:3)
    at :program (test-async-local-storage-isolation.js:1:1)
...
## 🟢 New passes (337) — consider advancing the baseline
