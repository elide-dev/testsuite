...
- Image digest: `15b14ec99d0401eeed818e6badd861d5e11be361aa35c7a6b714dd61eb47db7e`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-12T19:38:39.725Z → 2026-08-12T20:04:57.618Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1387/3071 (65.03%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1387 | 679 | 67 | 938 | 0 | 404 |
...
- `test/parallel/test-buffer-generic-methods.js` — fail — AssertionError: The expression evaluated to a falsy value:    assert.ok(!Buffer.isBuffer(actualUint8Array))
...
- `test/parallel/test-child-process-exec-timeout-expire.js` — fail — AssertionError: Expected values to be strictly equal:
...
- `test/parallel/test-child-process-exec-timeout-kill.js` — fail — AssertionError: Expected values to be strictly equal:
...
'' !== 'buzz'
    ...
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)
- `test/parallel/test-child-process-spawn-timeout-kill-signal.js` — pass
- `test/parallel/test-child-process-spawn-typeerror.js` — fail — AssertionError: Missing expected exception (RangeError).
    at :anonymous (test-child-process-spawn-typeerror.js:80:1)
    at :program (test-child-process-spawn-typeerror.js:1:1)
- …and 1933 more

## 🟢 New passes (404) — consider advancing the baseline
