...
### 15 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
### 14 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at :anonymous (<loc>) at :program (<loc>)`
...
### 10 × `AssertionError: Missing expected exception. at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Missing expected exception.
    at :anonymous (test-fs-write-stream-autoclose-option.js:59:1)
    at :program (test-fs-write-stream-autoclose-option.js:1:1)`
...
### 3 × `AssertionError: function should not have been called at <loc> at mustNotCall (<loc>)`

distinct messages:
- `AssertionError: function should not have been called at test-stream-duplex-end.js:37
...
- `(node:1517) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.`
...
distinct messages:
- `(node:75792) [DEP0169] DeprecationWarning: ʼurl.parse()ʼ behavior is not standardized and prone to errors that have security implications. Use the WHATWG URL API instead. CVEs are not issued for ʼurl.parse()ʼ vulnerabilities.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expe`
- `(node:94395) [DEP0169] DeprecationWarning: ʼurl.parse()ʼ behavior is not standardized and prone to errors that have security implications. Use the WHATWG URL API instead. CVEs are not issued for ʼurl.parse()ʼ vulnerabilities.`
example test: `test/parallel/test-http.js`

### 2 × `(node:<n>) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. <n> close listeners added to [Socket]. MaxListeners is <n>. Use emitter.setM`

distinct messages:
- `(node:62703) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
AssertionError: function should not have been called at test-http-many-ended-pipelines.js:64
called with arg`
- `(node:64419) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007514cc000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000710f3551d750 (heapBase - 4417754114224)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007514e16390d8 points into the stack for thread 0x00007514cc000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007c1900000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000710f3551d360 (heapBase - 12132387794080)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007c1914e2a448 points into the stack for thread 0x00007c1900000cc0
 `
...
### 2 × `Error: EACCES: permission denied, rm <str> at refresh (<loc>) at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `Error: EACCES: permission denied, rm '/work/.harness/work/node-api/node-test/.tmp.857'
    at refresh (tmpdir.js:20:3)
    at :anonymous (test-fs-mkdtempDisposableSync.js:10:1)
    at :program (test-fs-mkdtempDisposableSync.js:1:1)`
- `Error: EACCES: permission denied, rm '/work/.harness/work/node-api/node-test/.tmp.888'
    at refresh (tmpdir.js:20:3)
    at :anonymous (test-fs-promises-mkdtempDisposable.js:11:1)
    at :program (test-fs-promises-mkdtempDisposable.js:1:1)`
example test: `test/parallel/test-fs-mkdtempDisposableSync.js`

### 2 × `Error: ENOENT: no such file or directory, open <str>`
...
distinct messages:
- `(node:93558) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:73519) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:29254) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 110418]: --- stdout ---

[process 110418]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Wed, 12 Aug 2026 19:51:32 GMT\r`
...
+   'Date: Wed, 12 Aug 2026 19:52:10 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.84350.sock',
-   _connections: 1,
-   _handle: {},
-   _listeningId: 2,
-   _pauseOnCo`
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected <str> + <str> + <str> + <str> + + <str> + + <str> + + <str> + + <str> + <str> at Duple`
...
### 1 × `AssertionError: Expected values to be strictly equal: false !== true at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (n`
...
false !== true
    ...
    at EventEmitter.emit (native)
AssertionError:`
example test: `test/parallel/test-net-server-drop-connections.js`

### 1 × `AssertionError: Expected values to be strictly equal: false !== true at EventEmitter.server (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (native`
...
false !== true
    ...
    at EventEmitter.server (test-http-outgoing-finish-writable.js:18:10)
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)
    at Duplex.push`
...
called with arguments: [Error: bind EADDRINUSE 0.0.0.0:51733] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind',
  address: '0.0.0.0',
...
### 1 × `AssertionError: wrong exit for <n>-changeCodeInExitWithUncaught expected:<n> but got:<n> <n> !== <n> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return`

distinct messages:
- `AssertionError: wrong exit for 7-changeCodeInExitWithUncaught
expected:98 but got:1
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@7480ffdf: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@7480ffdf: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@25687d0b], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:39677`
...
distinct messages:
- `Error: connect ECONNREFUSED 0:0:0:0:0:0:0:1:33089`
...
### 1 × `GC summary Collected chunk bytes: <n>.00M Collected object bytes: <n>.00M Allocated chunk bytes: <n>.06M Allocated object bytes: <n>.57M Incremental GC count: <`

distinct messages:
- `GC summary
  Collected chunk bytes: 0.00M
  Collected object bytes: 0.00M
  Allocated chunk bytes: 35.06M
  Allocated object bytes: 34.57M
...
### 1 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc> Mismatched end function calls. Expected exactly <n`
...
Mismatched end function calls. Expected exactly 1, actu`
...
- `TypeError: Cannot read property 'lang' of null
    ...
    at EventEmitter.emit (native)
    at Duplex.push (native)
(node:67302) [DEP0169] DeprecationWarning: ʼurl.parse()ʼ behavior is not standardized and prone to errors that have sec`
