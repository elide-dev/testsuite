...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000728fa0000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007651a071d750 (heapBase + 4136061228880)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000728fb4f69038 points into the stack for thread 0x0000728fa0000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x000073db88000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007651a071d360 (heapBase + 2710534738784)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000073db9cfba448 points into the stack for thread 0x000073db88000cc0
  `
...
### 2 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - <str> at :anonymous (<loc>) at :program (<loc>)`
...
distinct messages:
- `(node:82923) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:116439) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:93704) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:35043) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 137114]: --- stdout ---

[process 137114]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Wed, 12 Aug 2026 06:14:48 GMT\r`
...
+   'Date: Wed, 12 Aug 2026 06:15:39 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.106522.sock',
-   _connections: 1,
-   _handle: {},
-   _listeningId: 2,
-   _pauseOnC`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:47643' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3757489c: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3757489c: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@42eec38d], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:33395`
...
distinct messages:
- `Error: connect ECONNREFUSED 0:0:0:0:0:0:0:1:44771`
...
- `GC summary
  ...
  Allocated chunk bytes: 34.99M
  Allocated object bytes: 34.60M
