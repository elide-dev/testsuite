...
distinct messages:
- `(node:1264) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
AssertionError: DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use th`
- `(node:1512) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007caef8000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000725b8051d750 (heapBase - 11349311236272)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007caf0d599038 points into the stack for thread 0x00007caef8000cc0
 `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007fb908000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000725b8051d360 (heapBase - 14691064229024)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007fb91c33a448 points into the stack for thread 0x00007fb908000cc0
 `
...
distinct messages:
- `(node:84044) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:117583) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:95159) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:37024) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
distinct messages:
- `[process 1253]: --- stderr ---
(node:1253) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.

[process 1253]: --- stdout ---

[process 1253]: status = 0, signal = null
Erro`
...
[process 140433]: --- stdout ---

[process 140433]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Wed, 12 Aug 2026 03:00:02 GMT\r`
...
+   'Date: Wed, 12 Aug 2026 03:01:05 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.107725.sock',
-   _connections: 1,
-   _handle: {},
-   _listeningId: 2,
-   _pauseOnC`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:33992' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@245a3c17: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@245a3c17: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@41cca862], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:44539`
...
### 1 × `Error: Source is not a file or is not readable: /work/.harness/work/node-api/node-api-overlay/test/fixtures/child-process-spawn-node; see --help AssertionError:`
