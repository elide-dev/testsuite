...
- Image digest: `4f0442baacfa567ea109df6ff9b58bee6392956c6b7987be3bf333aec63d4c75`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-12T02:47:02.484Z → 2026-08-12T03:14:19.847Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1322/3071 (61.98%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1322 | 737 | 74 | 938 | 1 | 340 |
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1253]: --- stderr ---
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1264) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-resizable.js` — fail — (node:1512) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
## 🟢 New passes (340) — consider advancing the baseline
