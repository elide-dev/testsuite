...
- Image digest: `361940f2ce228380c5492171a08212a1993cadd1b421bf55507c9a4cfb47fae7`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-12T07:45:39.149Z → 2026-08-12T08:12:37.214Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1329/3071 (62.31%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1329 | 731 | 73 | 938 | 0 | 346 |
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1267) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-resizable.js` — fail — (node:1515) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
## 🟢 New passes (346) — consider advancing the baseline
