...
### 2 × `Traceback (most recent call last): File <str>, line <n>, in test_attribute_name_interning self.assertIs(x_key, y_key) ~~~~~~~~~~~~~^^^^^^^^^^^^^^ AssertionError`
...
### 1 × `_pickle.UnpicklingError: BINSTRING exceeds system<str>s maximum size of <n> bytes"`

distinct messages:
- `_pickle.UnpicklingError: BINSTRING exceeds system's maximum size of 2147483647 bytes

During handling of the above exception, another exception occurred:

Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/pickletester.py", line 984, in test_large_binstring
    with self.assert`
example test: `test_pickle.CUnpicklerTests.test_large_binstring`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_concurrent_pickler_dump pickler.dump(X()) # should not crash ~~~~~~~~~~~~^^^^^ File <str>, line`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 413, in test_concurrent_pickler_dump
    pickler.dump(X())  # should not crash
    ~~~~~~~~~~~~^^^^^
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 411, in __reduce__
    self.assertRaises(Run`
example test: `test_pickle.CPicklerUnpicklerObjectTests.test_concurrent_pickler_dump`

### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_concurrent_pickler_dump_and_init pickler.dump([X()]) # should not fail ~~~~~~~~~~~~^^^^^^^ File`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 423, in test_concurrent_pickler_dump_and_init
    pickler.dump([X()])  # should not fail
    ~~~~~~~~~~~~^^^^^^^
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 421, in __reduce__
    self.asse`
example test: `test_pickle.CPicklerUnpicklerObjectTests.test_concurrent_pickler_dump_and_init`

### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_concurrent_unpickler_load unpickled = unpickler.load() # should not fail File <str>, line <n>, `

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 433, in test_concurrent_unpickler_load
    unpickled = unpickler.load()  # should not fail
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 429, in reducer
    self.assertRaises(RuntimeError, un`
example test: `test_pickle.CPicklerUnpicklerObjectTests.test_concurrent_unpickler_load`

### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_concurrent_unpickler_load_and_init unpickled = unpickler.load() # should not crash File <str>, `

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 443, in test_concurrent_unpickler_load_and_init
    unpickled = unpickler.load()  # should not crash
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 439, in reducer
    self.assertRaises(Runtim`
example test: `test_pickle.CPicklerUnpicklerObjectTests.test_concurrent_unpickler_load_and_init`
...
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_context.py", line 92, in test_context_new_unhashable_str_subclass
    with self.assertRaisesRegex(TypeError, 'unhashable type'):
         ~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: TypeError not r`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_custom_find_class self.assertEqual(loads(b<str>), (<str>, <str>)) ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/pickletester.py", line 1169, in test_custom_find_class
    self.assertEqual(loads(b'cmath\nlog\n.'), ('math', 'log'))
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: <built-in function log> != ('m`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_doctest_main_issue4197 self.assertIn(expected.encode(<str>), out) ~~~~~~~~~~~~~^^^^^^^^^^^^^^^^`
...
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_zipimport_support.py", line 205, in test_doctest_main_issue4197
    ...
    ~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: b'File "/tmp/tmpkp0jczyb/script.py", line 2,`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_find_class unpickler.find_class(<str>, <str>) ~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^ Typ`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/pickletester.py", line 1137, in test_find_class
...
distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/pickletester.py", line 1092, in test_load_global
...
distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/pickletester.py", line 1108, in test_load_stack_global
...
distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_json/test_speedups.py", line 143, in test_mutate_list_during_encode
    self.assertEqual(call_count, 3)
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^
AssertionError: 10 != 3`
example test: `test_json.test_speedups.TestEncode.test_mutate_list_during_encode`

### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_pdb_issue4201 self.assertIn(os.path.normcase(script_name.encode(<str>)), data) ~~~~~~~~~~~~~^^^`
...
distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_json/test_unicode.py", line 82, in test_single_surrogate_decode
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_unpickler_super self.assertEqual(unpickler.load(), <str>) ~~~~~~~~~~~~~~^^ File <str>, line <n>`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 250, in test_unpickler_super
    self.assertEqual(unpickler.load(), 'abc')
                     ~~~~~~~~~~~~~~^^
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 244, in persistent_load
    supe`
...
distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 325, in test_unpickler_super_instance_attribute
    self.assertEqual(unpickler.load(), 'abc')
                     ~~~~~~~~~~~~~~^^
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 312, in persi`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in trace_wrapper return func(*args, **kwargs) File <str>, line <n>, in test_bad_getattr s = self.dumps(`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/support/__init__.py", line 1296, in trace_wrapper
    return func(*args, **kwargs)
  File "/work/suites/cpython/Lib/test/pickletester.py", line 1952, in test_bad_getattr
