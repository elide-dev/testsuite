...
- Ran: 2026-09-25T19:12:54.510Z → 2026-09-25T19:15:24.687Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 3884/4484 (86.62%)** — overall, over all tests including skipped/suppressed

**vs expectations: 4363/4484 (97.30%)** — tests at or above the baseline (only regressions count against it)

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 3884 | 134 | 41 | 425 | 121 | 6 |
...
- `test_context.ContextTest.test_context_getset_4` — Traceback (most recent call last):
...
- `test_context.ContextTest.test_context_new_1` — TypeError: Context() takes 1 positional argument but 2 were given
...
- `test_context.ContextTest.test_context_new_unhashable_str_subclass` — Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_context.py", line 92, in test_context_new_unhashable_str_subclass
    with self.assertRaisesRegex(TypeError, 'unhashable type'):
         ~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: TypeError not raised

- `test_context.ContextTest.test_context_run_4` — Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_context.py", line 23, in wrapper
    return ctx.run(func, *args, **kwargs)
           ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^
  File "/work/suites/cpython/Lib/test/test_context.py", line 177, in test_context_run_4
    ...
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^
AssertionError: <_contextvars.Context object at 0x753270b6> != <_contextvars.Context object at 0x1cdee792>
...
- `test_pickle.CIdPersPicklerTests.test_pickler_super` — Traceback (most recent call last):
  ...
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 228, in persistent_id
    self.assertIsNone(super().persistent_id(obj))
                      ~~~~~~~~~~~~~~~~~~~~~^^^^^
  [Previous line repeated 4718 more times]
...
- `test_json.test_speedups.TestEncode.test_mutate_list_during_encode` — Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_json/test_speedups.py", line 143, in test_mutate_list_during_encode
    self.assertEqual(call_count, 3)
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^
AssertionError: 10 != 3

- `test_json.test_unicode.TestCUnicode.test_single_surrogate_decode` — Traceback (most recent call last):
...
- `test_generators.GeneratorCloseTest.test_close_releases_frame_locals` — Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_generators.py", line 669, in test_close_releases_frame_locals
    ...
    ~~~~~~~~~~~~~~~~~^^^^^^^^
AssertionError: <test.test_generators.GeneratorCloseTest.test_close_releases_frame_locals.<locals>.Foo object at 0x5cbf16be> is not None
...
- `test_pickle.CIdPersPicklerTests.test_unpickler_super` — Traceback (most recent call last):
  ...
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 244, in persistent_load
    super().persistent_load(pid)
    ~~~~~~~~~~~~~~~~~~~~~~~^^^^^
  [Previous line repeated 4716 more times]
  File "/opt/elide/lib/resources/python/python-home/lib/python3.13/unittest/case.py", line 793, in assertRaises
    context = _AssertRaisesContext(expected_exception, self)
  File "/opt/elide/lib/resources/python/python-home/lib/python3.13/unittest/case.py", line 205, in __init__
    _BaseTestCaseContext.__init__(self, test_case)
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^
RecursionError: maximum recursion depth exceeded

- `test_pickle.CIdPersPicklerTests.test_unpickler_super_instance_attribute` — Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 325, in test_unpickler_super_instance_attribute
    self.assertEqual(unpickler.load(), 'abc')
                     ~~~~~~~~~~~~~~^^
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 312, in persistent_load
    raise AssertionError('should never be called')
AssertionError: should never be called

- `test_pickle.CPicklerUnpicklerObjectTests.test_concurrent_pickler_dump` — Traceback (most recent call last):
  ...
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 411, in __reduce__
    ...
    ~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: RuntimeError not raised by dump

- `test_pickle.CPicklerUnpicklerObjectTests.test_concurrent_pickler_dump_and_init` — Traceback (most recent call last):
  ...
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 421, in __reduce__
    ...
    ~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: RuntimeError not raised by __init__

- `test_pickle.CPicklerUnpicklerObjectTests.test_concurrent_unpickler_load` — Traceback (most recent call last):
  ...
  File "/work/suites/cpython/Lib/test/test_pickle.py", line 429, in reducer
    ...
    ~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/elide/lib/resources/python/python-home/lib/python3.13/unittest/case.py", line 795, in assertRaises
    return context.handle('assertRaises', args, kwargs)
           ~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/elide/lib/resources/python/python-home/lib/python3.13/unittest/case.py", line 238, in handle
    callable_obj(*args, **kwargs)
    ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^
_pickle.UnpicklingError: could not find MARK

- `test_pickle.CPicklerUnpicklerObjectTests.test_concurrent_unpickler_load_and_init` — Traceback (most recent call last):
...
- `test_pickle.CUnpicklerTests.test_large_binstring` — _pickle.UnpicklingError: BINSTRING exceeds system's maximum size of 2147483647 bytes
...
Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/pickletester.py", line 984, in test_large_binstring
    with self.assertRaisesRegex(pickle.UnpicklingError, errmsg):
         ~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: "BINSTRING pickle has negative byte count" does not match "BINSTRING exceeds system's maximum size of 2147483647 bytes"


## 🟢 New passes (6) — consider advancing the baseline
