...
- Ran: 2026-09-25T18:24:53.427Z → 2026-09-25T18:28:05.079Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 887/1563 (72.94%)**
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1654) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1750]: --- stderr ---
...
not ok 6 - __elide_node_test__test__parallel__test-diagnostics-channel-web-locks.js
  ...
  ...
1..6
- `test/parallel/test-dns-channel-cancel.js` — pass
...
## 🟢 New passes (35) — consider advancing the baseline
