...
- `promise_test: Unhandled rejection with value: object "TypeError: Failed to parse URL: http://{{host}}:{{ports[http][1]}}/fetch/api/basic/../resources/top.txt?pipe=header(Access-Control-Allow-Origin,*) (base http://127.0.0.1:38601/fetch/api/basic/)"`
- `promise_test: Unhandled rejection with value: object "TypeError: Failed to parse URL: https://{{host}}:{{ports[https][0]}}/fetch/api/basic/../resources/top.txt (base http://127.0.0.1:38601/fetch/api/basic/)"`
...
distinct messages:
- `assert_equals: Check referrer header expected (string) "http://127.0.0.1:38601/fetch/api/redirect/" but got (object) null`
- `assert_equals: Check referrer header expected (string) "http://127.0.0.1:38601/" but got (object) null`
...
distinct messages:
- `assert_equals: Request's referrer is correct expected (string) "http://127.0.0.1:38601/fetch/api/basic/" but got (object) null`
- `assert_equals: Request's referrer is correct expected (string) "http://127.0.0.1:38601/" but got (object) null`
...
example test: `fetch/api/request/request-headers.any.js :: Request should not get its content-type from the init request if init headers are provided`
...
distinct messages:
- `assert_equals: request's referer should be: http://127.0.0.1:38601/fetch/api/basic/ expected (string) "http://127.0.0.1:38601/fetch/api/basic/" but got (object) null`
...
distinct messages:
- `assert_equals: request's referer should be: http://127.0.0.1:38601/fetch/api/basic/foo expected (string) "http://127.0.0.1:38601/fetch/api/basic/foo" but got (object) null`
...
distinct messages:
- `assert_true: http://127.0.0.1:38601/fetch/api/resources/top.txt?%C3%A2%C2%98%C2%83 ends with top.txt?%E2%98%83 expected true got false`
...
distinct messages:
- `assert_true: http://127.0.0.1:38601/fetch/api/resources/top.txt?%C3%A2%C2%98%C2%83%e2%98%83 ends with top.txt?%E2%98%83%e2%98%83 expected true got false`
...
distinct messages:
- `assert_true: http://127.0.0.1:38601/fetch/api/resources/top.txt?%C3%BF ends with top.txt?%FF expected true got false`
