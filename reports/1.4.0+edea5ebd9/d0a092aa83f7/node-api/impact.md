...
│values provided for JSToNumberNodeGen@7abcc740: [[B@2e18de24], [byte[]]      │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected    │
│values provided for JSToObjectNodeGen.Uncached@7f03a307: [[B@394ff9aa],      │
│[byte[]]                                                   `
...
### 2 × `TypeError: TypeError: Cannot load module: <str>`
...
distinct messages:
- `(node:10063) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10063) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9414) Warning: A Warning
(node:9414) CustomWarning: A Warning
(node:9414) Warning: A Warning
(node:9414) CustomWarning: A Warning
(node:9414) [CODE001] CustomWarning: A Warning
(node:9414) CustomWarning: A Warning
(node:9414) [CODE001] CustomWarning: A Warning
(node:9414) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10313) Warning: test
(node:10313) DeprecationWarning: test
(node:10313) Warning: test
(node:10313) DeprecationWarning: test
(node:10313) Error: test
(node:10313) Warning: test
...
distinct messages:
- `7/5/2026, 6:02:43 PM start test
7/5/2026, 6:02:43 PM waiting for callbacks
7/5/2026, 6:02:43 PM fs open() callback
7/5/2026, 6:02:43 PM WriteStream constructor
7/5/2026, 6:02:43 PM closed 1
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@c4d673f === [B@743118ee │ │ │ │ In file <loc> │ │─ Stack Tra`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@c4d673f === [B@743118ee                                   │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@4f6c45ba │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@4f6c45ba                                    │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Unsupported operation │ │ │ │ In file <loc> │ │─ Stack Trace ───────`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Unsupported operation                                             │
│                                                                             │
│ In file test/parallel/test-worker-unref-from-message-durin`
example test: `test/parallel/test-worker-unref-from-message-during-exit.js`
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6223-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6223-64K.txt of length 65536
