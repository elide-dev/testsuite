...
- `promise_test: Unhandled rejection with value: object "TypeError: Failed to parse URL: ../resources/bad-chunk-encoding.py?count=1"`
- `promise_test: Unhandled rejection with value: object "TypeError: Failed to parse URL: ../resources/cache.py?v=0ab049ed-2eb9-4fa7-972c-55b28d82c063"`
...
example test: `fetch/fetch-later/permissions-policy/deferred-fetch-allowed-by-permissions-policy.https.window.js :: Permissions policy header: "deferred-fetch=*" allows fetchLater() in the top-level document.`
