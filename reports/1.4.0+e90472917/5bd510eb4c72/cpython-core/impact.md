...
AssertionError: <function FinalizeTestCase.test_all_freed.<locals>.callback at 0x3e2a449a> is not None`
...
AssertionError: b'File "/tmp/tmp3b8fza2o/script.py", line 2, in __main__.Test' not found in b'***************`
...
AssertionError: b'/tmp/tmpgaox6dqa/script.py' not found in b'> /work/.harness/work/cpython-core/`
...
AssertionError: 'Z' unexpectedly found in {<weakref at 1141194965; to 'UserString' at 622690045>, <weakref at 805710938; to `
...
AssertionError: 5.214332808012841 not less than 4`
...
AssertionError: <test.test_exceptions.ExceptionTests.testExceptionCleanupState.<locals>.MyObj object at 0x2e1778d4> is not None`
