...
### 64 × `Node API test timed out`

distinct messages:
- `Node API test timed out`
example test: `test/parallel/test-dns-cancel-reverse-lookup.js`

### 42 × `TypeError: Cannot load module: <str> at :anonymous (<loc>) at :program (<loc>)`
...
### 39 × `AssertionError: Missing expected exception at :anonymous (<loc>) at :program (<loc>)`
...
### 15 × `AssertionError: <n> === <n> at :anonymous (<loc>) at :program (<loc>)`
...
### 15 × `AssertionError: <str> === <str> at :anonymous (<loc>) at :program (<loc>)`
...
### 13 × `AssertionError: Unexpected global(s) found: Operators, onunhandledrejection, onrejectionhandled at Function.fail (native) at Process.<anonymous> (<loc>) at Asse`

distinct messages:
- `AssertionError: Unexpected global(s) found: Operators, onunhandledrejection, onrejectionhandled
    at Function.fail (native)
    at Process.<anonymous> (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:500:14)
...
### 13 × `TypeError: Cannot read property <str> of undefined at :anonymous (<loc>) at :program (<loc>)`
...
### 11 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
example test: `test/parallel/test-diagnostics-channel-udp.js`

### 8 × `AssertionError: Missing expected exception at :=> (<loc>) at :anonymous (<loc>) at :program (<loc>)`
...
### 8 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc> Mismatched noop function calls. Expected exactly <`
...
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-pipe-unpipe-streams.js:14:27
    at test-stream-pipe-unpipe-streams.js:1:1
Mismatched noop function calls. Expected exact`
...
### 4 × `AssertionError: function should not have been called at <loc> at Function.fail (native) at mustNotCall (<loc>) at AssertionError.get stack (native) AssertionErr`
...
### 3 × `AssertionError: Timer should be canceled at Function.fail (native) at timerNotCanceled (<loc>) at AssertionError.get stack (native) TypeError: timeout.refresh i`
...
TypeError: timeout.refresh is not a function
    at :anonymous (test-timers-nan-duration-emit-once-per-proc`
- `AssertionError: Timer should be canceled
    at Function.fail (native)
    at timerNotCanceled (test-timers-negative-duration-warning-emit-once-per-process.js:9:10)
    at AssertionError.get stack (native)
TypeError: timeout.refresh is not a function
    at :anonymous (test-timers-negative-duration-`
- `AssertionError: Timer should be canceled
    at Function.fail (native)
...
### 2 × `AssertionError: <n> === <n> at Function.strictEqual (native) at <loc> at _return (<loc>) at AssertionError.get stack (native) AssertionError: <n> === <n> at :an`
...
### 2 × `AssertionError: <str>child<str>--help<str> === <str> at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: 'error: unexpected argument 'child' found  Usage: symlinked-node [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND]  For more information, try '--help'. ' === ''
    at :anonymous (test-process-execpath.js:23:3)
    at :program (test-process-execpath.js:1:1)`
- `AssertionError: 'error: unexpected argument 'child' found  Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND]  For more information, try '--help'. ' === ''
    at :anonymous (test-worker-on-process-exit.js:14:3)
    at :program (test-worker-on-process-exit.js:1:1)`
example test: `test/parallel/test-process-execpath.js`

### 2 × `AssertionError: error: unexpected argument <str> found tip: to pass <str> as a value, use <str> Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND] Fo`
...
- `AssertionError: error: unexpected argument '-e' found    tip: to pass '-e' as a value, use '-- -e'  Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND]  For more information, try '--help'.
    at produce (test-vm-cached-data.js:33:3)
    at testProduceConsume (test-vm-cached-data.js:41:16)`
example test: `test/parallel/test-util-getcallsites-sourcemap.js`

### 2 × `AssertionError: Expected exit code <n>, got <n>. stdout: stderr: error: unexpected argument <str> found Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COM`

distinct messages:
- `AssertionError: Expected exit code 0, got 2. stdout:  stderr: error: unexpected argument 'child' found  Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND]  For more information, try '--help'.
    at :anonymous (test-async-hooks-stack-overflow-nested-async.js:74:3)
    at :program (test-as`
- `AssertionError: Expected exit code 0, got 2. stdout:  stderr: error: unexpected argument 'child' found  Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND]  For more information, try '--help'.
    at :anonymous (test-async-hooks-stack-overflow.js:43:3)
    at :program (test-async-hooks-sta`
...
### 2 × `java.lang.UnsupportedOperationException: util.debuglog() is not yet implemented at :anonymous (native) at :program (<loc>)`
...
### 2 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at _return (<loc>) at <loc> at <loc> Mismatched <ano`
...
### 2 × `TypeError: (intermediate value).gc is not a function at <loc> at TypeError.get stack (native)`
...
distinct messages:
- `(node:7778) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
    at AssertionError.get stack (native)
(node:7778) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:7285) Warning: A Warning
(node:7285) CustomWarning: A Warning
(node:7285) Warning: A Warning
(node:7285) CustomWarning: A Warning
(node:7285) [CODE001] CustomWarning: A Warning
(node:7285) CustomWarning: A Warning
(node:7285) [CODE001] CustomWarning: A Warning
(node:7285) [CODE001] CustomWarni`
...
distinct messages:
- `(node:7979) Warning: test
(node:7979) DeprecationWarning: test
(node:7979) Warning: test
(node:7979) DeprecationWarning: test
(node:7979) Error: test
(node:7979) Warning: test
...
### 1 × `[node:child_process] uncaught error in child event handler: AssertionError: The input did not match the regular expression: /EISDIR/ [node:child_process] uncaug`

distinct messages:
- `[node:child_process] uncaught error in child event handler: AssertionError: The input did not match the regular expression: /EISDIR/
[node:child_process] uncaught error in child event handler: AssertionError: The input did not match the regular expression: /EISDIR/
AssertionError: Got unwanted excep`
example test: `test/parallel/test-fs-readfile-error.js`

### 1 × `[node:child_process] uncaught error in child event handler: SyntaxError: Unexpected end of JSON input AssertionError: Unexpected global(s) found: Operators, onu`

distinct messages:
- `[node:child_process] uncaught error in child event handler: SyntaxError: Unexpected end of JSON input
AssertionError: Unexpected global(s) found: Operators, onunhandledrejection, onrejectionhandled
    at Function.fail (native)
    at Process.<anonymous> (/work/.harness/work/node-api/node-api-overla`
...
[process 15446]: --- stdout ---

[process 15446]: status = 1, signal = null
...
distinct messages:
- `7/20/2026, 2:20:27 AM start test
7/20/2026, 2:20:27 AM waiting for callbacks
7/20/2026, 2:20:27 AM fs open() callback
7/20/2026, 2:20:27 AM WriteStream constructor
7/20/2026, 2:20:27 AM closed 1
...
### 1 × `AssertionError: [{}, {}] deepStrictEqual [<str>] at Function.deepStrictEqual (native) at <loc> at AssertionError.get stack (native) AssertionError: [{}, {}, {},`
...
### 1 × `AssertionError: [B@484a3a67 === [B@1b66ae2b at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: [B@484a3a67 === [B@1b66ae2b
...
### 1 × `AssertionError: <n> === <n> at Function.strictEqual (native) at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (native) a`
...
### 1 × `AssertionError: <n> === null at Function.strictEqual (native) at <loc> at _return (<loc>) at AssertionError.get stack (native)`
...
### 1 × `AssertionError: Expected exit code <n> (try-catch worked), got <n>. stdout: stderr: error: unexpected argument <str> found Usage: elide [OPTIONS] [FILE] [-- <SC`

distinct messages:
- `AssertionError: Expected exit code 0 (try-catch worked), got 2. stdout:  stderr: error: unexpected argument 'child' found  Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND]  For more information, try '--help'.
    at :anonymous (test-async-hooks-stack-overflow-try-catch.js:42:3)
    at :`
example test: `test/parallel/test-async-hooks-stack-overflow-try-catch.js`
...
### 1 × `AssertionError: function should not have been called at <loc> at Function.fail (native) at mustNotCall (<loc>) at AssertionError.get stack (native)`
...
### 1 × `AssertionError: function should not have been called at <loc> at Function.fail (native) at mustNotCall (<loc>) at AssertionError.get stack (native) TypeError: (`
...
### 1 × `AssertionError: function should not have been called at <loc> at Function.fail (native) at mustNotCall (<loc>) at AssertionError.get stack (native) TypeError: t`
...
- `AssertionError: function should not have been called at test-timers-dispose.js:7
    ...
    at mustNotCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:631:12)
    at AssertionError.get stack (native)
TypeError: timer[(intermediate value).dispose] is not`
...
### 1 × `AssertionError: Got unwanted exception: <str> === <str> at Function.throws (native) at pushError (<loc>) at <loc> at AssertionError.get stack (native)`
...
distinct messages:
- `AssertionError: Got unwanted exception: Command failed: /work/.harness/work/node-api/node-test/.tmp.783/install/bin/elide
...
### 1 × `AssertionError: Got unwanted exception: Out of range: offset <n> + width <n> exceeds length <n> at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Got unwanted exception: Out of range: offset 0 + width 1 exceeds length 0
    at :anonymous (test-buffer-read.js:83:3)
...
### 1 × `AssertionError: Got unwanted exception: The <str> argument must be of type function. Received type string (<str>) at testUid (<loc>) at :=> (<loc>) at :anonymou`
...
### 1 × `AssertionError: Non-integer delay ordering should be <n>,<n>,<n>,<n>, but got <n>,<n>,<n>,<n> at Function.deepStrictEqual (native) at <loc> at _return (<loc>) a`

distinct messages:
- `AssertionError: Non-integer delay ordering should be 1,2,3,4, but got 1,4,3,2
    at Function.deepStrictEqual (native)
...
### 1 × `AssertionError: undefined == true at ok (native) at <loc> at Array.forEach (native) at <loc> at _return (<loc>) at AssertionError.get stack (native)`
...
### 1 × `AssertionError: undefined === [B@7e4281a1 at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: undefined === [B@7e4281a1
...
### 1 × `AssertionError: undefined === <n> at Function.strictEqual (native) at immediateHandler (<loc>) at _return (<loc>) at AssertionError.get stack (native) Assertion`
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToNumberNodeGen@12b0b85c: [[B@7d98c860], [byte[]] at :=> (<loc>)`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToNumberNodeGen@12b0b85c: [[B@7d98c860], [byte[]]
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@664a4e4b: [[B@7610a21e], [byte[]] at :=`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@664a4e4b: [[B@7610a21e], [byte[]]
    at :=> (native)
    at _return (index.js:573:12)`
...
### 1 × `error: unexpected argument <str> found Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND] For more information, try <str>. [node:child_process] uncau`
...
For more information, try '--help'.
[node:child_process] uncaught error in child event handler: AssertionError: 2 === 0
error: unexpected argument 'child' found

Usage: elide [OPTIONS] [FILE] [--`
example test: `test/parallel/test-vm-sigint-existing-handler.js`

### 1 × `error: unexpected argument <str> found Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND] For more information, try <str>. AssertionError: false == t`
...
### 1 × `error: unexpected argument <str> found Usage: elide [OPTIONS] [FILE] [-- <SCRIPT_ARGS>...] [COMMAND] For more information, try <str>. error: unexpected argument`
...
For more information, try '--help'.
error: unexpected `
example test: `test/parallel/test-vm-sigint.js`
...
### 1 × `java.lang.IllegalArgumentException: READ + APPEND not allowed at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `java.lang.IllegalArgumentException: READ + APPEND not allowed
    at :anonymous (test-fs-append-file-sync.js:95:21)
    at :program (test-fs-append-file-sync.js:1:1)`
...
### 1 × `ReferenceError: err3 is not defined at Domain.err2 (<loc>) at err (<loc>) at ReferenceError.get stack (native)`
...
### 1 × `ReferenceError: interval is not defined at <loc> at _return (<loc>) at ReferenceError.get stack (native) TypeError: (intermediate value)(...).unref is not a fun`
...
### 1 × `TypeError: (intermediate value).gc is not a function at <loc> at _return (<loc>) at TypeError.get stack (native)`
...
### 1 × `TypeError: (intermediate value)(...).unref is not a function at <loc> at TypeError.get stack (native)`
...
### 1 × `TypeError: (intermediate value)(...).unref is not a function at Process.<anonymous> (<loc>) at Process._return (<loc>) at TypeError.get stack (native)`
...
### 1 × `TypeError: Cannot add property <str> to non-object <n> at <loc> at _return (<loc>) at TypeError.get stack (native)`
...
### 1 × `TypeError: Cannot add property <str> to non-object <n> at <loc> at _return (<loc>) at TypeError.get stack (native) TypeError: timer.unref is not a function at :`
...
### 1 × `TypeError: Cannot read property <str> of undefined at onImmediate (<loc>) at onImmediate (<loc>) at TypeError.get stack (native) TypeError: Cannot read property`
...
### 1 × `TypeError: The <str> argument must be a number or Date. Received type string (<str>) at getExpectedMtime (<loc>) at runTests (<loc>) at runTests (<loc>) at Type`
...
### 1 × `TypeError: timer.refresh is not a function at <loc> at _return (<loc>) at TypeError.get stack (native)`
...
### 1 × `TypeError: timer1.unref is not a function at <loc> at _return (<loc>) at TypeError.get stack (native)`

distinct messages:
- `TypeError: timer1.unref is not a function
    at test-timers-unrefed-in-callback.js:31:12
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at TypeError.get stack (native)`
example test: `test/parallel/test-timers-unrefed-in-callback.js`
...
distinct messages:
- `TypeError: TypeError: Cannot load module: 'http'`
example test: `test/parallel/test-worker-cleanexit-with-moduleload.js`

### 1 × `TypeError: TypeError: Cannot load module: <str> TypeError: TypeError: Cannot load module: <str> AssertionError: Missing expected exception at :anonymous (<loc>)`
...
### 1 × `Uncaught (in promise) AssertionError: Got rejection that did not match expected: node:worker_threads: postMessageToThread is not implemented yet in Elide Assert`
...
### 1 × `Uncaught JSException in event listener: AssertionError: <str> === <str> AssertionError: Unexpected global(s) found: Operators, onunhandledrejection, onrejection`

distinct messages:
- `Uncaught JSException in event listener: AssertionError: 'undefined' === 'number'
AssertionError: Unexpected global(s) found: Operators, onunhandledrejection, onrejectionhandled
    at Function.fail (native)
    at Process.<anonymous> (/work/.harness/work/node-api/node-api-overlay/test/common/index.j`
...
| 184 | node:streams |
| 115 | node:fs |
| 96 | node:worker-threads |
| 68 | node:process |
| 59 | node:vm |
| 54 | node:buffer |
| 44 | node:module-loading |
