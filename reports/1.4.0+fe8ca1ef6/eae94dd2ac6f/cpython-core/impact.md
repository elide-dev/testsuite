...
AssertionError: <function FinalizeTestCase.test_all_freed.<locals>.callback at 0x428437bd> is not None`
...
AssertionError: b'File "/tmp/tmpz75p8yq1/script.py", line 2, in __main__.Test' not found in b'***************`
...
AssertionError: b'/tmp/tmp7sdsu2im/script.py' not found in b'> /work/.harness/work/cpython-core/`
...
AssertionError: 'Z' unexpectedly found in {<weakref at 573426635; to 'UserString' at 1544641873>, <weakref at 1418461269; to`
...
AssertionError: 4.9704368300008355 not less than 4`
...
AssertionError: <test.test_exceptions.ExceptionTests.testExceptionCleanupState.<locals>.MyObj object at 0x5568618e> is not None`
