...
│values provided for JSToNumberNodeGen@67e29109: [[B@f262e6e], [byte[]]       │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected    │
│values provided for JSToObjectNodeGen.Uncached@514f983e: [[B@31a8713],       │
│[byte[]]                                                   `
...
distinct messages:
- `(node:10038) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10038) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9389) Warning: A Warning
(node:9389) CustomWarning: A Warning
(node:9389) Warning: A Warning
(node:9389) CustomWarning: A Warning
(node:9389) [CODE001] CustomWarning: A Warning
(node:9389) CustomWarning: A Warning
(node:9389) [CODE001] CustomWarning: A Warning
(node:9389) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10306) Warning: test
(node:10306) DeprecationWarning: test
(node:10306) Warning: test
(node:10306) DeprecationWarning: test
(node:10306) Error: test
(node:10306) Warning: test
...
distinct messages:
- `7/4/2026, 9:26:52 PM start test
7/4/2026, 9:26:52 PM waiting for callbacks
7/4/2026, 9:26:52 PM fs open() callback
7/4/2026, 9:26:52 PM WriteStream constructor
7/4/2026, 9:26:52 PM closed 1
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@27ea5a78 === [B@29f228e3 │ │ │ │ In file <loc> │ │─ Stack Tr`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@27ea5a78 === [B@29f228e3                                  │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@6bb93ed6 │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@6bb93ed6                                    │
│                                                                             │
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6246-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6246-64K.txt of length 65536
