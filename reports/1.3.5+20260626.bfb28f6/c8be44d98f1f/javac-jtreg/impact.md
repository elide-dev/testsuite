...
distinct messages:
- `'/work/.harness/work/javac-jtreg/jtreg-run-JW8MFD/wrapper-jdk/bin/java' timed out after 240000 ms (elapsed time including timeout handling 240518 ms)`
- `'/work/.harness/work/javac-jtreg/jtreg-run-JW8MFD/wrapper-jdk/bin/java' timed out after 240000 ms (elapsed time including timeout handling 240188 ms)`
