...
distinct messages:
- `'/work/.harness/work/javac-jtreg/jtreg-run-NDttrQ/wrapper-jdk/bin/java' timed out after 240000 ms (elapsed time including timeout handling 240186 ms)`
- `'/work/.harness/work/javac-jtreg/jtreg-run-NDttrQ/wrapper-jdk/bin/java' timed out after 240000 ms (elapsed time including timeout handling 240171 ms)`
