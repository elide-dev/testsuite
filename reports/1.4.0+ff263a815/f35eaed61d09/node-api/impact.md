...
### 418 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ co`
...
### 41 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │java.lang.UnsupportedOperationException: util.getCallSites() is not yet │ │impl`
...
### 40 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: {} │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n`
...
### 19 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc>: │ │ ╭`
...
### 10 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │java.lang.UnsupportedOperationException: path.resolve() is not yet │ │implement`
...
│                                                                             │
│ In file test/parallel/test-path-extname.js:225:1          `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│java.lang.UnsupportedOperationException: path.win32 is not yet implemented   │
│                                                                             │
│ In file test/parallel/test-path-glob.js:225:1             `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│java.lang.UnsupportedOperationException: path.win32 is not yet implemented   │
│                                                                             │
│ In file test/parallel/test-path-isabsolute.js:225:1       `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│java.lang.UnsupportedOperationException: path.win32 is not yet implemented   │
│                                                                             │
│ In file test/parallel/test-path-normalize.js:225:1        `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│java.lang.UnsupportedOperationException: path.win32 is not yet implemented   │
│                                                                             │
│ In file test/parallel/test-path-join.js:225:1             `
...
### 5 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │java.lang.IllegalStateException: Cannot load module: │ │<str> │ │ │ │ In file <`
...
example test: `test/parallel/test-worker-environmentdata.js`
...
### 2 × `Uncaught (in promise) TypeError: path must be a string, Buffer, or file: URL`
...
### 1 × `[EventLoop] external task threw: Error: invalid char <n>,undefined <loc>.runtime.JSException: Error: invalid char <n>,undefined`

distinct messages:
- `[EventLoop] external task threw: Error: invalid char 0,undefined
...
### 1 × `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@4b75e2b4: [[B@67a83970], [byte[]] com.oracle.truffle.api.dsl.Unsup`

distinct messages:
- `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@4b75e2b4: [[B@67a83970], [byte[]]
com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSCollectionsNormalizeNodeGen@4b75e2b4: [[B@67a83970], [byte[]]
	at com.oracle`
...
distinct messages:
- `7/1/2026, 9:48:26 PM start test
╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'prototype' of undefined                     │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: Got unwanted exception: {code: <str>, errno: -<n>, │ │syscall: `

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: Got unwanted exception: {code: 'ERR_FS_EISDIR', errno: -21,  │
│syscall: 'rm', path:                                                         │
│'/work/.harness/work/node-api/node-test/.tmp.624/速_dir'}   `
example test: `test/parallel/test-fs-rmSync-special-char.js`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@71d70885 │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n>`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@71d70885                                    │
│                                                                             │
...
### 1 × `Uncaught (in promise) Error: ENOENT: no such file or directory, open <str>`
...
### 1 × `Uncaught (in promise) TypeError: {ok: function ok() { [native code] }, equal: function equal() { [native code] }, notEqual: function notEqual() { [native code] `

distinct messages:
- `Uncaught (in promise) TypeError: {ok: function ok() { [native code] }, equal: function equal() { [native code] }, notEqual: function notEqual() { [native code] }, strictEqual: function strictEqual() { [native code] }, notStrictEqual: function notStrictEqual() { [native code] }, deepEqual: function d`
example test: `test/parallel/test-fs-readv-promises.js`
