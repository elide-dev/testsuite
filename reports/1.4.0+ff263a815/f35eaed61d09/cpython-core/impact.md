...
### 2 × `Traceback (most recent call last): File <str>, line <n>, in wrapper return function(*args, **kwargs) ^^^^^^^^^^^^^^^^^^^^^^^^^ File <str>, line <n>, in test_com`
...
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_gzip.py", line 997, in wrapper
    return function(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/work/suites/cpython/Lib/test/test_gzip.py", line 1062, in test_compress_infile_outfile_default
    rc, out, `
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_gzip.py", line 997, in wrapper
    return function(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/work/suites/cpython/Lib/test/test_gzip.py", line 1050, in test_compress_stdin_outfile
    self.assertEqual(e`
example test: `test_gzip.TestCommandLine.test_compress_infile_outfile_default`
...
AssertionError: <function FinalizeTestCase.test_all_freed.<locals>.callback at 0x6ed49b97> is not None`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_bad_syntax self.assertEqual(rc, <n>) AssertionError: <n> != <n>`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_py_compile.py", line 273, in test_bad_syntax
    self.assertEqual(rc, 1)
AssertionError: 2 != 1`
example test: `test_py_compile.PyCompileCLITestCase.test_bad_syntax`

### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_bad_syntax_with_quiet self.assertEqual(rc, <n>) AssertionError: <n> != <n>`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_py_compile.py", line 282, in test_bad_syntax_with_quiet
    self.assertEqual(rc, 1)
AssertionError: 2 != 1`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_builtins self.assertEqual(lines, [<str>]) AssertionError: Lists differ: [<str>, <str>.<str>Can<`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_inspect/test_inspect.py", line 5329, in test_builtins
    self.assertEqual(lines, ["Can't get info for builtin modules."])
AssertionError: Lists differ: ["error: unexpected argument '-m' found", '[156 chars]p'."] != ["Can'`
...
AssertionError: b'File "/tmp/tmp2wtl84sx/script.py", line 2, in __main__.Test' not found in b'***************`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_help stdout = self.run_ok(<str>) ^^^^^^^^^^^^^^^^^ File <str>, line <n>, in run_ok return asser`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_calendar.py", line 865, in test_help
    stdout = self.run_ok('-h')
             ^^^^^^^^^^^^^^^^^
  File "/work/suites/cpython/Lib/test/test_calendar.py", line 857, in run_ok
    return assert_python_ok('-m', 'calendar', `
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_output_current_year stdout = self.run_ok() ^^^^^^^^^^^^^ File <str>, line <n>, in run_ok return`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_calendar.py", line 877, in test_output_current_year
    stdout = self.run_ok()
             ^^^^^^^^^^^^^
  File "/work/suites/cpython/Lib/test/test_calendar.py", line 857, in run_ok
    return assert_python_ok('-m', 'cale`
example test: `test_calendar.CommandLineTestCase.test_output_current_year`
...
### 1 × `Traceback (most recent call last): File <str>, line <n>, in test_output_year stdout = self.run_ok(<str>) ^^^^^^^^^^^^^^^^^^^ File <str>, line <n>, in run_ok ret`

distinct messages:
- `Traceback (most recent call last):
  File "/work/suites/cpython/Lib/test/test_calendar.py", line 884, in test_output_year
    stdout = self.run_ok('2004')
             ^^^^^^^^^^^^^^^^^^^
  File "/work/suites/cpython/Lib/test/test_calendar.py", line 857, in run_ok
    return assert_python_ok('-m', '`
example test: `test_calendar.CommandLineTestCase.test_output_year`
...
AssertionError: b'/tmp/tmphq75zy23/script.py' not found in b'> /work/.harness/work/cpython-core/`
...
AssertionError: 'Z' unexpectedly found in {<weakref at 1079835541; to 'UserString' at 598098876>, <weakref at 1581470859; to`
...
AssertionError: 4.939687049947679 not less than 4`
...
AssertionError: <test.test_exceptions.ExceptionTests.testExceptionCleanupState.<locals>.MyObj object at 0x223a49d4> is not None`
