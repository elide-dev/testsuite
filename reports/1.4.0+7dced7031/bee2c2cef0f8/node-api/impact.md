...
│TypeError: Cannot load module: 'async_hooks'                                 │
│                                                                             │
│ In file test/parallel/test-async-hooks-close-during-destro`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
...
│TypeError: Cannot load module: 'async_hooks'                                 │
│                                                                             │
│ In file test/parallel/test-async-hooks-promise-triggerid.j`
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot load module: 'async_hooks'                                 │
│                                                                             │
...
distinct messages:
- `(node:12166) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:12166) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:11451) Warning: A Warning
(node:11451) CustomWarning: A Warning
(node:11451) Warning: A Warning
(node:11451) CustomWarning: A Warning
(node:11451) [CODE001] CustomWarning: A Warning
(node:11451) CustomWarning: A Warning
(node:11451) [CODE001] CustomWarning: A Warning
(node:11451) [CODE001] Cus`
...
distinct messages:
- `(node:12450) Warning: test
(node:12450) DeprecationWarning: test
(node:12450) Warning: test
(node:12450) DeprecationWarning: test
(node:12450) Error: test
(node:12450) Warning: test
...
### 1 × `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@c0500f9: [[B@152ce6cb], [byte[]] com.oracle.truffle.api.dsl.Unsupp`

distinct messages:
- `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@c0500f9: [[B@152ce6cb], [byte[]]
com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSCollectionsNormalizeNodeGen@c0500f9: [[B@152ce6cb], [byte[]]
	at com.oracle.t`
...
distinct messages:
- `7/2/2026, 9:02:26 PM start test
╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'prototype' of undefined                     │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@6a091413 │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n>`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@6a091413                                    │
│                                                                             │
...
│values provided for JSToNumberNodeGen@5219b5aa: [[B@2bb4c079], [byte[]]      │
│                                                           `
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-8043-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-8043-64K.txt of length 65536
