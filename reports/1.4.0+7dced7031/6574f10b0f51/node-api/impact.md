...
### 421 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ co`
...
### 66 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot load module: <str> │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n> │ │ `
...
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: function should not have been called at                      │
│test-stream-writable-destroy.js:28                                           │
│                                                           `
...
### 3 × `AssertionError: function should not have been called at <loc> at Function.fail (native) at mustNotCall (<loc>)`
...
distinct messages:
- `(node:12327) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:12327) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:11604) Warning: A Warning
(node:11604) CustomWarning: A Warning
(node:11604) Warning: A Warning
(node:11604) CustomWarning: A Warning
(node:11604) [CODE001] CustomWarning: A Warning
(node:11604) CustomWarning: A Warning
(node:11604) [CODE001] CustomWarning: A Warning
(node:11604) [CODE001] Cus`
...
distinct messages:
- `(node:12600) Warning: test
(node:12600) DeprecationWarning: test
(node:12600) Warning: test
(node:12600) DeprecationWarning: test
(node:12600) Error: test
(node:12600) Warning: test
...
### 1 × `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@490b70c0: [[B@<n>], [byte[]] com.oracle.truffle.api.dsl.Unsupporte`

distinct messages:
- `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@490b70c0: [[B@63688529], [byte[]]
com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSCollectionsNormalizeNodeGen@490b70c0: [[B@63688529], [byte[]]
	at com.oracle`
...
distinct messages:
- `7/2/2026, 4:57:10 PM start test
╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'prototype' of undefined                     │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@20116feb │ │ │ │ In file <loc>: │ │ ╭─ │ │ <n>`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@20116feb                                    │
│                                                                             │
...
│values provided for JSToNumberNodeGen@50d74b4a: [[B@30b6e320], [byte[]]      │
│                                                           `
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-8237-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-8237-64K.txt of length 65536
