...
### 9 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
│values provided for JSToNumberNodeGen@c2c6170: [[B@6402f22c], [byte[]]       │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected    │
│values provided for JSToObjectNodeGen.Uncached@30169ebf: [[B@16d42ee1],      │
│[byte[]]                                                   `
...
### 2 × `AssertionError: {stackTraceLimit: <n>} === {} at Function.strictEqual (native) at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitt`

distinct messages:
- `AssertionError: {stackTraceLimit: 10} === {}
    at Function.strictEqual (native)
    at EventEmitter.<anonymous> (test-worker-syntax-error-file.js:13:12)
...
- `AssertionError: {stackTraceLimit: 10} === {}
    at Function.strictEqual (native)
    at EventEmitter.<anonymous> (test-worker-syntax-error.js:9:10)
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)`
example test: `test/parallel/test-worker-syntax-error-file.js`
...
### 2 × `Error: Failed to create a new context: IllegalStateException: Engine is already closed.`

distinct messages:
- `Error: Failed to create a new context: IllegalStateException: Engine is already closed.`
...
distinct messages:
- `(node:10086) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10086) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9433) Warning: A Warning
(node:9433) CustomWarning: A Warning
(node:9433) Warning: A Warning
(node:9433) CustomWarning: A Warning
(node:9433) [CODE001] CustomWarning: A Warning
(node:9433) CustomWarning: A Warning
(node:9433) [CODE001] CustomWarning: A Warning
(node:9433) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10344) Warning: test
(node:10344) DeprecationWarning: test
(node:10344) Warning: test
(node:10344) DeprecationWarning: test
(node:10344) Error: test
(node:10344) Warning: test
...
distinct messages:
- `7/3/2026, 10:30:00 PM start test
7/3/2026, 10:30:00 PM waiting for callbacks
7/3/2026, 10:30:00 PM fs open() callback
7/3/2026, 10:30:00 PM WriteStream constructor
7/3/2026, 10:30:00 PM closed 1
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@<n> === [B@358b8e1a │ │ │ │ In file <loc> │ │─ Stack Trace ─`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@981760 === [B@358b8e1a                                    │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@466c3c8a │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@466c3c8a                                    │
│                                                                             │
...
distinct messages:
- `AssertionError: 'Error: Error: fhqwhgads
    at EventEmitter.<anonymous> (test-worker-error-stack-getter-throws.js:18:31)
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)' === undefined
    at Function.strictEqu`
...
### 1 × `TypeError: TypeError: Cannot load module: <str> TypeError: TypeError: Cannot load module: <str>`
...
### 1 × `TypeError: TypeError: Cannot load module: <str> TypeError: TypeError: Cannot load module: <str> TypeError: TypeError: Cannot load module: <str> TypeError: TypeE`
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6243-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6243-64K.txt of length 65536
