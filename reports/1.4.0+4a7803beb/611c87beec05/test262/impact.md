...
example test: `test/built-ins/Error/prototype/stack/getter-error-as-prototype.js strict mode`
...
example test: `test/language/module-code/instn-named-bndng-dflt-named.js default`
...
example test: `test/language/module-code/instn-iee-bndng-const.js strict mode`
...
example test: `test/language/module-code/source-phase-import/reexport-source-binding-namespace-get.js strict mode`
