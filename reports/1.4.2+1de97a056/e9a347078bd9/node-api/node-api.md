# node-api — `1.4.2+1de97a056`

- Image digest: `e9a347078bd9986d48c8eea15c5d53288a0988c47cc0dc5af436471abe7882ef`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-09T21:56:28.203Z → 2026-08-09T22:01:36.895Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1075/3071 (50.40%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1075 | 963 | 95 | 938 | 7 | 204 |
...
- `test/parallel/test-buffer-alloc.js` — fail — (node:754) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-arraybuffer.js` — fail — (node:788) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-compare.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: `The "b" argument must be an instance of Buffer or Uint8Array. Received type string ('abc')` -   message: `The "buf2" argument must be an instance of Buffer or Uint8Array. Received type string ('abc')`   }
...
# todo 0
# duration_ms 1093
- `test/parallel/test-buffer-indexof.js` — fail — AssertionError: Expected values to be strictly equal:  -1 !== 1
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1114) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-concat.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: 'The "list[0]" argument must be an instance of Buffer or Uint8Array. Received type number (104)' -   message: 'The "list" argument must be an instance of Array. Received an instance of Buffer'   }
    at :=> (test-buffer-concat.js:49:3)
    at :anonymous (test-buffer-concat.js:48:1)
    at :program (test-buffer-concat.js:1:1)
- `test/parallel/test-buffer-bytelength.js` — fail — (node:972) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1340]: --- stderr ---
...
- `test/parallel/test-buffer-new.js` — fail — (node:1338) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-isutf8.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected  + Comparison {} - Comparison { -   code: 'ERR_INVALID_ARG_TYPE' - }
    at :=> (test-buffer-isutf8.js:68:3)
    at :anonymous (test-buffer-isutf8.js:61:1)
    at :program (test-buffer-isutf8.js:1:1)
- `test/parallel/test-buffer-isascii.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected  + Comparison {} - Comparison { -   code: 'ERR_INVALID_ARG_TYPE' - }
...
- `test/parallel/test-buffer-parent-property.js` — fail — (node:1395) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-resizable.js` — fail — (node:1467) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
- `test/parallel/test-buffer-over-max-length.js` — fail — (node:1394) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-slow.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   code: 'ERR_MEMORY_ALLOCATION_FAILED', +   name: 'Error' -   code: 'ERR_OUT_OF_RANGE', -   name: 'RangeError'   }
    at :anonymous (test-buffer-slow.js:52:1)
    at :program (test-buffer-slow.js:1:1)
- `test/parallel/test-buffer-write.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_OUT_OF_RANGE', +   message: 'The value of "offset" is out of range. It must be >= 0 and <= 9. Received -1', -   message: 'The value of "offset" is out of range. It must be >= 0 && <= 9. Received -1',     name: 'RangeError'   }
    at :=> (test-buffer-write.js:7:3)
    at :anonymous (test-buffer-write.js:6:1)
    at :program (test-buffer-write.js:1:1)
- `test/parallel/test-buffer-tostring-range.js` — fail — AssertionError: Expected values to be strictly equal:  'abc' !== ''
...
- `test/parallel/test-buffer-writeuint.js` — fail — AssertionError: Expected values to be strictly equal: + actual - expected  + [Function: writeUInt8] - undefined
...
- `test/parallel/test-child-process-cwd.js` — fail — AssertionError: Expected values to be strictly equal:
+ actual - expected
...
Error: spawn pwd ENOTDIR
AssertionError: The input did not match the regular expression /The URL must be of scheme file/. Input:  Expected values to be strictly equal: + actual - expected  + 'undefined' - 'number'
...
- `test/parallel/test-child-process-execfile.js` — fail — AssertionError: Expected values to be strictly equal:
+ actual - expected
...
- `test/parallel/test-child-process-fork-stdio-string-variant.js` — fail — AssertionError: Missing expected exception (TypeError).
...
- `test/parallel/test-buffer-tostring-rangeerror.js` — fail — (node:1567) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-child-process-spawn-typeerror.js` — fail — Error: spawn  ENOENT
AssertionError: Missing expected exception (TypeError).
...
- `test/parallel/test-child-process-spawnsync-input.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected  + Buffer(0) [Uint8Array] [] - Buffer(15) [Uint8Array] [ -   116, -   104, -   105, -   115, -   32, -   105, -   115, -   32, -   115, -   116, -   100, -   111, -   117, -   116, -   10 - ]
...
- `test/parallel/test-child-process-stdio.js` — fail — AssertionError: Missing expected exception (Error).
...
- `test/parallel/test-child-process-uid-gid.js` — fail — Error: spawn echo EIO
...
- `test/parallel/test-fs-writesync-crash.js` — AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: 'EBADF: bad file descriptor, write', -   message: '',     name: 'Error'   }
    at :anonymous (test-fs-writesync-crash.js:40:1)
    at :program (test-fs-writesync-crash.js:1:1)
- `test/parallel/test-http-pipeline-socket-parser-typeerror.js` — Error: This socket has been ended by the other party
- `test/parallel/test-net-connect-abort-controller.js` — Error: ECONNRESET: connection reset by peer, tcp-read '5' (errno=104)
- `test/parallel/test-http-chunked-smuggling.js` — Node API test timed out
- `test/parallel/test-http-insecure-parser.js` — Node API test timed out
- `test/parallel/test-http-server-delete-parser.js` — Node API test timed out
- `test/parallel/test-vm-global-setter.js` — AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: "Cannot assign to read only property 'nonWritableProp' of {getSetPropReceivingFunction: accessor, getSetPropReceivingNumber: accessor, propReceivingNumber: 144, getSetPropThrowing: accessor, nonWritableProp: 51, globalProxy: (this), unknownPropReceivingNumber: 145, Symbol(sym-1): accessor, Symbol(sym-2): accessor, Symbol(sym-3): 148, Symbol(sym-4): 149}", -   message: 'Cannot redefine property: nonWritableProp',     name: 'TypeError'   }
    at :anonymous (test-vm-global-setter.js:115:1)
    at :program (test-vm-global-setter.js:1:1)

## 🟢 New passes (204) — consider advancing the baseline
