...
### 21 × `AssertionError: Expected values to be strictly equal: <n> !== <n> at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Expected values to be strictly equal:  250 !== 615
...
### 19 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
### 18 × `AssertionError: Missing expected exception. at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Missing expected exception.
    at :anonymous (test-diagnostics-channel-tracing-channel-args-types.js:37:1)
...
example test: `test/parallel/test-child-process-advanced-serialization.js`

### 15 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at :anonymous (<loc>) at :program (<loc>)`
...
### 9 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
- `TypeError: Cannot read property 'split' of undefined
    at :anonymous (test-process-release.js:6:22)
    at :program (test-process-release.js:1:1)`
...
### 8 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + Comparison {} - Comparison { - code: <str> - } at :anonymous (<loc>) at :progra`
...
### 8 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + message: <str>, - code: <str>, - message: <str>, name: <str> } at `
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream-transform-final-sync.js:69:17
    at test-stream-transform-final-sync.js:1:1
Mismatched <anonymous> function calls`
...
distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: 'The "buffer" argument must be of type string or an instance of Buffer, TypedArray, or DataView. Received undefined', -   message: 'The "offset" argument must`
...
### 7 × `AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Missing expected exception (TypeError).
    at :anonymous (test-dns-channel-timeout.js:9:5)
    at :program (test-dns-channel-timeout.js:1:1)`
- `AssertionError: Missing expected exception (TypeError).
    at :anonymous (test-net-server-options.js:6:1)
    at :program (test-net-server-options.js:1:1)`
- `AssertionError: Missing expected exception (TypeError).
...
### 7 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (`
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at EventEmitter.<anonymous> (test-http-server-keepalive-end.js:12:24)
    at EventEmitter._return (/work/.harness/work/node-api/n`
example test: `test/parallel/test-diagnostics-channel-net.js`

### 6 × `AssertionError: Expected values to be strictly equal: <str> !== <str> at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Expected values to be strictly equal:  '[::1]' !== '::1'
    at :anonymous (test-url-urltooptions.js:20:1)
...
### 5 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at`
...
### 5 × `TypeError: Cannot read property <str> of null at :anonymous (<loc>) at :program (<loc>)`
...
### 4 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { code: <str>, + message: <str>, - message: <str>, name: <str> } at :=`
...
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_OUT_OF_RANGE', +   message: 'The value of "offset" is out of range. It must be >= 0 and <= 9. Received -1', -   message: 'The value of "offset" is out of range. It must be >= 0 && <= 9. Rece`
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: 'The "pathObject" argument must be of type object. Received type number', -   message: 'The "pathObject" argument must be of type object. Received type number`
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: 'The "filename" argument must be of type string or an instance of URL. Received boolean', -   message: 'The "filename" argument must be of type string or an i`
example test: `test/parallel/test-buffer-from.js`

### 4 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - <str> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>`
...
### 4 × `AssertionError: Expected values to be strictly equal: undefined !== <n> at Object.messageSent (<loc>) at Object.<anonymous> (<loc>) at Object._return (<loc>)`
...
undefined !== 236
    ...
    at Object._return (/work/.harness/wo`
- `AssertionError: Expected values to be strictly equal:
...
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-dns-negative-zero.js:9:43
    at test-dns-negative-zero.js:1:1
Mismatched noop function calls. Expected exactly 1, actual 0.
   `
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
...
### 3 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + Comparison {} - Comparison { - code: <str> - } at :=> (<loc>) at :anonymous (<l`
...
### 3 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at Duplex.<anonymous> (<loc>) at Duplex._return (<loc>)`
...
### 3 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - <str> at :anonymous (<loc>) at :program (<loc>)`
...
### 3 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - true at :anonymous (<loc>) at :program (<loc>)`
...
### 3 × `AssertionError: Expected values to be strictly equal: undefined !== <n> at Object.<anonymous> (<loc>) at Object._return (<loc>)`
...
### 3 × `AssertionError: Expected values to be strictly equal: undefined !== <n> at Object.<anonymous> (<loc>) at Object.<anonymous> (<loc>) at Object._return (<loc>)`
...
### 3 × `AssertionError: Missing expected exception (TypeError). at :=> (<loc>) at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Missing expected exception (TypeError).
    at :=> (test-readline-interface-escapecodetimeout.js:34:3)
    at :anonymous (test-readline-interface-escapecodetimeout.js:28:1)
    at :program (test-readline-interface-escapecodetimeout.js:1:1)`
example test: `test/parallel/test-dgram-custom-lookup.js`

### 3 × `AssertionError: Missing expected exception. at :=> (<loc>) at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Missing expected exception.
    at :=> (test-perf-hooks-timerify-invalid-args.js:22:3)
    at :anonymous (test-perf-hooks-timerify-invalid-args.js:21:1)
    at :program (test-perf-hooks-timerify-invalid-args.js:1:1)`
...
### 3 × `Error: ENOENT: no such file or directory, open <str>`
...
### 3 × `Uncaught (in promise) AssertionError: Missing expected rejection.`
...
### 2 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + [] - [ - <str> - ] at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected  + [] - [ -   'Timeout' - ]
...
distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   code: 'ERR_OUT_OF_RANGE', +   message: 'The value of "length" is out of range. It must be <= 0. Received 10' -   code: 'ERR_INVALID_ARG_VALUE', -   message: "The argument 'buffer' is empty and cannot b`
...
### 2 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at :=> (<loc>) at _return (<loc>)`

distinct messages:
- `AssertionError: Expected values to be strictly equal: + actual - expected  + '["foo"]' - "[ 'foo' ]"
    at :=> (test-console-tty-colors.js:19:7)
    at _return (index.js:573:12)`
- `AssertionError: Expected values to be strictly equal: + actual - expected  + '' - '0123456789012345678901234567890123456789'
    at :=> (test-zlib-premature-end.js:28:7)
    at _return (index.js:573:12)`
example test: `test/parallel/test-console-tty-colors.js`

### 2 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - Domain { - members: [] - } at :=> (<loc>) at _return (<loc>) at :anonymo`

distinct messages:
- `AssertionError: Expected values to be strictly equal: + actual - expected  + undefined - Domain { -   members: [] - }
...
### 2 × `AssertionError: Expected values to be strictly equal: <n> !== <n> at Timeout.<anonymous> (<loc>) at Timeout._return (<loc>) AssertionError: Expected values to b`
...
AssertionError: Expected values to be stric`
- `AssertionError: Expected values to be strictly equal:
...
### 2 × `AssertionError: function should not have been called at <loc> at Immediate.mustNotCall (<loc>)`
...
### 2 × `AssertionError: Missing expected exception (Error). at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Missing expected exception (Error).
    at :anonymous (test-stream-transform-constructor-set-methods.js:9:1)
    at :program (test-stream-transform-constructor-set-methods.js:1:1)`
example test: `test/parallel/test-child-process-stdio.js`

### 2 × `AssertionError: Missing expected exception (RangeError). at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Missing expected exception (RangeError).
    at :anonymous (test-fs-utimes.js:214:3)
    at :program (test-fs-utimes.js:1:1)`
- `AssertionError: Missing expected exception (RangeError).
...
### 2 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at mustCall (<loc>) at Proxy.expectsError (<loc>) at <loc> at <loc> Mismatched <anonymo`
...
### 2 × `TypeError: Cannot set property _events of [object EventEmitter] which has only a getter at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `TypeError: Cannot set property _events of [object EventEmitter] which has only a getter
    at :anonymous (test-event-emitter-listeners.js:85:3)
    at :program (test-event-emitter-listeners.js:1:1)`
- `TypeError: Cannot set property _events of [object EventEmitter] which has only a getter
    at :anonymous (test-event-emitter-remove-listeners.js:150:3)
...
### 1 × `AssertionError: <n>, <n>, <n> !== <n> at :=> (<loc>) at _return (<loc>)`

distinct messages:
- `AssertionError: 3, 1,   3 !== 1
...
### 1 × `AssertionError: AssertionError: Expected values to be strictly deep-equal: + actual - expected + [] - [ - <str> - ] TypeError: Cannot read property <str> of nul`

distinct messages:
- `AssertionError: AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
### 1 × `AssertionError: AssertionError: Expected values to be strictly deep-equal: + actual - expected + {} - { - codeRangeSizeMb: <n>, - maxOldGenerationSizeMb: <n>, -`
...
AssertionError: Expected values to be strictly deep-equal: + actual - expected  +`
example test: `test/parallel/test-worker-resource-limits.js`

### 1 × `AssertionError: AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { - code: <str>, name: <str> }`
...
### 1 × `AssertionError: AssertionError: Expected values to be strictly equal: + actual - expected + undefined - <str> AssertionError: Expected values to be strictly equ`

distinct messages:
- `AssertionError: AssertionError: Expected values to be strictly equal:
+ actual - expected
...
### 1 × `AssertionError: AssertionError: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :progra`

distinct messages:
- `AssertionError: AssertionError: Missing expected exception (TypeError).
AssertionError: Missing expected exception (TypeError).
...
### 1 × `AssertionError: AssertionError: Missing expected exception.`

distinct messages:
- `AssertionError: AssertionError: Missing expected exception.`
example test: `test/parallel/test-worker-unsupported-things.js`

### 1 × `AssertionError: AssertionError: The input did not match the regular expression /AtomicsLoad/. Input: <str>.<str>`

distinct messages:
- `AssertionError: AssertionError: The input did not match the regular expression /AtomicsLoad/. Input:
...
### 1 × `AssertionError: EIO: i/o error, tcp-bind <str> (errno=<n>) at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (native)`
...
### 1 × `AssertionError: Expected <str> to be strictly unequal to: undefined at Domain.<anonymous> (<loc>) at Domain._return (<loc>) at EventEmitter.server (<loc>) at Ev`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected [ <str>, + <str>, + <str> - <str>, - <str>, - <str>, - <str>, - <str> ] at :=> (<`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    [     '012', +   '345\r67', +   '89 ABC DEF' -   '345', -   '67', -   '89', -   'ABC', -   'DEF'   ]
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected { + data: null, + lastEventId: <str>, - data: undefined, - lastEventId: <str>, or`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    { +   data: null, +   lastEventId: '', -   data: undefined, -   lastEventId: 'undefined',     origin: 'foo',     ports: [], +   source: null, -   source: undefined,     type: 'message'   }
    at :anonymous (test-worke`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + [] - [ - <str>, - <str>, - <str>, - <str>, - <str>, - <str>, - <str>, - <str>, `

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected  + [] - [ -   'toString', -   'href', -   'origin', -   'protocol', -   'username', -   'password', -   'host', -   'hostname', -   'port', -   'pathname', -   'search', -   'searchParams', -   'hash', -   'toJSON' - ]
  `
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + Set(<n>) { - Set(<n>) { <str>, <str>, <str>, <str>, <str>, + <str>, - <str>, <s`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected  + Set(12) { - Set(14) {     'cached_builtins',     'debug',     'dtls',     'inspector',     'ipv6', +   'openssl', -   'openssl_is_boringssl',     'quic', -   'require_module',     'tls',     'tls_alpn',     'tls_ocsp',`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + undefined - { - foo: <str> - } at checkEnd (<loc>) at checkEnd (<loc>) at <loc>`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str> - code: <str> } at :=> (<loc>) at :anonymous (<loc>) a`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   code: 'EBADF' -   code: 'ERR_INVALID_ARG_TYPE'   }
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str>, + message: <str>, - code: <str>, - message: /^Not run`
...
+ actual - expected
  ...
  Comparison {
+   code: 'EBADF',
+   message: "EBADF: bad file descriptor, udp-addMembership '1' (errno=9)",
...
distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   code: 'ERR_MEMORY_ALLOCATION_FAILED', +   name: 'Error' -   code: 'ERR_OUT_OF_RANGE', -   name: 'RangeError'   }
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + message: <str> - code: <str>, - message: /^No such built-in module`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: "Cannot load module: 'node:unknown'" -   code: 'ERR_UNKNOWN_BUILTIN_MODULE', -   message: /^No such built-in module: /u   }
    at :anonymous (test-require-node-prefix.js:15:3)
    at :program`
example test: `test/parallel/test-require-node-prefix.js`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + message: <str>, - message: /Receiver must be an instance of class/`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: 'Value of "this" must be of type URL', -   message: /Receiver must be an instance of class/,     name: 'TypeError'   }
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { code: <str>, + message: <str> - message: <str> } at :=> (<loc>) at :`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: 'The "list[0]" argument must be an instance of Buffer or Uint8Array. Received type number (104)' -   message: 'The "list" argument must be an instance of Arra`
...
distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: ʼThe "b" argument must be an instance of Buffer or Uint8Array. Received type string ('abc')ʼ -   message: ʼThe "buf2" argument must be an instance of Buffer o`
example test: `test/parallel/test-buffer-compare.js`

### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { code: <str>, + message: <str> - message: <str> } at Duplex.<anonymou`
...
+ actual - expected
  ...
  Comparison {
    code: 'ENOENT',
+   message: "ENOENT: network error, tcp-connect '/tmp/fadagagsdfgsdf' (errno=2)"
-   message: 'connect ENOENT /tmp/fadagagsdfgsdf'
  }

    at Duplex.<anonymous> (/work/.harness/work/n`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { code: <str>, + message: <str>, - message: <str>, name: <str> } at Du`
...
+ actual - expected
  ...
  Comparison {
    code: 'ECONNRESET',
+   message: "ECONNRESET: connection reset by peer, tcp-read '3' (errno=104)",
-   message: 'read ECONNRESET',
    name: 'Error'
  }

    at Duplex.<anonymous> (/work/.harness/work/`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected RangeError { constructor: [Function: RangeError], + message: <str> - message: <st`
...
-   message: 'Maximum call stack size exceeded'
    ...
    at EventEmitter.<anonymous> (/work/.harness/wor`
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at <loc> at _return (<loc>) at EventEmitter.emit (native) AssertionErr`
...
+ 'Command failed'
- 'Command failed: /opt/elide/bin/elide /work/.harness/work/node-api/node-api-overlay/test/fixtures/exit.js 42'

    at test-child-process-execfile.js:27:14
    at _return (/work/.harness/work/node-api/node`
example test: `test/parallel/test-child-process-execfile.js`

### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at <loc> at _return (<loc>) at Writable.end (native) at EventEmitter.s`
...
- 'ERR_STREAM_ALREADY_FINISHED'
    ...
    at test-http-outgoing-end-multiple.js:14:12
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at Writable.end (n`
example test: `test/parallel/test-http-outgoing-end-multiple.js`

### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at check (<loc>) at EventEmitter.server (<loc>) at EventEmitter.emit (`

distinct messages:
- `AssertionError: Expected values to be strictly equal:
+ actual - expected

+ 'Basic dXNlcjpwYXNzJTNB'
- 'Basic dXNlcjpwYXNzOg=='
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - ClientRequest [Writable] { - _bodyForbidden: false, - _ended: false, - _`
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - Domain { - members: [] - } at :anonymous (<loc>) at :program (<loc>)`
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - Server [EventEmitter] { - _allowHalfOpen: true, - _connections: <n>, - _`
...
- }
    ...
    at EventEmitter.onSocket (test-net-p`
...
distinct messages:
- `AssertionError: Expected values to be strictly equal: + actual - expected  + Url { +   auth: null, +   hash: null, +   host: null, +   hostname: null, +   href: 'foo', +   path: 'foo', +   pathname: 'foo', +   port: null, +   protocol: null, +   query: null, +   search: null, +   slashes: false + } `
...
### 1 × `AssertionError: Expected values to be strictly equal: <n> !== <n> at <loc> at _return (<loc>) TypeError: Cannot read property <str> of undefined at :=> (<loc>) `
...
1 !== 0
    ...
    at test-stream-writable-destroy.js:397:12
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
TypeError: Cannot read property 'code' of undefined
    at :=> (test-stream-writable-destroy.js:338`
...
### 1 × `AssertionError: Expected values to be strictly equal: <n> !== <n> at Immediate.<anonymous> (<loc>) at Immediate._return (<loc>)`
...
distinct messages:
- `AssertionError: Expected values to be strictly equal:  'abc' !== 'YWJj'
    at :=> (test-stream-readable-unshift.js:99:7)
    at _return (index.js:573:12)`
...
### 1 × `AssertionError: Expected values to be strictly equal: <str> !== <str> at doTest (<loc>) at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Expected values to be strictly equal:  '' !== '[1;1H[0J'
...
### 1 × `AssertionError: Expected values to be strictly equal: false !== true at testMethod (<loc>) at :=> (<loc>) at :anonymous (<loc>) at :program (<loc>)`
...
### 1 × `AssertionError: Expected values to be strictly equal: true !== false at <loc> at _return (<loc>) AssertionError: function should not have been called at <loc> a`
...
true !== false
    ...
    at _return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
AssertionError: function should not have been called at test-fs-write-stream-autoclo`
...
### 1 × `AssertionError: Expected values to be strictly equal: undefined !== <n> at Object.<anonymous> (<loc>) at Object.<anonymous> (<loc>) at Object._return (<loc>) at`
...
undefined !== 512
    ...
    at Object.<anonymous> (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:538:17)
    at Object._return (/work/.harness/work/no`
example test: `test/parallel/test-dgram-connect-send-multi-buffer-copy.js`

### 1 × `AssertionError: Expected values to be strictly equal: undefined !== <n> at Object.onMessage (<loc>) at Object._return (<loc>)`
...
### 1 × `AssertionError: function onUncaught(error) {} at <loc> called with arguments: <str>, <str> at process.mustNotCall (<loc>) AssertionError: function onUncaught(er`
...
AssertionError: function onUncaught`
...
### 1 × `AssertionError: function should not have been called at <loc> at EventEmitter.mustNotCall (<loc>) at EventEmitter.emit (native) AssertionError: Missing expected`

distinct messages:
- `AssertionError: function should not have been called at test-net-server-listen-options.js:58
    at EventEmitter.mustNotCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:631:12)
    at EventEmitter.emit (native)
AssertionError: Missing expected exception (TypeError).
    at sh`
...
### 1 × `AssertionError: function should not have been called at <loc> at Immediate.mustNotCall (<loc>) AssertionError: Expected values to be strictly equal: + actual - `

distinct messages:
- `AssertionError: function should not have been called at test-async-hooks-top-level-clearimmediate.js:30
    at Immediate.mustNotCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:631:12)
AssertionError: Expected values to be strictly equal: + actual - expected  + Immediate { + `
example test: `test/parallel/test-async-hooks-top-level-clearimmediate.js`

### 1 × `AssertionError: function should not have been called at <loc> at Immediate.mustNotCall (<loc>) AssertionError: function should not have been called at <loc> at `

distinct messages:
- `AssertionError: function should not have been called at test-timers-setimmediate-infinite-loop.js:17
    at Immediate.mustNotCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:631:12)
AssertionError: function should not have been called at test-timers-setimmediate-infinite-loop`
...
### 1 × `AssertionError: function should not have been called at <loc> at Timeout.mustNotCall (<loc>)`
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: { result: [Function (anonymous)] }, <str> at mustNotCall (<loc>)`
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: { result: undefined }, <str> at mustNotCall (<loc>) at <loc> at <loc>`
...
called with arguments: { result: undefined }, 'tracing:test:end'
    at mustNotCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:631:12)
    at test-diagnosti`
example test: `test/parallel/test-diagnostics-channel-tracing-channel-sync-early-exit.js`
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: Error: write after end at <loc> at Array.map (native) at Writable.mustNotCa`
...
called with arguments: Error: write after end
    ...
    at Array.map (native)
    at Writable.mustNotCall (/work/.harness/work/`
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: null at Object.mustNotCall (<loc>) AssertionError: function should not have`
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: TypeError: The <str> argument must be of type string or an instance of Buff`

distinct messages:
- `AssertionError: function should not have been called at test-zlib-unzip-one-byte-chunks.js:16
called with arguments: TypeError: The "chunk" argument must be of type string or an instance of Buffer, TypedArray, or DataView. Received an instance of Object
    at /work/.harness/work/node-api/node-api-o`
...
distinct messages:
- `AssertionError: function should not have been called at test-zlib-object-write.js:8
called with arguments: TypeError: The input must be a Buffer, TypedArray, DataView, ArrayBuffer, or string
    at test-zlib-object-write.js:10:10
    at Function.throws (native)
    at test-zlib-object-write.js:9:8
 `
...
### 1 × `AssertionError: Got unwanted exception: protocol Actual message: <str> at :=> (<loc>) at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Got unwanted exception: protocol Actual message: "receiver is not a URLPattern"
    at :=> (test-urlpattern-invalidthis.js:25:3)
    at :anonymous (test-urlpattern-invalidthis.js:13:1)
...
### 1 × `AssertionError: Missing expected exception (Error). at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (native) at Duplex.`
...
- `AssertionError: Missing expected exception (Error).
    ...
    at EventEmitter.emit (native)
    at Duplex.push (nat`
example test: `test/parallel/test-http-head-throw-on-response-body-write.js`

### 1 × `AssertionError: Missing expected exception (TypeError): createWriteStream options.fs.open should throw if isn't a function at :=> (<loc>) at :anonymous (<loc>) `

distinct messages:
- `AssertionError: Missing expected exception (TypeError): createWriteStream options.fs.open should throw if isn't a function
...
### 1 × `AssertionError: Missing expected exception (TypeError): zlib.constants.Z_OK should be immutable at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Missing expected exception (TypeError): zlib.constants.Z_OK should be immutable
    at :anonymous (test-zlib-const.js:13:1)
    at :program (test-zlib-const.js:1:1)`
example test: `test/parallel/test-zlib-const.js`

### 1 × `AssertionError: Missing expected exception (TypeError). at <loc> at Array.forEach (native) at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) a`
...
### 1 × `AssertionError: The expression evaluated to a falsy value: assert.ok(fileURL.endsWith(<str>)) at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: The expression evaluated to a falsy value:    assert.ok(fileURL.endsWith('/'))
    at :anonymous (test-url-pathtofileurl.js:10:3)
...
### 1 × `AssertionError: The expression evaluated to a falsy value: assert.ok(req.signal instanceof AbortSignal) at EventEmitter.<anonymous> (<loc>) at EventEmitter._ret`
...
distinct messages:
- `AssertionError: The expression evaluated to a falsy value:    assert(builtinModules.includes('http'))
    at :anonymous (test-module-builtin.js:7:1)
...
distinct messages:
- `AssertionError: The expression evaluated to a falsy value:    assert(inspection.includes('active: true'))
    at :anonymous (test-worker-message-port-inspect-during-init-hook.js:21:1)
...
### 1 × `AssertionError: The expression evaluated to a falsy value: assert(isBuiltin(<str>)) at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: The expression evaluated to a falsy value:    assert(isBuiltin('http'))
    at :anonymous (test-module-isBuiltin.js:7:1)
    at :program (test-module-isBuiltin.js:1:1)`
example test: `test/parallel/test-module-isBuiltin.js`
...
### 1 × `AssertionError: The input did not match the regular expression /^DataCloneError: Transfer list contains duplicate MessagePort$/. Input: {} at :anonymous (<loc>)`

distinct messages:
- `AssertionError: The input did not match the regular expression /^DataCloneError: Transfer list contains duplicate MessagePort$/. Input:  {}
...
### 1 × `AssertionError: The input did not match the regular expression /^Error: foo$/. Input: <str> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) `

distinct messages:
- `AssertionError: The input did not match the regular expression /^Error: foo$/. Input:
...
### 1 × `AssertionError: The input did not match the regular expression /^Error: setMulticastTTL EINVAL$/. Input: The value of <str> is out of range. It must be >= <n> a`

distinct messages:
- `AssertionError: The input did not match the regular expression /^Error: setMulticastTTL EINVAL$/. Input:

The value of "ttl" is out of range. It must be >= 0 and <= 255. Received 1000

    at EventEmitter.<anonymous> (test-dgram-multicast-setTTL.js:34:10)
    at EventEmitter._return (/work/.harness/`
...
### 1 × `AssertionError: The input did not match the regular expression /Cannot find module <str>/. Input: Cannot load module: <str> at :anonymous (<loc>) at :program (<`

distinct messages:
- `AssertionError: The input did not match the regular expression /Cannot find module '\u0000ab'/. Input:  Cannot load module: ' ab'
    at :anonymous (test-require-nul.js:8:1)
    at :program (test-require-nul.js:1:1)`
example test: `test/parallel/test-require-nul.js`

### 1 × `AssertionError: The input did not match the regular expression /Cannot find module <str>/. Input: Command failed: /work/.harness/work/node-api/node-test/.tmp.<n`

distinct messages:
- `AssertionError: The input did not match the regular expression /Cannot find module '\x66oo'/. Input:  Command failed: /work/.harness/work/node-api/node-test/.tmp.1932/install/bin/elide
...
### 1 × `AssertionError: The input did not match the regular expression /DataCloneError/. Input: {} at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: The input did not match the regular expression /DataCloneError/. Input:  {}
    at :anonymous (test-worker-invalid-workerdata.js:10:1)
    at :program (test-worker-invalid-workerdata.js:1:1)`
example test: `test/parallel/test-worker-invalid-workerdata.js`
...
### 1 × `AssertionError: The input did not match the regular expression /ERR_INVALID_ARG_TYPE/. Input: (intermediate value).setSourceMapsEnabled is not a function at :an`

distinct messages:
- `AssertionError: The input did not match the regular expression /ERR_INVALID_ARG_TYPE/. Input:  (intermediate value).setSourceMapsEnabled is not a function
...
### 1 × `AssertionError: The input did not match the regular expression /ERR_INVALID_ARG_TYPE/. Input: Module.setSourceMapsSupport is not a function at :anonymous (<loc>`

distinct messages:
- `AssertionError: The input did not match the regular expression /ERR_INVALID_ARG_TYPE/. Input:  Module.setSourceMapsSupport is not a function
...
### 1 × `AssertionError: The input did not match the regular expression /ERR_INVALID_ARG_TYPE/. Input: The <str> argument must be specified at :anonymous (<loc>) at :pro`

distinct messages:
- `AssertionError: The input did not match the regular expression /ERR_INVALID_ARG_TYPE/. Input:  The "streams" argument must be specified
...
### 1 × `AssertionError: The input did not match the regular expression /The <str> argument must be of type string/. Input: isStringOneByteRepresentation is not a functi`

distinct messages:
- `AssertionError: The input did not match the regular expression /The "content" argument must be of type string/. Input:  isStringOneByteRepresentation is not a function
...
### 1 × `AssertionError: The input did not match the regular expression /TypeError/. Input: setMulticastInterface EINVAL at EventEmitter.<anonymous> (<loc>) at EventEmit`

distinct messages:
- `AssertionError: The input did not match the regular expression /TypeError/. Input:

setMulticastInterface EINVAL
...
### 1 × `AssertionError: Unexpected stack shape (domain._stack = undefined) + actual - expected + undefined - [ - Domain { - members: [] - }, - Domain { - members: [] - `

distinct messages:
- `AssertionError: Unexpected stack shape (domain._stack = undefined) + actual - expected  + undefined - [ -   Domain { -     members: [] -   }, -   Domain { -     members: [] -   } - ]
...
### 1 × `AssertionError: wrong exit for <n>-exitWithOneOnUncaught expected:<n> but got:<n> <n> !== <n> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>`

distinct messages:
- `AssertionError: wrong exit for 3-exitWithOneOnUncaught
expected:1 but got:99
...
### 1 × `Error: ECONNREFUSED: connection refused, tcp-connect <str> (errno=<n>) AssertionError: Missing expected exception (RangeError): createConnectionWithCb() at sync`

distinct messages:
- `Error: ECONNREFUSED: connection refused, tcp-connect '0:0:0:0:0:0:0:1:0' (errno=111)
AssertionError: Missing expected exception (RangeError): createConnectionWithCb()
...
### 1 × `Error: ECONNREFUSED: connection refused, tcp-connect <str> (errno=<n>) AssertionError: Missing expected exception: http request should throw when passing invali`
...
distinct messages:
- `Error: ECONNREFUSED: connection refused, tcp-connect '127.0.0.1:9999' (errno=111)
Error: ECONNREFUSED: connection refused, tcp-connect '127.0.0.1:9999' (errno=111)
Error: ECONNREFUSED: connection refused, tcp-connect '127.0.0.1:9999' (errno=111)
Error: ECONNREFUSED: connection refused, tcp-connect '`
...
### 1 × `Error: ENOENT: no such file or directory, open <str> Error: ENOENT: no such file or directory, open <str>`

distinct messages:
- `Error: ENOENT: no such file or directory, open '/work/.harness/work/node-api/node-api-overlay/test/parallel/file.txt'
Error: ENOENT: no such file or directory, open '/work/.harness/work/node-api/node-api-overlay/test/parallel/file.txt'`
example test: `test/parallel/test-readline-input-onerror.js`
...
distinct messages:
- `Error: foobar`
example test: `test/parallel/test-domain-ee-implicit.js`
...
### 1 × `Error: process.stdout construction failed: TypeError: <this>.buf.subarray is not a function at process.get stdout (native) at Writable.<anonymous> (<loc>) at Wr`
...
- `Error: process.stdout construction failed: TypeError: <this>.buf.subarray is not a function
    ...
    at Writable.emit (native)
    at Duplex.emit (native)
    at EventEmitter.breakSocket (test-http-cl`
...
### 1 × `Error: spawn echo EIO AssertionError: Missing expected exception. at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `Error: spawn echo EIO
AssertionError: Missing expected exception.
...
### 1 × `Error: spawn ENOENT AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
### 1 × `Error: test destroy AssertionError: function should not have been called at <loc> called with arguments: Error: Destroy test at EventEmitter.<anonymous> (<loc>)`

distinct messages:
- `Error: test destroy
AssertionError: function should not have been called at test-http-outgoing-destroyed.js:61
called with arguments: Error: Destroy test
    at EventEmitter.<anonymous> (test-http-outgoing-destroyed.js:68:17)
...
### 1 × `Error: This socket has been ended by the other party`

distinct messages:
- `Error: This socket has been ended by the other party`
example test: `test/parallel/test-http-pipeline-socket-parser-typeerror.js`
...
### 1 × `Error: Unhandled error. (undefined) at :anonymous (<loc>) at :program (<loc>)`
...
### 1 × `ReferenceError: reader is not defined at Readable.<anonymous> (<loc>) at Readable._return (<loc>) at ReferenceError.get stack (native) TypeError: Cannot constru`

distinct messages:
- `ReferenceError: reader is not defined
    at Readable.<anonymous> (test-stream-readable-to-web-termination-byob.js:9:39)
    at Readable._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at ReferenceError.get stack (native)
TypeError: Cannot construct a BYOB rea`
...
### 1 × `TypeError: Cannot set property _events of [object EventEmitter] which has only a getter at :anonymous (<loc>) at :program (<loc>) AssertionError: Expected value`

distinct messages:
- `TypeError: Cannot set property _events of [object EventEmitter] which has only a getter
    at :anonymous (test-event-emitter-remove-all-listeners.js:108:3)
...
### 1 × `TypeError: deflater.flush is not a function at :anonymous (<loc>) AssertionError: Expected values to be strictly deep-equal: + actual - expected + undefined - B`
...
### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected RangeError { constructor: [Function: RangeError], + message`
...
### 1 × `Uncaught (in promise) AssertionError: Missing expected rejection (AbortError). Uncaught (in promise) AssertionError: Missing expected rejection (AbortError). Un`
...
### 1 × `Uncaught (in promise) AssertionError: The input did not match the regular expression /AbortError/. Input: {}`

distinct messages:
- `Uncaught (in promise) AssertionError: The input did not match the regular expression /AbortError/. Input:
...
### 1 × `Uncaught (in promise) Error: Command failed AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
### 1 × `Uncaught (in promise) Error: Command failed AssertionError: The expression evaluated to a falsy value: assert(promise.child instanceof child_process.ChildProces`
...
### 1 × `Uncaught (in promise) Error: foo Uncaught (in promise) AssertionError: Expected values to be strictly equal: + actual - expected + undefined - Domain { - member`
...
### 1 × `Uncaught (in promise) Error: node:worker_threads: postMessageToThread is not implemented yet in Elide TypeError: TypeError: Cannot execute on non-shared array.`
