...
AssertionError: <function FinalizeTestCase.test_all_freed.<locals>.callback at 0x30afa190> is not None`
...
AssertionError: b'File "/tmp/tmpfz5q5oa7/script.py", line 2, in __main__.Test' not found in b'***************`
...
AssertionError: b'/tmp/tmptoti9m3t/script.py' not found in b'> /work/.harness/work/cpython-core/`
...
AssertionError: 'Z' unexpectedly found in {<weakref at 2113358176; to 'UserString' at 387602971>, <weakref at 985147753; to `
...
AssertionError: 5.377423757920042 not less than 4`
...
AssertionError: <test.test_exceptions.ExceptionTests.testExceptionCleanupState.<locals>.MyObj object at 0x35137e99> is not None`
