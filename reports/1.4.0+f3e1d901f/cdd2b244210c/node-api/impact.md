...
### 18 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: false == true │ │ │ │ In file <loc> │ │─ Stack Trace ──────────`
...
### 18 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │TypeError: Cannot read property <str> of undefined │ │ │ │ In file <loc> │ │─ S`
...
### 5 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-timers-nan-duration-warning-promises.js:7:32
    at test-timers-nan-duration-warning-promises.js:1:1`
...
│values provided for JSToNumberNodeGen@188e215b: [[B@611ca4af], [byte[]]      │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected    │
│values provided for JSToObjectNodeGen.Uncached@2a59a9ab: [[B@3ac2acf9],      │
│[byte[]]                                                   `
example test: `test/parallel/test-fs-promises-writefile-typedarray.js`

### 2 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │null │ │ │ │ In file <loc> │ │─ Stack Trace ───────────────────────────────────`
...
example test: `test/parallel/test-fs-promises-write-optional-params.js`
...
distinct messages:
- `(node:10140) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10140) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9486) Warning: A Warning
(node:9486) CustomWarning: A Warning
(node:9486) Warning: A Warning
(node:9486) CustomWarning: A Warning
(node:9486) [CODE001] CustomWarning: A Warning
(node:9486) CustomWarning: A Warning
(node:9486) [CODE001] CustomWarning: A Warning
(node:9486) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10395) Warning: test
(node:10395) DeprecationWarning: test
(node:10395) Warning: test
(node:10395) DeprecationWarning: test
(node:10395) Error: test
(node:10395) Warning: test
...
### 1 × `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@23dd2cde: [[B@350b9906], [byte[]] com.oracle.truffle.api.dsl.Unsup`

distinct messages:
- `[EventLoop] external task threw: Unexpected values provided for JSCollectionsNormalizeNodeGen@23dd2cde: [[B@350b9906], [byte[]]
com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSCollectionsNormalizeNodeGen@23dd2cde: [[B@350b9906], [byte[]]
	at com.oracle`
...
distinct messages:
- `7/3/2026, 4:27:32 AM start test
╭─ Script Error ──────────────────────────────────────────────────────────────╮
│TypeError: Cannot read property 'prototype' of undefined                     │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@70ae93e === [B@<n> │ │ │ │ In file <loc> │ │─ Stack Trace ──`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@39338f9a │ │ │ │ In file <loc> │ │─ Stack Trac`
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │null │ │ │ │ In file <loc> │ │─ Advice ────────────────────────────────────────`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│null                                                                         │
│                                                                             │
│ In file test/parallel/test-stream-auto-destroy.js:419:1   `
...
### 1 × `first cb second cb [EventLoop] external task threw: AssertionError: null === BAM <loc>.runtime.JSException: AssertionError: null === BAM`

distinct messages:
- `first cb
second cb
[EventLoop] external task threw: AssertionError: null === BAM
com.oracle.truffle.js.runtime.JSException: AssertionError: null === BAM`
...
### 1 × `Uncaught (in promise) AssertionError: <n> === <n> Uncaught (in promise) Error: stream.push() after EOF [EventLoop] external task threw: {} <loc>.runtime.UserScr`

distinct messages:
- `Uncaught (in promise) AssertionError: 0 === 5
Uncaught (in promise) Error: stream.push() after EOF
[EventLoop] external task threw: {}
...
### 1 × `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.<n>/.removeme-fs-readfile-<n>-64K.txt of length <n> Validating readFile on file /work/.h`

distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6305-64K.txt of length 65536
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6305-1K.txt of length 1024
