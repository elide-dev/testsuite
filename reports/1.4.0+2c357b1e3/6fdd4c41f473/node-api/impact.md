...
│values provided for JSToNumberNodeGen@3b8bbda7: [[B@68f49baf], [byte[]]      │
│                                                           `
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected    │
│values provided for JSToObjectNodeGen.Uncached@387041b7: [[B@d6dd68c],       │
│[byte[]]                                                   `
...
│                                                           `
example test: `test/parallel/test-worker-relative-path.js`
...
distinct messages:
- `(node:10061) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:10061) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:9417) Warning: A Warning
(node:9417) CustomWarning: A Warning
(node:9417) Warning: A Warning
(node:9417) CustomWarning: A Warning
(node:9417) [CODE001] CustomWarning: A Warning
(node:9417) CustomWarning: A Warning
(node:9417) [CODE001] CustomWarning: A Warning
(node:9417) [CODE001] CustomWarni`
...
distinct messages:
- `(node:10318) Warning: test
(node:10318) DeprecationWarning: test
(node:10318) Warning: test
(node:10318) DeprecationWarning: test
(node:10318) Error: test
(node:10318) Warning: test
...
distinct messages:
- `7/4/2026, 6:59:06 PM start test
7/4/2026, 6:59:06 PM waiting for callbacks
7/4/2026, 6:59:06 PM fs open() callback
7/4/2026, 6:59:06 PM WriteStream constructor
7/4/2026, 6:59:06 PM closed 1
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: [B@4e2456c5 === [B@3f9f2450 │ │ │ │ In file <loc> │ │─ Stack Tr`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: [B@4e2456c5 === [B@3f9f2450                                  │
│                                                                             │
...
### 1 × `╭─ Script Error ──────────────────────────────────────────────────────────────╮ │AssertionError: undefined === [B@5288d081 │ │ │ │ In file <loc> │ │─ Stack Trac`

distinct messages:
- `╭─ Script Error ──────────────────────────────────────────────────────────────╮
│AssertionError: undefined === [B@5288d081                                    │
│                                                                             │
...
distinct messages:
- `Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6247-1K.txt of length 1024
Validating readFile on file /work/.harness/work/node-api/node-test/.tmp.608/.removeme-fs-readfile-6247-64K.txt of length 65536
