...
example test: `fetch/fetch-later/permissions-policy/deferred-fetch-allowed-by-permissions-policy.https.window.js :: Permissions policy header: "deferred-fetch=*" allows fetchLater() in the same-origin iframe.`
