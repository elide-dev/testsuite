...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007105a0000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007f114671d750 (heapBase + 15447495137104)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007105b6c09038 points into the stack for thread 0x00007105a0000cc0
 `
- `[ [ SegfaultHandler caught a segfault in thread 0x0000710b20000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007f114671d360 (heapBase + 15423872815968)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000710b36c6a448 points into the stack for thread 0x0000710b20000cc0
 `
...
distinct messages:
- `(node:74586) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:104739) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:82461) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:37436) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 123047]: --- stdout ---

[process 123047]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 08:18:18 GMT\r`
...
### 1 × `AssertionError: Client allowed multiple content-length headers. at Writable.<anonymous> (<loc>) at Writable.emit (native) at Duplex.push (native)`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 08:19:31 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 08:19:02 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.93757.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:41155' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `AssertionError: The input did not match the regular expression /HTTP\/<n>\.<n> <n> Service Unavailable/m. Input: <str> at Duplex.<anonymous> (<loc>) at Duplex._`

distinct messages:
- `AssertionError: The input did not match the regular expression /HTTP\/1\.1 503 Service Unavailable/m. Input:

'0'

    at Duplex.<anonymous> (test-http-keep-alive-pipeline-max-requests.js:77:14)
    at Duplex._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at `
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@5a672e06: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@5a672e06: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@56587e3a], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:38243`
...
distinct messages:
- `Uncaught (in promise) Error: escaped timeout at 2027 milliseconds!
AssertionError: Missing expected exception.
