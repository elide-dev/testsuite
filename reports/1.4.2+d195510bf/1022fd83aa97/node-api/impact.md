...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000079516c000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000071f799f1d750 (heapBase - 8078062397616)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000795181b09038 points into the stack for thread 0x000079516c000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007d52cc000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000071f799f1d360 (heapBase - 12482014489760)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007d52e1f0a448 points into the stack for thread 0x00007d52cc000cc0
 `
...
distinct messages:
- `(node:75969) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:106892) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:84336) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:37901) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 125953]: --- stdout ---

[process 125953]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 10:47:04 GMT\r`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 10:48:16 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 10:47:49 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.95883.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:52568' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@70f4e9d0: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@70f4e9d0: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@64e9db9e], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:39577`
