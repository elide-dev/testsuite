...
- Image digest: `7b36496e2e29e5a6dd14f70a30b868ae545a9245341876c51b951ea10a4e8787`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-11T05:32:02.188Z → 2026-08-11T06:02:25.270Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1252/3071 (58.70%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1252 | 806 | 75 | 938 | 4 | 273 |
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1254]: --- stderr ---
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1265) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-http-keep-alive-pipeline-max-requests.js` — AssertionError: The input did not match the regular expression /Hello World!/m. Input:
...
## 🟢 New passes (273) — consider advancing the baseline
