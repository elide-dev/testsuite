...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-dns-perf_hooks.js:25:36
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007c5d88000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000703a3871d750 (heapBase - 13341502875824)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007c5d9f7a9038 points into the stack for thread 0x00007c5d88000cc0
 `
- `[ [ SegfaultHandler caught a segfault in thread 0x000071d8bc000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000703a3871d360 (heapBase - 1776028363936)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000071d8d392a448 points into the stack for thread 0x000071d8bc000cc0
  `
...
distinct messages:
- `(node:76485) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
[EventLoop] external task threw: Could not allocate an aligned heap chunk because the heap address space is `
...
distinct messages:
- `(node:107473) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:84827) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:38470) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 126331]: --- stdout ---

[process 126331]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 05:47:49 GMT\r`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 05:49:02 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 05:48:30 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.96373.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:54363' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `AssertionError: The input did not match the regular expression /Hello World!/m. Input: <str> at assertResponse (<loc>) at Duplex.<anonymous> (<loc>) at Duplex._`

distinct messages:
- `AssertionError: The input did not match the regular expression /Hello World!/m. Input:

'0'

    at assertResponse (test-http-keep-alive-pipeline-max-requests.js:14:12)
    at Duplex.<anonymous> (test-http-keep-alive-pipeline-max-requests.js:75:7)
    at Duplex._return (/work/.harness/work/node-api/`
...
### 1 × `AssertionError: wrong exit for <n>-exitWithUndefinedFatalException expected:<n> but got:<n> <n> !== <n> at EventEmitter.<anonymous> (<loc>) at EventEmitter._ret`

distinct messages:
- `AssertionError: wrong exit for 10-exitWithUndefinedFatalException
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@6271105b: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@6271105b: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@435c8673], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:35359`
...
### 1 × `Error: read ECONNRESET Error: read ECONNRESET`
...
### 1 × `Uncaught (in promise) AssertionError: Missing expected rejection. Uncaught (in promise) AssertionError: Missing expected rejection. Uncaught (in promise) Assert`
