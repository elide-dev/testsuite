...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000076063c000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000735c6351d750 (heapBase - 2924212791472)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000760650549038 points into the stack for thread 0x000076063c000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007cb830000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000735c6351d360 (heapBase - 10285585411232)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007cb847c3a448 points into the stack for thread 0x00007cb830000cc0
 `
...
distinct messages:
- `(node:78769) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:109516) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:86997) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:39720) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 128246]: --- stdout ---

[process 128246]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 07:29:58 GMT\r`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 07:31:19 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 07:30:36 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.98372.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:48484' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@602a50d6: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@602a50d6: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@558ef441], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:36963`
...
AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: 'escaped timeout at 2005 milliseconds!' -   code: 'ERR_SCRIPT_EXECUTION_TIMEOUT', -   message: 'Script execution timed out af`
