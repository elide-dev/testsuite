...
- Image digest: `723b3a64840e9bc8bc6ea7b7bdcebd1607fe7f8776c40c0e921237145c053c22`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-10T18:15:27.841Z → 2026-08-10T18:45:40.060Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1181/3071 (55.37%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1181 | 878 | 74 | 938 | 5 | 203 |
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1259]: --- stderr ---
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1270) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
false !== true
    ...
    at Writable._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
- `test/parallel/test-http-raw-headers.js` — ok
...
## 🟢 New passes (203) — consider advancing the baseline
