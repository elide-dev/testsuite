...
### 5 × `AssertionError: Expected values to be strictly equal: <str> !== <str> at :anonymous (<loc>) at :program (<loc>)`
...
- `AssertionError: Expected values to be strictly equal:  'Symbol()' !== 'NaN'
    at :anonymous (test-util-format.js:59:1)
...
distinct messages:
- `(node:76397) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:107287) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:107316) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:85701) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007fe0d4000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007bdfce11d750 (heapBase - 4398145743024)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007fe0eab69038 points into the stack for thread 0x00007fe0d4000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000076425c000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007bdfce11d360 (heapBase + 6178077004640)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007642705ea448 points into the stack for thread 0x000076425c000cc0
  `
...
[process 126249]: --- stdout ---

[process 126249]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 18:31:12 GMT\r\n\r\nOK"`
...
### 1 × `AssertionError: case / failed, actual paths is [<str>,<str>] + actual - expected [ - <str>, <str> ] at :=> (<loc>) at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: case / failed, actual paths is ["//node_modules","/node_modules"] + actual - expected    [ -   '//node_modules',     '/node_modules'   ]
    at :=> (test-module-nodemodulepaths.js:124:3)
    at :anonymous (test-module-nodemodulepaths.js:122:1)
    at :program (test-module-nodemodulep`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected [Object: null prototype] { + <str>: <str>, date: <str> } at Writable.<anonymous> `
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 18:33:00 GMT'
  }
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + message: <str>, - message: /Cannot read private member/, name: <st`

distinct messages:
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: 'Receiver must be an instance of class URL', -   message: /Cannot read private member/,     name: 'TypeError'   }
    at :=> (test-whatwg-url-invalidthis.js:58:3)
    at :anonymous (test-whatw`
...
+   'Date: Mon, 10 Aug 2026 18:31:54 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
### 1 × `AssertionError: Expected values to be strictly equal: undefined !== <str> at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Expected values to be strictly equal:  undefined !== ''
    at :anonymous (test-url-urltooptions.js:33:1)
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:41631' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@604b545d: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@604b545d: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@25cc358b], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:38933`
...
### 1 × `Uncaught (in promise) AssertionError: Missing expected exception (Error). AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <s`
...
- 'AbortError'
    ...
    at Readable.<anonymous> (test-fs-read-stream-file-handle.js:145:12)
    at Readable._return (/work/.harness/work/node-api`
