...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007556a4000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007b6f0871d750 (heapBase + 6706129393488)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007556b9469038 points into the stack for thread 0x00007556a4000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x000075bcc0000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007b6f0871d360 (heapBase + 6267572966240)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000075bcd808a448 points into the stack for thread 0x000075bcc0000cc0
  `
...
### 2 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { code: <str>, + message: <str>, - message: <str>, name: <str> } at :=`
...
distinct messages:
- `(node:77366) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:107684) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:107713) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:86207) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
[process 126861]: --- stdout ---

[process 126861]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 19:58:00 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 19:59:49 GMT'
  }
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + Comparison {} - Comparison { - code: <str> - } at :=> (<loc>) at :anonymous (<l`
...
+   'Date: Mon, 10 Aug 2026 19:58:42 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:53071' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@58ec39a9: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@58ec39a9: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@6be621a1], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:44305`
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    ...
    at test-fs-write-buffer.js:99:23
 `
