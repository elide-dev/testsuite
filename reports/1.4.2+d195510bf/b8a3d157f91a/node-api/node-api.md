...
- Image digest: `b8a3d157f91a8390b1419984f2633cd7b314a5387b11d802c5697874d6df682f`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-10T19:42:15.267Z → 2026-08-10T20:12:32.116Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1191/3071 (55.84%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1191 | 867 | 75 | 938 | 4 | 212 |
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1258]: --- stderr ---
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1269) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-resizable.js` — fail — (node:1517) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
## 🟢 New passes (212) — consider advancing the baseline
