...
- Image digest: `24b9ee439ea6f75a6975c52297062e9a2444ef3f19a49918e8f93a91a9814e3f`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-10T10:35:10.246Z → 2026-08-10T11:04:25.488Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1172/3071 (54.95%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1172 | 886 | 75 | 938 | 4 | 193 |
...
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1261]: --- stderr ---
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1272) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-buffer-resizable.js` — fail — (node:1520) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
- `test/parallel/test-fs-read-stream-pos.js` — Node API test timed out
...
## 🟢 New passes (193) — consider advancing the baseline
