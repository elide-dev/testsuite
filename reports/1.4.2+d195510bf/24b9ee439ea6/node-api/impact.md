...
distinct messages:
- `(node:1272) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
AssertionError: DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use th`
- `(node:1520) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.`
...
distinct messages:
- `(node:139719) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at process.listener (test-process-no-deprecation.js:13:10)
(node:139719) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:107999) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
[EventLoop] external task threw: Could not allocate an unaligned heap chunk because the heap address space `
...
distinct messages:
- `(node:145431) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:145460) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:120521) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000074cd30000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007254f931d360 (heapBase - 2711043583136)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000074cd45aea448 points into the stack for thread 0x000074cd30000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007100ec000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007254f931d750 (heapBase + 1464805480272)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000710101759038 points into the stack for thread 0x00007100ec000cc0
  `
...
distinct messages:
- `[process 1261]: --- stderr ---
(node:1261) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.

[process 1261]: --- stdout ---

[process 1261]: status = 0, signal = null
Erro`
...
[process 170980]: --- stdout ---

[process 170980]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 10:50:29 GMT\r\n\r\nOK"`
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected [ <str>, <str>, <str>, - <str>, - <str>, <str>, + <str>, + <str> ] at Writable.<a`
...
-   'array-val',
    '2',
+   'Date',
+   'Mon, 10 Aug 2026 10:55:14 GMT'
  ]

    at Writable.<anonymous> (test-http-write-head-after-set-header.js:39:12)
    at W`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 10:52:24 GMT'
  }
...
+   'Date: Mon, 10 Aug 2026 10:51:20 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:39696' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
called with arguments: <Buffer 28 6e 6f 64 65 3a 33 35 38 32 29 20 44 65 70 72 65 63 61 74 69 6f 6e 57 61 72 6e 69 6e 67 3a 20 53 6f 6d 65 74 68 69 6e 67 20 65 6c 73 65 20 69 73 20 ... 12 more bytes>
    `
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@4294b464: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@4294b464: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@42e5098d], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:45171`
