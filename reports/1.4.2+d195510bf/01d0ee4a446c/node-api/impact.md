...
### 2 × `AssertionError: Expected values to be strictly equal: true !== false at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (n`
...
distinct messages:
- `(node:78709) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:108759) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:87088) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:39664) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007b5734000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007a4742b1d750 (heapBase - 1163689339056)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007b574af19038 points into the stack for thread 0x00007b5734000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007716c0000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007a4742b1d360 (heapBase + 3511181235040)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007716d6eca448 points into the stack for thread 0x00007716c0000cc0
  `
...
[process 127556]: --- stdout ---

[process 127556]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 04:49:48 GMT\r`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 04:51:04 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 04:50:24 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.97610.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:38979' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@86179a6: [dev.elide.lang.javascript.nod`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@86179a6: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@3b4597f6], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:45809`
