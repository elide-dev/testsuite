...
### 97 × `Node API test timed out`

distinct messages:
- `Node API test timed out`
example test: `test/parallel/test-async-hooks-execution-async-resource-await.js`

### 19 × `AssertionError: Expected values to be strictly equal: <n> !== <n> at :anonymous (<loc>) at :program (<loc>)`
...
### 14 × `AssertionError: Missing expected exception. at :anonymous (<loc>) at :program (<loc>)`
...
### 10 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
distinct messages:
- `(node:1141) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
`
- `(node:1189) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
AssertionError: Expected values to be strictly equal:  2 !== 3
    at :anonymous (test-buffer-bytelength.js:10`
- `(node:1273) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
### 3 × `AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
distinct messages:
- `(node:36228) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at process.listener (test-process-no-deprecation.js:13:10)
(node:36228) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:25384) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:16893) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 default listeners added to [EventEmitter]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:39096) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:39112) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:27285) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:35532) Warning: A Warning
(node:35532) CustomWarning: A Warning
(node:35532) Warning: A Warning
(node:35532) CustomWarning: A Warning
(node:35532) [CODE001] CustomWarning: A Warning
(node:35532) CustomWarning: A Warning
(node:35532) [CODE001] CustomWarning: A Warning
(node:35532) [CODE001] Cus`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007944ec000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000742c0d11d750 (heapBase - 5600082274480)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000794501299038 points into the stack for thread 0x00007944ec000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000705274000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000742c0d11d360 (heapBase + 4237406098272)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000070528a58a448 points into the stack for thread 0x0000705274000cc0
  `
...
[process 1262]: status = 0, signal = null
Erro`
...
[process 43003]: --- stdout ---

[process 43003]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 07:25:05 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 07:27:45 GMT'
  }
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str>, + message: <str>, + name: <str> - code: <str>, - mess`
...
+   'Date: Mon, 10 Aug 2026 07:26:07 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:55903' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
called with arguments: <Buffer 28 6e 6f 64 65 3a 36 37 35 39 29 20 44 65 70 72 65 63 61 74 69 6f 6e 57 61 72 6e 69 6e 67 3a 20 53 6f 6d 65 74 68 69 6e 67 20 65 6c 73 65 20 69 73 20 ... 12 more bytes>
    `
...
### 1 × `AssertionError: Missing expected exception (TypeError). at :=> (<loc>) at :anonymous (<loc>) at :program (<loc>)`
...
### 1 × `AssertionError: The input did not match the regular expression /^DataCloneError: Transfer list contains duplicate MessagePort$/. Input: <str> at :anonymous (<lo`

distinct messages:
- `AssertionError: The input did not match the regular expression /^DataCloneError: Transfer list contains duplicate MessagePort$/. Input:  'DataCloneError: value of type MessagePortInstance is not yet supported by structured clone'
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@47ea5344: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@47ea5344: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@3591da7f], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:41383`
...
Printing instructions (ip=0x0000561af645193b):
  0x0000561af645183b: 0x0`
...
### 1 × `Mismatched noop function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at MessagePort.<anonymous> (<loc>) at MessagePort._return (<loc>) at`

distinct messages:
- `Mismatched noop function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at MessagePort.<anonymous> (test-worker-message-port-arraybuffer.js:24:24)
    at MessagePort._return (/work/.harness/work/node-api/node`
