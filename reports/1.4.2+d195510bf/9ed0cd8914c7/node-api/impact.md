...
### 18 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
### 15 × `AssertionError: Missing expected exception. at :anonymous (<loc>) at :program (<loc>)`
...
- `(node:1442) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   code: 'ERR_`
...
### 7 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + Comparison {} - Comparison { - code: <str> - } at :anonymous (<loc>) at :progra`
...
- `AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: 'The "superCtor.prototype" argument must be of type Object. Received undefined', -   message: 'The "superCtor.prototype" property must be of type object. Rece`
example test: `test/parallel/test-event-emitter-errors.js`
...
### 5 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (`
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at EventEmitter.<anonymous> (test-net-connect-nodelay.js:21:40)
...
### 4 × `AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
### 3 × `AssertionError: Expected values to be strictly equal: <str> !== <str> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (`
...
- `Mismatched <anonymous> function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:531:10)
    at test-stream2-set-encoding.js:212:23
    at test-stream2-set-encoding.js:1:1
Mismatched <anonymous> function calls. Expected ex`
...
### 3 × `TypeError: Cannot set property <str> of undefined at :anonymous (<loc>) at :program (<loc>)`
...
### 2 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - <str> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>`
...
example test: `test/parallel/test-net-listen-invalid-port.js`
...
distinct messages:
- `(node:37243) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at process.listener (test-process-no-deprecation.js:13:10)
(node:37243) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:26380) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
Unhandled exception: java.lang.OutOfMemoryError: Could not allocate an aligned heap chunk because the heap a`
...
distinct messages:
- `(node:17880) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 default listeners added to [EventEmitter]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:40104) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:40120) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:28281) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:36532) Warning: A Warning
(node:36532) CustomWarning: A Warning
(node:36532) Warning: A Warning
(node:36532) CustomWarning: A Warning
(node:36532) [CODE001] CustomWarning: A Warning
(node:36532) CustomWarning: A Warning
(node:36532) [CODE001] CustomWarning: A Warning
(node:36532) [CODE001] Cus`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007f3c24000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007b1eac31d360 (heapBase - 4520315333792)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007f3c3b6ca448 points into the stack for thread 0x00007f3c24000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000731760000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007b1eac31d750 (heapBase + 8831731357520)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007317774d9038 points into the stack for thread 0x0000731760000cc0
  `
...
[process 44016]: --- stdout ---

[process 44016]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 06:10:48 GMT\r\n\r\nOK"`
...
### 1 × `AssertionError: Domains stack should be empty in beforeExit handler but the value of process.domain is null + actual - expected + null - undefined at process.on`

distinct messages:
- `AssertionError: Domains stack should be empty in beforeExit handler but the value of process.domain is null
+ actual - expected

+ null
- undefined

    at process.onBeforeExit (test-domain-stack-empty-in-process-uncaughtexception.js:17:10)
    at process.onBeforeExit (/work/.harness/work/node-api/n`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 06:13:11 GMT'
  }
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at :=> (<loc>) at _return (<loc>) at :anonymous (<loc>) at :program (<`
...
+   'Date: Mon, 10 Aug 2026 06:11:49 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + Domain [EventEmitter] { + _disposed: false, + members: [] + } - undefined at EventEm`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:47889' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
called with arguments: <Buffer 28 6e 6f 64 65 3a 37 35 37 37 29 20 44 65 70 72 65 63 61 74 69 6f 6e 57 61 72 6e 69 6e 67 3a 20 53 6f 6d 65 74 68 69 6e 67 20 65 6c 73 65 20 69 73 20 ... 12 more bytes>
    `
...
### 1 × `AssertionError: function should not have been called at <loc> called with arguments: Error: write after end at Immediate.<anonymous> (<loc>) at Immediate._retur`
...
### 1 × `AssertionError: Missing expected exception (RangeError). at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Missing expected exception (RangeError).
    at :anonymous (test-zlib.js:32:1)
    at :program (test-zlib.js:1:1)`
example test: `test/parallel/test-zlib.js`
...
distinct messages:
- `AssertionError: The expression evaluated to a falsy value:    assert(isBuiltin('sys'))
    at :anonymous (test-module-isBuiltin.js:8:1)
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@55d26e8f: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@55d26e8f: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@407bd490], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `domains stack length should be 1 but is 2`
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:33763`
...
### 1 × `Error: connect ECONNREFUSED <n><loc><loc><loc><loc> AssertionError: Missing expected exception: http request should throw when passing invalid insecureHTTPParse`

distinct messages:
- `Error: connect ECONNREFUSED 0:0:0:0:0:0:0:1:80
...
### 1 × `Error: Connection closed before message completed AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str> - co`
...
### 1 × `Error: spawn /opt/elide/bin/elide ENOTDIR AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `Error: spawn /opt/elide/bin/elide ENOTDIR
AssertionError: Missing expected exception (TypeError).
...
### 1 × `Fatal error: java.lang.OutOfMemoryError: Could not allocate an aligned heap chunk because the heap address space is exhausted. Consider re-building the image wi`
...
Printing instructions (ip=0x00005941e95719db):
  0x00005941e95718db: 0x0`
...
### 1 × `Trace: in nexttick false AssertionError: Expected values to be strictly equal: + actual - expected + null - Domain [EventEmitter] { - _disposed: false, - member`
...
### 1 × `TypeError: Cannot construct a BYOB reader for a stream that is not a byte stream at :anonymous (<loc>) at :program (<loc>)`
...
| 60 | node:vm |
| 51 | node:net |
| 49 | node:child-process |
| 41 | node:module-loading |
| 34 | node:zlib |
| 28 | node:buffer |
| 26 | node:async-hooks |
| 26 | node:domain |
