...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000754b04000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000074338631d750 (heapBase - 1196111308976)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000754b1b599038 points into the stack for thread 0x0000754b04000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007a7500000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000074338631d360 (heapBase - 6873990966432)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007a751680a448 points into the stack for thread 0x00007a7500000cc0
  `
...
distinct messages:
- `(node:76059) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:106992) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:84373) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:38094) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 124796]: --- stdout ---

[process 124796]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 09:15:19 GMT\r`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 09:16:32 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 09:15:59 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.95816.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:44133' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3ff0f92d: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3ff0f92d: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@480ed6eb], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:45295`
...
### 1 × `GC summary Collected chunk bytes: <n>.00M Collected object bytes: <n>.00M Allocated chunk bytes: <n>.23M Allocated object bytes: <n>.92M Incremental GC count: <`

distinct messages:
- `GC summary
  Collected chunk bytes: 0.00M
  Collected object bytes: 0.00M
  Allocated chunk bytes: 35.23M
  Allocated object bytes: 34.92M
