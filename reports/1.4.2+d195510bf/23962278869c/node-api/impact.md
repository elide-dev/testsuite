...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000739138000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000072afe051d750 (heapBase - 963543443632)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000073914faf9038 points into the stack for thread 0x0000739138000cc0
  R`
- `[ [ SegfaultHandler caught a segfault in thread 0x00007e4de4000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000072afe051d360 (heapBase - 12768999255200)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007e4dfb36a448 points into the stack for thread 0x00007e4de4000cc0
 `
...
distinct messages:
- `(node:78237) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:108851) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:87308) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:38886) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 127942]: --- stdout ---

[process 127942]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 00:12:19 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 00:14:02 GMT'
  }
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected <str> + <str> + <str> + <str> + <str> + <str> + <str> + + <str> - <str> + - <str> + - `
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:51620' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3f9ada3b: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3f9ada3b: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@6b0cb19e], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:41607`
...
### 1 × `TypeError: The argument <str> is empty and cannot be written. Received <Buffer > at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `TypeError: The argument 'buffer' is empty and cannot be written. Received <Buffer >
    at :anonymous (test-fs-read-zero-length.js:16:11)
    at :program (test-fs-read-zero-length.js:1:1)`
example test: `test/parallel/test-fs-read-zero-length.js`
