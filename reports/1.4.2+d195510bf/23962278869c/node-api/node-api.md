...
- Image digest: `23962278869c0fa2ad0841d8f85a5fa97a31c268456a864d6cf2a34689811d7d`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-10T23:56:28.618Z → 2026-08-11T00:26:46.389Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1209/3071 (56.68%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1209 | 849 | 75 | 938 | 5 | 231 |
...
- `test/parallel/test-buffer-compare.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison {     code: 'ERR_INVALID_ARG_TYPE', +   message: 'The "target" argument must be an instance of Buffer or Uint8Array.', -   message: `The "target" argument must be an instance of Buffer or Uint8Array. Received type string ('abc')`,     name: 'TypeError'   }
    at :anonymous (test-buffer-compare.js:42:1)
    at :program (test-buffer-compare.js:1:1)
- `test/parallel/test-buffer-concat.js` — fail — AssertionError: Missing expected exception.
...
- `test/parallel/test-child-process-fork-stdio-string-variant.js` — fail — Error: Source is not a file or is not readable: /work/.harness/work/node-api/node-api-overlay/test/fixtures/child-process-spawn-node; see --help
...
- `test/parallel/test-fs-read-zero-length.js` — TypeError: The argument 'buffer' is empty and cannot be written. Received <Buffer >
...
## 🟢 New passes (231) — consider advancing the baseline
