...
distinct messages:
- `(node:77210) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:108111) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:86449) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:37902) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007fb6b0000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007915f091d750 (heapBase - 7283180972208)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007fb6c4469038 points into the stack for thread 0x00007fb6b0000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000713768000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007915f091d360 (heapBase + 8656650621792)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000071377ed9a448 points into the stack for thread 0x0000713768000cc0
  `
...
[process 127212]: --- stdout ---

[process 127212]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 23:27:42 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 23:29:26 GMT'
  }
...
+   'Date: Mon, 10 Aug 2026 23:28:19 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:55928' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `AssertionError: The expression evaluated to a falsy value: assert(!req._dumped) at Writable.<anonymous> (<loc>) at Writable._return (<loc>)`
...
- `AssertionError: The expression evaluated to a falsy value:
  ...
  assert(!req._dumped)
    ...
    at Writable.<anonymous> (test-http-pause-no-dump.js:13:7)
    at Writable._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)`
example test: `test/parallel/test-http-pause-no-dump.js`
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3f0a66fc: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@3f0a66fc: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@237f66b0], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:46141`
