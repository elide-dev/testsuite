...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000732e08000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007011a271d750 (heapBase - 3416202553520)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000732e1e3f9038 points into the stack for thread 0x0000732e08000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007cb7c8000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007011a271d360 (heapBase - 13903438949536)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007cb7df76a448 points into the stack for thread 0x00007cb7c8000cc0
 `
...
distinct messages:
- `(node:76593) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:107196) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:107227) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:85682) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
[process 125980]: --- stdout ---

[process 125980]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 21:54:12 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 21:55:57 GMT'
  }
...
+   'Date: Mon, 10 Aug 2026 21:54:50 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:42221' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
0'
    ...
    at Duplex.<anonymous> (test-http-server-keep-alive-defaults.js:69:7)
    at Duplex.push (native)`
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@31153a8f: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@31153a8f: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@1610fe1d], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:44307`
