...
### 17 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at <loc> at <loc>`
...
- `AssertionError: Missing expected exception (TypeError).
    at :=> (test-dns-setservers-type-check.js:66:5)
    at :anonymous (test-dns-setservers-type-check.js:50:3)
...
distinct messages:
- `(node:1269) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
distinct messages:
- `(node:74696) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
AssertionError: function should not have been called at test-http-many-ended-pipelines.js:64
called with arg`
- `(node:76109) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000074f800000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007f6385b1d750 (heapBase + 11461216032592)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000074f815899038 points into the stack for thread 0x000074f800000cc0
 `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007581b8000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007f6385b1d360 (heapBase + 10869718504288)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007581cf4aa448 points into the stack for thread 0x00007581b8000cc0
 `
...
distinct messages:
- `(node:107549) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:85112) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:37619) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
distinct messages:
- `[process 1258]: --- stderr ---
(node:1258) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.

[process 1258]: --- stdout ---

[process 1258]: status = 0, signal = null
Erro`
...
[process 127054]: --- stdout ---

[process 127054]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 09:58:40 GMT\r`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 10:00:26 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 09:59:38 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.96387.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:47399' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `AssertionError: The expression evaluated to a falsy value: assert(sync) at Duplex.<anonymous> (<loc>) at Duplex._return (<loc>) at Duplex.write (native)`
...
- `AssertionError: The expression evaluated to a falsy value:
  ...
  assert(sync)
    ...
    at Duplex.<anonymous> (test-http-sync-write-error-during-continue.js:39:7)
    at Duplex._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
...
### 1 × `AssertionError: Values have same structure but are not reference-equal: [ <str>, <str> ] at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: Values have same structure but are not reference-equal:  [   '127.0.0.1',   '0.0.0.0' ]
    at :anonymous (test-dns.js:42:3)
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@25ab0f38: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@25ab0f38: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@72c32099], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:41065`
...
### 1 × `Error: Parse Error: Invalid header token`
