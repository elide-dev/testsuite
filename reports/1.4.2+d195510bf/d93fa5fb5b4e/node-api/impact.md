...
### 22 × `AssertionError: Expected values to be strictly equal: <n> !== <n> at :anonymous (<loc>) at :program (<loc>)`
...
distinct messages:
- `(node:76727) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:107522) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:86053) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000773a44000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000757972f1d750 (heapBase - 1923357485232)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000773a5a469038 points into the stack for thread 0x0000773a44000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007438c4000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000757972f1d360 (heapBase + 1381619848032)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007438da64a448 points into the stack for thread 0x00007438c4000cc0
  `
...
[process 126844]: --- stdout ---

[process 126844]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 22:40:02 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 22:41:54 GMT'
  }
...
+   'Date: Mon, 10 Aug 2026 22:40:47 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:40202' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@4fd2f947: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@4fd2f947: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@609c6984], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:35073`
