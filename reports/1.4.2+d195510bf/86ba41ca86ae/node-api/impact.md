...
### 3 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at`
...
distinct messages:
- `(node:79588) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:110140) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:88520) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:39826) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007ce814000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007c763811d750 (heapBase - 484725893296)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007ce8298a9038 points into the stack for thread 0x00007ce814000cc0
  R`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000779f88000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007c763811d360 (heapBase + 5324418700128)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000779f9d08a448 points into the stack for thread 0x0000779f88000cc0
  `
...
[process 129075]: --- stdout ---

[process 129075]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 01:07:35 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 01:09:19 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 01:08:13 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:43923' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@849c18c: [dev.elide.lang.javascript.nod`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@849c18c: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@e3906b4], [BorrowedEmitterState]
    at :anonymous (native)
    at :program (test-fs-stream-con`
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:40199`
...
### 1 × `Mismatched <anonymous> function calls. Expected at least <n>, actual <n>. at Proxy.mustCallAtLeast (<loc>) at Timeout.<anonymous> (<loc>) at Timeout._return (<l`

distinct messages:
- `Mismatched <anonymous> function calls. Expected at least 1, actual 0.
    at Proxy.mustCallAtLeast (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:543:10)
    at Timeout.<anonymous> (test-fs-read-stream-pos.js:37:28)
    at Timeout._return (/work/.harness/work/node-api/node-api-o`
example test: `test/parallel/test-fs-read-stream-pos.js`
