...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007a0114000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007f3464b1d750 (heapBase + 5722250532688)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007a0129279038 points into the stack for thread 0x00007a0114000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x00007c0c18000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007f3464b1d360 (heapBase + 3475915527008)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007c0c2ee9a448 points into the stack for thread 0x00007c0c18000cc0
  `
...
distinct messages:
- `(node:75662) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit

Unhandled exception: java.lang.OutOfMemoryError: Could not allocate an aligned heap chunk because the heap `
...
distinct messages:
- `(node:104969) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:83883) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:37912) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 123202]: --- stdout ---

[process 123202]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 03:11:35 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 03:12:51 GMT'
  }

    at Writable.<anonymous> (test-http-content-length.j`
...
+   'Date: Tue, 11 Aug 2026 03:12:11 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
- Server [EventEmitter] {
-   _allowHalfOpen: true,
-   _connectionKey: '../node-test/.tmp.2062/node-test.94988.sock',
-   _connections: 1,
-   _handle: {},
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - true at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>)`
...
example test: `test/parallel/test-net-socket-connecting.js`
...
### 1 × `AssertionError: Expected values to be strictly equal: undefined !== <n> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit`
...
undefined !== 1
    ...
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)`
example test: `test/parallel/test-net-buffersize.js`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:59490' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@132bf9e6: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@132bf9e6: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@3a67eafb], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:40285`
...
### 1 × `SyntaxError: Unexpected token T in JSON at position <n> at JSON.parse (native) at Readable.<anonymous> (<loc>) at SyntaxError.get stack (native) SyntaxError: Un`
...
### 1 × `Uncaught (in promise) Object{} Uncaught (in promise) Object{} Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expect`
...
+ actual - expected
  ...
  Comparison {
+   message: 'function values are not structured-cloneable',
