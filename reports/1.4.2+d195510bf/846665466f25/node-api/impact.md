...
### 10 × `AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
### 2 × `AssertionError: function should not have been called at <loc> called with arguments: Socket [Duplex] { _handle: {}, _allowHalfOpen: false, connecting: false, _c`

distinct messages:
- `AssertionError: function should not have been called at test-net-client-bind-twice.js:9
...
distinct messages:
- `(node:77860) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit

Exception: java.lang.OutOfMemoryError thrown from the UncaughtExceptionHandler in thread "TruffleCompilerTh`
...
distinct messages:
- `(node:107051) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:107080) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:86839) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007920a4000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000786d0171d750 (heapBase - 767231142064)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007920b8559038 points into the stack for thread 0x00007920a4000cc0
  R`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000072bcb8000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000786d0171d360 (heapBase + 6258999808864)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000072bccc8fa448 points into the stack for thread 0x000072bcb8000cc0
  `
...
[process 125556]: --- stdout ---

[process 125556]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 21:10:33 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 21:12:16 GMT'
  }
...
+   'Date: Mon, 10 Aug 2026 21:11:10 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:44965' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `AssertionError: Missing expected exception. at Duplex.<anonymous> (<loc>) at Duplex._return (<loc>) at Duplex.push (native) Error: Cannot call end after a strea`
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@7e21bfb9: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@7e21bfb9: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@387b7dd], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:34041`
