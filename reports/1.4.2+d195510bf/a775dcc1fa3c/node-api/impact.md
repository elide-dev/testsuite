...
### 13 × `AssertionError: Missing expected exception. at :anonymous (<loc>) at :program (<loc>)`
...
### 6 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { code: <str>, + message: <str>, - message: <str>, name: <str> } at :a`
...
### 4 × `Mismatched <anonymous> function calls. Expected exactly <n>, actual <n>. at Proxy.mustCall (<loc>) at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (`
...
### 3 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { code: <str>, + message: <str>, - message: <str>, name: <str> } at :=`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000711ad0000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000077601c71d750 (heapBase + 6899000268624)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000711ae53a9038 points into the stack for thread 0x0000711ad0000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x000070cde4000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x000077601c71d360 (heapBase + 7229377205088)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000070cdfbcea448 points into the stack for thread 0x000070cde4000cc0
  `
...
distinct messages:
- `(node:36845) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at process.listener (test-process-no-deprecation.js:13:10)
(node:36845) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:25958) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:17489) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 default listeners added to [EventEmitter]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:39680) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:39701) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:27867) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:36116) Warning: A Warning
(node:36116) CustomWarning: A Warning
(node:36116) Warning: A Warning
(node:36116) CustomWarning: A Warning
(node:36116) [CODE001] CustomWarning: A Warning
(node:36116) CustomWarning: A Warning
(node:36116) [CODE001] CustomWarning: A Warning
(node:36116) [CODE001] Cus`
...
[process 43593]: --- stdout ---

[process 43593]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 08:31:01 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 08:34:04 GMT'
  }
...
### 1 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected + [] - [ - <str> - ] TypeError: Cannot read property <str> of null at :anonymous `
...
AssertionError: Expected values to be strictly deep-equal: + actual - expected  + {} - { -   code`
...
+   'Date: Mon, 10 Aug 2026 08:31:43 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + undefined - <str> AssertionError: Expected values to be strictly equal: + actual - e`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:46565' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
called with arguments: <Buffer 28 6e 6f 64 65 3a 37 32 39 39 29 20 44 65 70 72 65 63 61 74 69 6f 6e 57 61 72 6e 69 6e 67 3a 20 53 6f 6d 65 74 68 69 6e 67 20 65 6c 73 65 20 69 73 20 ... 12 more bytes>
    `
...
### 1 × `AssertionError: Missing expected exception (TypeError). AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
### 1 × `AssertionError: The input did not match the regular expression /Connection: keep-alive\r\n/m. Input: <str> at assertResponse (<loc>) at Duplex.<anonymous> (<loc`
...
0'
    ...
    at Duplex.<anonymous> (test-http-server-keep-alive-max-requests-null.js:69:7)
    at Duplex.p`
example test: `test/parallel/test-http-server-keep-alive-max-requests-null.js`
...
### 1 × `AssertionError: wrong exit for <n>-zeroExitWithUncaughtHandler expected:<n> but got:<n> <n> !== <n> at EventEmitter.<anonymous> (<loc>) at EventEmitter._return `

distinct messages:
- `AssertionError: wrong exit for 5-zeroExitWithUncaughtHandler
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@4ca46b1c: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@4ca46b1c: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@17162f7c], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:32943`
...
Printing instructions (ip=0x0000630161951d1b):
  0x0000630161951c1b: 0x0`
...
### 1 × `TypeError: <this>._implicitHeader is not a function at :anonymous (<loc>) at :program (<loc>)`
