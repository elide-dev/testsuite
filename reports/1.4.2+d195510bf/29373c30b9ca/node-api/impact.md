...
- `TypeError: This handle type cannot be sent
    ...
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)`
example test: `test/parallel/test-child-process-fork-net-socket.js`
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000074213c000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007cb675f1d750 (heapBase + 9441310529360)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000742153b29038 points into the stack for thread 0x000074213c000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x000071d220000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007cb675f1d360 (heapBase + 11980105962336)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000071d236bfa448 points into the stack for thread 0x000071d220000cc0
 `
...
- `TypeError: Cannot read property 'killed' of null
    ...
    at EventEmitter.emit (native)
    at TypeError.get stack (native)`
example test: `test/parallel/test-child-process-exec-timeout-kill.js`
...
distinct messages:
- `(node:130061) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at process.listener (test-process-no-deprecation.js:13:10)
(node:130061) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:97865) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:134509) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:134538) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:109629) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
[process 157427]: --- stdout ---

[process 157427]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 09:54:17 GMT\r\n\r\nOK"`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 09:56:02 GMT'
  }
...
+   'Date: Mon, 10 Aug 2026 09:54:57 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:50757' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
called with arguments: <Buffer 28 6e 6f 64 65 3a 33 35 37 31 29 20 44 65 70 72 65 63 61 74 69 6f 6e 57 61 72 6e 69 6e 67 3a 20 53 6f 6d 65 74 68 69 6e 67 20 65 6c 73 65 20 69 73 20 ... 12 more bytes>
    `
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@27d92127: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@27d92127: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@5ae58e37], [BorrowedEmitterState]
    at :anonymous (native)
...
### 1 × `domains stack length should be <n>, but instead is: <n>`

distinct messages:
- `domains stack length should be 0, but instead is: 1`
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:36441`
