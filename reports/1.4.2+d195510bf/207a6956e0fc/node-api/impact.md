...
distinct messages:
- `(node:74892) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit

Exception: 
Exception: java.lang.OutOfMemoryError thrown from the UncaughtExceptionHandler in thread "Truff`
...
distinct messages:
- `(node:105592) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:83116) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:37687) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007fe030000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007cb5bb71d360 (heapBase - 3476583754912)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007fe044d9a448 points into the stack for thread 0x00007fe030000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007421a0000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007cb5bb71d750 (heapBase + 9436503856976)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007421b7f89038 points into the stack for thread 0x00007421a0000cc0
  `
...
[process 124191]: --- stdout ---

[process 124191]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 06:45:10 GMT\r`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 06:46:24 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 06:45:52 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.94591.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:54186' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@5e117674: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@5e117674: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@1a0012cf], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:40519`
...
AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   message: 'escaped timeout at 2002 milliseconds!' -   code: 'ERR_SCRIPT_EXECUTION_TIMEOUT', -   message: 'Script execution timed out af`
