...
- Image digest: `fb5c015432d45dafd529e62a478118464ca7afe1b23da58523479c27e0f910a8`
- Suite version: `ed33ae74ad100a38df41edf56f6935c78821e779`
- Ran: 2026-08-10T11:29:05.830Z → 2026-08-10T11:55:34.999Z

## Summary

![Pass-rate chart](./pass-rate.svg)

**Pass rate: 1162/3071 (54.48%)**

| pass | fail | error | skip | regressions | new passes |
|---:|---:|---:|---:|---:|---:|
| 1162 | 914 | 57 | 938 | 15 | 194 |
...
Mismatched <anonymous> function calls. Expected exactly 2, actual 0.
    ...
    at test-async-hooks-enable-recursive.js:1:1
- `test/parallel/test-async-hooks-execution-async-resource-await.js` — fail — Uncaught (in promise) TypeError: The "callback" argument must be of type function. Received type number (10)
...
- `test/parallel/test-async-local-storage-contexts.js` — fail — Uncaught (in promise) TypeError: Cannot read property 'test' of undefined
...
- `test/parallel/test-async-local-storage-weak-asyncwrap-leak.js` — fail — Uncaught (in promise) AssertionError: Expected values to be strictly equal:
+ actual - expected
...
- `test/parallel/test-buffer-alloc.js` — fail — AssertionError: Expected values to be strictly equal:  5 !== 4
...
- `test/parallel/test-buffer-bytelength.js` — fail — AssertionError: Expected values to be strictly equal:  2 !== 3
...
- `test/parallel/test-buffer-constructor-outside-node-modules.js` — fail — (node:1257) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
AssertionError: DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
    ...
    at process._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
- `test/parallel/test-buffer-constructor-node-modules.js` — fail — [process 1265]: --- stderr ---
...
- `test/parallel/test-buffer-over-max-length.js` — fail — AssertionError: Expected values to be strictly deep-equal: + actual - expected    Comparison { +   code: 'ERR_MEMORY_ALLOCATION_FAILED', +   name: 'Error' -   code: 'ERR_OUT_OF_RANGE', -   name: 'RangeError'   }
...
- `test/parallel/test-buffer-resizable.js` — fail — (node:1510) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.
...
called with arguments: <Buffer 20 20 20 20 61 74 20 3a 61 6e 6f 6e 79 6d 6f 75 73 20 28 65 63 68 6f 2e 6a 73 3a 32 37 3a 31 33 29 0a 20 20 20 20 61 74 20 3a 70 72 6f 67 72 61 6d 20 ... 14 more bytes>
    at Readable.mustNotCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:631:12)
    at Readable.push (native)
...
- `test/parallel/test-async-local-storage-contexts.js` — Uncaught (in promise) TypeError: Cannot read property 'test' of undefined
Uncaught (in promise) TypeError: Cannot read property 'test' of undefined
...
- `test/parallel/test-domain-vm-promise-isolation.js` — Uncaught (in promise) AssertionError: Expected values to be strictly equal:
+ actual - expected
...
-   members: []
- }
- `test/parallel/test-fs-lchown.js` — Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
- `test/parallel/test-fs-promises-file-handle-sync.js` — Uncaught (in promise) AssertionError: Missing expected rejection.
- `test/parallel/test-fs-watch-recursive-assert-leaks.js` — Uncaught (in promise) TypeError: (intermediate value)._getActiveHandles is not a function
...
false !== true
    ...
    at Writable._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
- `test/parallel/test-http-server-optimize-empty-requests.js` — Uncaught (in promise) AssertionError: Expected 4 optimized requests but got 0
...
called with arguments: Error: write after end
  ...
  code: 'ERR_STREAM_WRITE_AFTER_END'
    ...
    at Writable.emit (native)
- `test/parallel/test-performance-resourcetimingbufferfull.js` — Uncaught (in promise) TypeError: performance.setResourceTimingBufferSize is not a function
- `test/parallel/test-performance-resourcetimingbuffersize.js` — Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
- `test/parallel/test-v8-collect-gc-profile.js` — Uncaught (in promise) TypeError: GCProfiler is not a constructor
- `test/parallel/test-vm-script-after-evaluate.js` — Uncaught (in promise) AssertionError: function should not have been called at test-vm-script-after-evaluate.js:16
- `test/parallel/test-worker-messaging-errors-invalid.js` — Uncaught (in promise) Error: node:worker_threads: postMessageToThread is not implemented yet in Elide

## 🟢 New passes (194) — consider advancing the baseline
