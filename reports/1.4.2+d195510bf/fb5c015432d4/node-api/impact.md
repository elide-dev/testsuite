...
### 10 × `TypeError: Cannot read property <str> of undefined at :anonymous (<loc>) at :program (<loc>)`
...
### 8 × `AssertionError: Missing expected exception (TypeError). at :anonymous (<loc>) at :program (<loc>)`
...
### 5 × `Uncaught (in promise) AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str>`
...
### 4 × `Uncaught (in promise) Error: node:worker_threads: postMessageToThread is not implemented yet in Elide`
...
### 3 × `Uncaught (in promise) {code: <str>, message: <str>, name: <str>}`

distinct messages:
- `Uncaught (in promise) {code: "ENODATA", message: "querySRV ENODATA _mongodb._tcp.cluster0.example.org", name: "Error"}`
- `Uncaught (in promise) {code: "ETIMEOUT", message: "queryANY ETIMEOUT example.org", name: "Error"}`
example test: `test/parallel/test-dns-resolvesrv.js`
...
### 2 × `AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str>, + name: <str> - code: <str>, - name: <str> } at :anon`
...
### 2 × `AssertionError: Expected values to be strictly equal: false !== true at Writable.<anonymous> (<loc>) at Writable._return (<loc>) AssertionError: Expected values`
...
### 2 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + name: <str> - name: <str> }`
...
### 2 × `Uncaught (in promise) AssertionError: Expected values to be strictly equal: <n> !== -<n>`
...
### 2 × `Uncaught (in promise) AssertionError: Missing expected exception.`

distinct messages:
- `Uncaught (in promise) AssertionError: Missing expected exception.`
example test: `test/parallel/test-fs-watch-recursive-validate.js`

### 2 × `Uncaught (in promise) TypeError: receiver is not an EventEmitter`
...
distinct messages:
- `(node:98601) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at process.listener (test-process-no-deprecation.js:13:10)
(node:98601) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:73387) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `(node:102935) TimeoutNaNWarning: NaN is not a number.
...
distinct messages:
- `(node:102964) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.`
...
distinct messages:
- `(node:82290) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x00007ac45c000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000764ebe51d360 (heapBase - 4898907892896)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x00007ac472c7a448 points into the stack for thread 0x00007ac45c000cc0
  `
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x0000720988000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x0000764ebe51d750 (heapBase + 4699605817168)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000072099c3a9038 points into the stack for thread 0x0000720988000cc0
  `
...
distinct messages:
- `[process 1265]: --- stderr ---
(node:1265) [DEP0005] DeprecationWarning: Buffer() is deprecated due to security and usability issues. Please use the Buffer.alloc(), Buffer.allocUnsafe(), or Buffer.from() methods instead.

[process 1265]: --- stdout ---

[process 1265]: status = 0, signal = null
Erro`
...
[process 115077]: --- stdout ---

[process 115077]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE {"headers":{"Connection":"keep-alive"},"chunks":["OK"]}
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Mon, 10 Aug 2026 11:42:53 GMT\r\n\r\nOK"`
...
### 1 × `AssertionError: Expected <str> to be reference-equal to <str>: + actual - expected + Promise { + <pending> - { - foo: <str> } at :anonymous (<loc>) at :program `

distinct messages:
- `AssertionError: Expected "actual" to be reference-equal to "expected": + actual - expected  + Promise { +   <pending> - { -   foo: 'bar'   }
    at :anonymous (test-diagnostics-channel-tracing-channel-promise-non-thenable.js:40:1)
    at :program (test-diagnostics-channel-tracing-channel-promise-non`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Mon, 10 Aug 2026 11:44:40 GMT'
  }
...
### 1 × `AssertionError: Expected values to be strictly equal: + actual - expected + <str> - <str> at Duplex.<anonymous> (<loc>) at Duplex._return (<loc>)`
...
+   'Date: Mon, 10 Aug 2026 11:43:33 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
### 1 × `AssertionError: Expected values to be strictly equal: <n> !== <n> at :=> (<loc>) at :anonymous (<loc>) at :program (<loc>)`
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:57569' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
called with arguments: <Buffer 28 6e 6f 64 65 3a 34 32 39 33 29 20 44 65 70 72 65 63 61 74 69 6f 6e 57 61 72 6e 69 6e 67 3a 20 53 6f 6d 65 74 68 69 6e 67 20 65 6c 73 65 20 69 73 20 ... 12 more bytes>
    `
...
### 1 × `AssertionError: The input did not match the regular expression /<str> argument must be of type function/. Input: <str> at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: The input did not match the regular expression /"callback" argument must be of type function/. Input:  'AssertionError: function should not have been called at test-diagnostics-channel-tracing-channel-callback.js:42 called with arguments: 1, 2, 3'
    at :anonymous (test-diagnostics-`
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@5dd442f6: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@5dd442f6: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@21291c7b], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:34503`
...
### 1 × `Uncaught (in promise) {code: <str>, message: <str>, name: <str>} Uncaught (in promise) {code: <str>, message: <str>, name: <str>}`

distinct messages:
- `Uncaught (in promise) {code: "ENODATA", message: "querySRV ENODATA _mongodb._tcp.cluster0.example.net", name: "Error"}
Uncaught (in promise) {code: "ENODATA", message: "querySRV ENODATA _mongodb._tcp.cluster.mongodb.net", name: "Error"}`
example test: `test/parallel/test-dns-resolvesrv-econnrefused.js`

### 1 × `Uncaught (in promise) AssertionError: Expected <n> optimized requests but got <n> <n> !== <n>`

distinct messages:
- `Uncaught (in promise) AssertionError: Expected 4 optimized requests but got 0

0 !== 4`
example test: `test/parallel/test-http-server-optimize-empty-requests.js`
...
### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected + Comparison {} - Comparison { - code: <str> - }`
...
-   code: 'ERR_INVALID_ARG_TYPE'
- }`
example test: `test/parallel/test-worker-heap-profile.js`
...
### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str> - code: <str>, - hostname: <str>`
...
example test: `test/parallel/test-dns-channel-cancel-promise.js`
...
### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str>, + message: <str>, + name: <str>`
...
+   message: 'node:worker_threads: worker.getHeapSnapshot is not implemented yet in Elide',
+   name: 'Error'
-   code: 'ERR_INVALID_ARG_TYPE',`
example test: `test/parallel/test-worker-heapdump-failure.js`

### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + code: <str>, + name: <str> - code: <str>, - `
...
### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal: + actual - expected Comparison { + message: <str>, - code: <str>, - message: <s`
...
+ actual - expected
  ...
  Comparison {
+   message: 'performance.setResourceTimingBufferSize is not a function',
-   code: 'ERR_INVALID_ARG_TYPE',
-   message: 'maxSize is a BigInt and cannot be converted to a number.',
  `
example test: `test/parallel/test-performance-resourcetimingbuffersize.js`
...
### 1 × `Uncaught (in promise) AssertionError: Expected values to be strictly equal: + actual - expected + null - Domain [EventEmitter] { - _disposed: false, - members: `
...
+ null
- Domain [EventEmitter]`
example test: `test/parallel/test-domain-vm-promise-isolation.js`
...
### 1 × `Uncaught (in promise) AssertionError: function should not have been called at <loc>`

distinct messages:
- `Uncaught (in promise) AssertionError: function should not have been called at test-vm-script-after-evaluate.js:16`
example test: `test/parallel/test-vm-script-after-evaluate.js`
...
### 1 × `Uncaught (in promise) AssertionError: Missing expected rejection. Uncaught (in promise) AssertionError: Missing expected rejection. AssertionError: watcher Obje`

distinct messages:
- `Uncaught (in promise) AssertionError: Missing expected rejection.
Uncaught (in promise) AssertionError: Missing expected rejection.
AssertionError: watcher Object was not closed
    at process.<anonymous> (test-fs-watch-recursive-promise.js:35:12)`
example test: `test/parallel/test-fs-watch-recursive-promise.js`
...
### 1 × `Uncaught (in promise) Error: node:worker_threads: worker.getHeapSnapshot is not implemented yet in Elide`

distinct messages:
- `Uncaught (in promise) Error: node:worker_threads: worker.getHeapSnapshot is not implemented yet in Elide`
...
### 1 × `Uncaught (in promise) TypeError: (intermediate value)._getActiveHandles is not a function`

distinct messages:
- `Uncaught (in promise) TypeError: (intermediate value)._getActiveHandles is not a function`
example test: `test/parallel/test-fs-watch-recursive-assert-leaks.js`

### 1 × `Uncaught (in promise) TypeError: Cannot read property <str> of undefined Uncaught (in promise) TypeError: Cannot read property <str> of undefined`

distinct messages:
- `Uncaught (in promise) TypeError: Cannot read property 'test' of undefined
Uncaught (in promise) TypeError: Cannot read property 'test' of undefined`
example test: `test/parallel/test-async-local-storage-contexts.js`
...
### 1 × `Uncaught (in promise) TypeError: GCProfiler is not a constructor`

distinct messages:
- `Uncaught (in promise) TypeError: GCProfiler is not a constructor`
example test: `test/parallel/test-v8-collect-gc-profile.js`
...
### 1 × `Uncaught (in promise) TypeError: performance.setResourceTimingBufferSize is not a function`

distinct messages:
- `Uncaught (in promise) TypeError: performance.setResourceTimingBufferSize is not a function`
example test: `test/parallel/test-performance-resourcetimingbufferfull.js`
...
### 1 × `Uncaught (in promise) TypeError: The <str> argument must be of type function. Received type number (<n>) Uncaught (in promise) TypeError: The <str> argument mus`

distinct messages:
- `Uncaught (in promise) TypeError: The "callback" argument must be of type function. Received type number (10)
Uncaught (in promise) TypeError: The "callback" argument must be of type function. Received type number (10)
Uncaught (in promise) TypeError: The "callback" argument must be of type function.`
...
### 1 × `Uncaught (in promise) TypeError: The <str> argument must be of type string or an instance of Buffer or URL. Received type number (<n>) Uncaught (in promise) Ass`

distinct messages:
- `Uncaught (in promise) TypeError: The "path" argument must be of type string or an instance of Buffer or URL. Received type number (1)
Uncaught (in promise) AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
### 1 × `Uncaught (in promise) TypeError: worker.cpuUsage is not a function`

distinct messages:
- `Uncaught (in promise) TypeError: worker.cpuUsage is not a function`
example test: `test/parallel/test-worker-cpu-usage.js`

### 1 × `Uncaught (in promise) TypeError: worker.startCpuProfile is not a function`

distinct messages:
- `Uncaught (in promise) TypeError: worker.startCpuProfile is not a function`
example test: `test/parallel/test-worker-cpu-profile.js`
...
| 84 | node:streams |
| 82 | node:fs |
| 74 | node:worker-threads |
| 61 | node:vm |
| 56 | node:process |
| 51 | node:net |
| 48 | node:child-process |
