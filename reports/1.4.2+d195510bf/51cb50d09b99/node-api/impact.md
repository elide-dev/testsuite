...
distinct messages:
- `(node:74647) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
AssertionError: function should not have been called at test-http-many-ended-pipelines.js:64
called with arg`
- `(node:76939) MaxListenersExceededWarning: Possible EventEmitter memory leak detected. 11 close listeners added to [Socket]. MaxListeners is 10. Use emitter.setMaxListeners() to increase limit
...
distinct messages:
- `[ [ SegfaultHandler caught a segfault in thread 0x000073807c000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007896a671d750 (heapBase + 5597054752592)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x0000738093e09038 points into the stack for thread 0x000073807c000cc0
  `
- `[ [ SegfaultHandler caught a segfault in thread 0x000070def4000cc0 ] ]
siginfo: si_signo: 11, si_code: 1, si_addr: 0x00007896a671d360 (heapBase + 8489849443168)

General purpose register values:
  RAX 0x0000000000000000 
  RBX 0x000070df0b58a448 points into the stack for thread 0x000070def4000cc0
  `
...
distinct messages:
- `(node:107912) TimeoutOverflowWarning: 2147483648 does not fit into a 32-bit signed integer.
...
distinct messages:
- `(node:85228) TimeoutOverflowWarning: 1099511627776 does not fit into a 32-bit signed integer.
Timeout duration was set to 1.
...
distinct messages:
- `(node:38012) Warning: tracePromise was called with the function '<anonymous>', which returned a non-thenable.
AssertionError: Expected values to be strictly deep-equal:
+ actual - expected
...
[process 127348]: --- stdout ---

[process 127348]: status = 1, signal = null
...
<  SERVER SENDING RESPONSE { headers: { Connection: 'keep-alive' }, chunks: [ 'OK' ] }
 > CLIENT ONDATA 82 "HTTP/1.1 200 OK\r\nConnection: keep-alive\r\nDate: Tue, 11 Aug 2026 12:02:37 GMT\r`
...
+ actual - expected
  ...
  [Object: null prototype] {
    ...
    connection: 'keep-alive',
+   date: 'Tue, 11 Aug 2026 12:03:51 GMT'
  }
...
+   'Date: Tue, 11 Aug 2026 12:03:15 GMT\r\n' +
+   'Connection: keep-alive\r\n' +
...
-   _allowHalfOpen: true,
-   _closing: false,
-   _connectionKey: '../node-test/.tmp.2062/node-test.96711.sock',
-   _connections: 1,
-   _handle: {},
...
called with arguments: [Error: EADDRINUSE: address already in use, udp-bind '0.0.0.0:33545' (errno=98)] {
  code: 'EADDRINUSE',
  errno: 98,
  syscall: 'bind'
}
...
### 1 × `AssertionError: The expression evaluated to a falsy value: assert(!c) at EventEmitter.<anonymous> (<loc>) at EventEmitter._return (<loc>) at EventEmitter.emit (`
...
- `AssertionError: The expression evaluated to a falsy value:
  ...
  assert(!c)
    ...
    at EventEmitter.<anonymous> (test-process-raw-debug.js:55:5)
    at EventEmitter._return (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:573:12)
    at EventEmitter.emit (native)
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@11fe33ae: [dev.elide.lang.javascript.no`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@11fe33ae: [dev.elide.lang.javascript.node.events.JSEventEmitter$BorrowedEmitterState@3555ba2b], [BorrowedEmitterState]
    at :anonymous (native)
...
distinct messages:
- `Error: connect ECONNREFUSED ::1:32769`
