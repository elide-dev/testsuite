...
### 2 × `RangeError: Maximum call stack size exceeded at :anonymous (<loc>) at :program (<loc>)`
...
distinct messages:
- `(node:7314) DeprecationWarning: Something is deprecated.
AssertionError: received unexpected warning
    at Function.fail (native)
    at Process.listener (test-process-no-deprecation.js:13:10)
(node:7314) DeprecationWarning: Something else is deprecated.`
...
distinct messages:
- `(node:6925) Warning: A Warning
(node:6925) CustomWarning: A Warning
(node:6925) Warning: A Warning
(node:6925) CustomWarning: A Warning
(node:6925) [CODE001] CustomWarning: A Warning
(node:6925) CustomWarning: A Warning
(node:6925) [CODE001] CustomWarning: A Warning
(node:6925) [CODE001] CustomWarni`
...
distinct messages:
- `(node:7459) Warning: test
(node:7459) DeprecationWarning: test
(node:7459) Warning: test
(node:7459) DeprecationWarning: test
(node:7459) Error: test
(node:7459) Warning: test
...
distinct messages:
- `7/15/2026, 12:40:31 AM start test
7/15/2026, 12:40:31 AM waiting for callbacks
7/15/2026, 12:40:31 AM fs open() callback
7/15/2026, 12:40:31 AM WriteStream constructor
7/15/2026, 12:40:31 AM closed 1
Mismatched WriteStream$open function calls. Expected exactly 1, actual 0.
    at Proxy.mustCall (/wo`
...
### 1 × `AssertionError: [B@78dc3c14 === [B@505a6472 at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: [B@78dc3c14 === [B@505a6472
...
### 1 × `AssertionError: function should not have been called at <loc> at Function.fail (native) at mustNotCall (<loc>) TypeError: timeout[(intermediate value).toPrimiti`

distinct messages:
- `AssertionError: function should not have been called at test-timers-to-primitive.js:7
    at Function.fail (native)
    at mustNotCall (/work/.harness/work/node-api/node-api-overlay/test/common/index.js:631:12)
TypeError: timeout[(intermediate value).toPrimitive] is not a function
    at :=> (test-t`
...
### 1 × `AssertionError: undefined === [B@3e013cec at :anonymous (<loc>) at :program (<loc>)`

distinct messages:
- `AssertionError: undefined === [B@3e013cec
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToNumberNodeGen@2a5da37b: [[B@66ba57c], [byte[]] at :=> (<loc>) `

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToNumberNodeGen@2a5da37b: [[B@66ba57c], [byte[]]
...
### 1 × `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@24d2df41: [[B@31bcf0a8], [byte[]] at :=`

distinct messages:
- `com.oracle.truffle.api.dsl.UnsupportedSpecializationException: Unexpected values provided for JSToObjectNodeGen.Uncached@24d2df41: [[B@31bcf0a8], [byte[]]
    at :=> (native)
    at _return (index.js:573:12)`
...
not ok 1 - Assert class destructuring behavior - diff option
  ...
  ...
# Subtest: Assert class destructur`
